...
The [Wave memory model](WaveMemoryModel.md) defines address spaces, explicit
SSA and token dependencies, write observation, control flow, synchronization,
and removal of unused memory operations. Source builders and all lowering stages
