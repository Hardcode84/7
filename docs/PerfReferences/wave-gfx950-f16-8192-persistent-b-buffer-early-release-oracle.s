...
.Lgfx950_persistent_f16_gemm.if_end_7:
		...
		; Oracle: overlap next B read with four independent MFMA chains.
...
.Lgfx950_persistent_f16_gemm.exec_endif_2:
			s_mov_b64 exec, s[24:25]
		; Slot is free once final LDS fragment reaches registers.
...
.Lgfx950_persistent_f16_gemm.if_end_11:
		...
		; Reuse the consumed B registers while later fragments drain.
...
.Lgfx950_persistent_f16_gemm.exec_endif_3:
			s_mov_b64 exec, s[24:25]
		; Hide returning-atomic latency under the final MFMA group.
