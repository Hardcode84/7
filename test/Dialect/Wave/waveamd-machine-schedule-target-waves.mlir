...
// TARGET: candidate func=pressure_explicit_one region=0 name=original cycles=6 delta=0 issued_ops=2 max_vgpr=128 max_sgpr=0 vgpr_hard_excess=0 sgpr_hard_excess=0
