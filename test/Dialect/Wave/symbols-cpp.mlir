...
// CHECK: sentinel-new-domain: true
// CHECK: sentinel-codec-roundtrip: true
// CHECK: sentinel-rejected-assumptions: true
// CHECK: sentinel-analysis-new-domain: true
...
// CHECK: view-xor-kind: xor
// CHECK: view-xor-args: 2
...
// CHECK: analysis-undefined-self-equality-check: true
...
// CHECK: material-cost-nonpow2-floor: 6
// CHECK: material-cost-nonpow2-ceil: none
// CHECK: material-cost-nonpow2-trunc: none
