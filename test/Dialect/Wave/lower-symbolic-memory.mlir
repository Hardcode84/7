...
// CHECK-LABEL: func.func @explicit_packet_offset_scatter(
// CHECK-NOT: wave.scatter
// CHECK-COUNT-1: wave.where
// CHECK-COUNT-1: wave.store
...
// CHECK-NOT: wave.store
// CHECK-NOT: wave.scatter
func.func @explicit_packet_offset_scatter(
    %value: !wave.simd<vector<4xf16>, 64>,
    %base: !wave.ptr<#waveamd.buffer, f16>, %tile: i32,
    %column_limit_raw: i32, %row_limit_raw: i32)
    attributes {wave.workgroup_size = array<i32: 64, 1, 1>} {
  %c128_i32 = arith.constant 128 : i32
  %scaled = wave.binary muli %tile, %c128_i32 overflow<nsw>
      : i32, i32 -> i32
