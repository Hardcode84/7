...
// RUN: wave-opt %s --waveamd-machine-schedule='score-func=candidate_lower score-region=0 score-order=0,2,1,3 model-vmem-value-latency=20' 2>&1 | FileCheck %s --check-prefix=LOWER-VALUE
...
// EQUAL: waveamd-machine-schedule score func=candidate_equal region=0 order=original cycles=6 issued_ops=2
// EQUAL: waveamd-machine-schedule score func=candidate_equal region=0 order=candidate cycles=6 issued_ops=2
