...
// DIAG: waveamd-machine-schedule candidate func=matmul_loop_candidate region=1 name=critical_path cycles=325 delta=-1 issued_ops=6 order=0,2,3,1,4,5,6
...
// DIAG: waveamd-machine-schedule selected func=matmul_loop_candidate region=1 name=critical_path original_cycles=326 selected_cycles=325 delta=-1 action=keep order=0,2,3,1,4,5,6
