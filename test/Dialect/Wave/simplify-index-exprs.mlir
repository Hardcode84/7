...
// CHECK: %[[OFF:.*]] = wave.index_expr <"16 + lid"> ["lid"](%[[LANE]]) : (!wave.simd<i32, 32>) -> !wave.index<32>
// CHECK: return %[[OFF]] : !wave.index<32>
func.func @range_folds_bound_symbol(%x: i32) -> !wave.index<32> {
  %lane = wave.lane_id : !wave.simd<i32, 32>
  %k = wave.assume_range %x, [16, 16] : i32
  %off = wave.index_expr <"K + lid"> ["K", "lid"](%k, %lane) : (i32, !wave.simd<i32, 32>) -> !wave.index<32>
...
func.func @range_cancels_symbol(%k_raw: i32, %x: i32) -> !wave.index {
