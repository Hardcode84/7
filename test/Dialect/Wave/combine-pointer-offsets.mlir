...
// CHECK-LABEL: func.func @non_global_identity_i32_offset_combines
// CHECK-SAME: (%[[OUT:.*]]: !wave.ptr<#waveamd.buffer, i32>, %[[RAW:.*]]: !wave.simd<i32, 32>)
// CHECK: %[[IDX:.*]] = wave.index_expr <"4 + raw0"> ["raw0"](%[[RAW]]) : (!wave.simd<i32, 32>) -> !wave.simd<index, 32>
// CHECK: %[[PTR:.*]] = wave.ptr_add %[[OUT]], %[[IDX]] : !wave.ptr<#waveamd.buffer, i32>, !wave.simd<index, 32> -> !wave.simd<!wave.ptr<#waveamd.buffer, i32>, 32>
// CHECK: return %[[PTR]]
func.func @non_global_identity_i32_offset_combines(
