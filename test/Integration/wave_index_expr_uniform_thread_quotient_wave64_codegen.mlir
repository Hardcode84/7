...
func.func @uniform_thread_quotient_wave64(%input: !wave.ptr<#wave.global, i32>, %out: !wave.ptr<#wave.global, i32>) -> !wave.mem.token attributes {wave.kernel, wave.workgroup_size = array<i32: 256, 1, 1>} {
