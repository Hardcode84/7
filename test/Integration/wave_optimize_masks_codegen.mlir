...
// CHECK-LABEL: func.func @wave64_mask_and_codegen
// CHECK: waveamdmachine.s_and_b64
// CHECK-NOT: waveamdmachine.s_and_b32
func.func @wave64_mask_and_codegen(
    %out: !wave.ptr<#wave.global, i32>, %limit0: i32, %limit1: i32)
    attributes {
      wave.kernel,
      wave.workgroup_size = array<i32: 256, 1, 1>,
      wave.waves_per_workgroup = 4 : i64
  ...
  %buffer = waveamd.make_buffer %out, %range
      : !wave.ptr<#wave.global, i32>, i32
      -> !wave.ptr<#waveamd.buffer, i32>
  %vlimit0 = wave.splat %limit0 : i32 -> !wave.simd<i32, 64>
  %vlimit1 = wave.splat %limit1 : i32 -> !wave.simd<i32, 64>
  %lane = wave.lane_id : !wave.simd<i32, 64>
  %m0 = wave.cmpi ult %lane, %vlimit0
      : !wave.simd<i32, 64>, !wave.simd<i32, 64> -> !wave.mask<64>
  %m1 = wave.cmpi ult %lane, %vlimit1
      : !wave.simd<i32, 64>, !wave.simd<i32, 64> -> !wave.mask<64>
  %false = wave.constant false -> !wave.mask<64>
  %combined = wave.select %m0, %m1, %false
      : !wave.mask<64>, !wave.mask<64>
  %zero = wave.constant 0 : i32 -> !wave.simd<i32, 64>
  %value = wave.select %combined, %lane, %zero
      : !wave.mask<64>, !wave.simd<i32, 64>
