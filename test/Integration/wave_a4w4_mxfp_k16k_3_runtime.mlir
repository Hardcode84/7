...
//
// RUN: %python %S/../../tools/wave-matmul-calibrate/wave-matmul-calibrate.py --chip=%chip --build-dir=%wave_obj_root --kernel-profile=a4w4-mxfp-k16k-3 --m=256 --n=256 --variants=baseline --iters=2 --warmup=1 --repeats=1 --sim-trip-count=0 --no-check \
// RUN:   | FileCheck %s
//
