...
// ASM: v_add_lshl_u32 [[LOAD_ACTIVE:v[0-9]+]], {{s[0-9]+}}, {{v[0-9]+}}, 2
// ASM: v_mov_b32_e32 [[LOAD_OOB:v[0-9]+]], 0x80000000
// ASM: v_cndmask_b32_e64 [[LOAD_VOFF:v[0-9]+]], [[LOAD_OOB]], [[LOAD_ACTIVE]], {{s[0-9]+}}
...
// ASM: v_add_lshl_u32 [[STORE_ACTIVE:v[0-9]+]], {{s[0-9]+}}, {{v[0-9]+}}, 2
// ASM: v_mov_b32_e32 [[STORE_OOB:v[0-9]+]], 0x80000000
// ASM: v_cndmask_b32_e64 [[STORE_VOFF:v[0-9]+]], [[STORE_OOB]], [[STORE_ACTIVE]], {{s[0-9]+}}
