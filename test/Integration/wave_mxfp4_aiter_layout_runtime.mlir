...
//
// RUN: %python %S/../../tools/wave-matmul-calibrate/wave-matmul-calibrate.py --chip=%chip --build-dir=%wave_obj_root --kernel-profile=gfx950-mxfp4-aiter-256x256 --m=256 --n=256 --k=1024 --cta-swizzle-xcds=1 --cta-group-m=1 --seed=17 --variants=scheduled --iters=2 --warmup=1 --repeats=1 \
...
// LARGE-TILE: output_layout_check: passed kernel=tile-packed final=row-major conversion=device coordinates=bijective elements=65536
...
// LARGE-TILE: grid: 1,1,1 block: 256,1,1
// LARGE-TILE: timing_scope: gemm+device-output-conversion
// LARGE-TILE: kernel_only_per_launch_us:
// LARGE-TILE: output_check: passed mode=strict layout=row-major elements=65536
...
// WAVE-K4: m=128 n=256 k=512 bm=1 bn=4 wave_m_tiles=8 wave_n_tiles=4 wave_k_tiles=4
