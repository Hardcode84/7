...
// ASM-LABEL: uniform_thread_quotient_wave32:
// ASM: v_readfirstlane_b32 [[FIRST:s[0-9]+]],
// ASM: s_lshr_b32 [[QUOT:s[0-9]+]], [[FIRST]], 5
// ASM: s_lshl_b32 [[OFFSET:s[0-9]+]], [[QUOT]], 5
// ASM: buffer_load_{{[a-z0-9]+}} {{.*}}, [[OFFSET]] offen offset:12
// ASM: buffer_store_
// ASM: s_endpgm
module attributes {waveamdmachine.target = "amdgcn-amd-amdhsa--gfx1100"} {
func.func @uniform_thread_quotient_wave32(%input: !wave.ptr<#wave.global, i32>, %out: !wave.ptr<#wave.global, i32>) -> !wave.mem.token attributes {wave.kernel, wave.workgroup_size = array<i32: 256, 1, 1>} {
