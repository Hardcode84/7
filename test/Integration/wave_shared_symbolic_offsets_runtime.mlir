...
// RUN:   --hip-lib=%hip_runtime_lib --kernel=shared_symbolic_offsets --stride=1 %t.hsaco | FileCheck %s

// CHECK: shared_symbolic_offsets: 3072 output and guard values passed

module attributes {waveamdmachine.target = "amdgcn-amd-amdhsa--CHIP"} {
func.func @shared_symbolic_offsets(%input: !wave.ptr<#wave.global, i32>,
  ...
  %cancelled = wave.binary subi %twice, %x overflow<nsw> : !wave.simd<i32, WAVE_WIDTH>, !wave.simd<i32, WAVE_WIDTH> -> !wave.simd<i32, WAVE_WIDTH>
  %ks = wave.splat %k : i32 -> !wave.simd<i32, WAVE_WIDTH>
  %offset = wave.binary addi %cancelled, %ks overflow<nsw> : !wave.simd<i32, WAVE_WIDTH>, !wave.simd<i32, WAVE_WIDTH> -> !wave.simd<i32, WAVE_WIDTH>
  %a = wave.ptr_add %out, %offset : !wave.ptr<#wave.global, i32>, !wave.simd<i32, WAVE_WIDTH> -> !wave.simd<!wave.ptr<#wave.global, i32>, WAVE_WIDTH>
  %b = wave.ptr_add %second, %offset : !wave.ptr<#wave.global, i32>, !wave.simd<i32, WAVE_WIDTH> -> !wave.simd<!wave.ptr<#wave.global, i32>, WAVE_WIDTH>
