...
// CHECK-LABEL: address_arithmetic_contract_codegen:
...
func.func @address_arithmetic_contract_codegen(
  ...
  %scaled = wave.binary muli %lane, %two
      : !wave.simd<i32, 32>, !wave.simd<i32, 32>
      -> !wave.simd<i32, 32>
  %shifted = wave.binary shli %scaled, %one
      : !wave.simd<i32, 32>, !wave.simd<i32, 32>
      -> !wave.simd<i32, 32>
  %offset = wave.binary addi %base_splat, %shifted
      : !wave.simd<i32, 32>, !wave.simd<i32, 32>
      -> !wave.simd<i32, 32>
