...
// LOWER: [[PTR0:%.*]] = wave.ptr_add %arg0, [[ADDR0]]
// LOWER: {{%.*}}, {{%.*}} = wave.load [[PTR0]] after [[DEP]]
// LOWER: [[GUARD1:%.*]]:2 = wave.where
// LOWER: [[ADDR1:%.*]] = wave.index_expr <"1 + raw0"> assuming
// LOWER-SAME: #wave.pred<"1 + raw0 >= 0">
// LOWER-SAME: #wave.pred<"-1073741822 + raw0 <= 0">
// LOWER: [[PTR1:%.*]] = wave.ptr_add %arg0, [[ADDR1]]
