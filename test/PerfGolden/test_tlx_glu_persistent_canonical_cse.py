...
# CHECK: perf-golden: tlx_glu_persistent_canonical_cse: asm matches golden
...
NAME = "tlx_glu_persistent_canonical_cse"
...
def test_tlx_glu_persistent_canonical_cse() -> None:
