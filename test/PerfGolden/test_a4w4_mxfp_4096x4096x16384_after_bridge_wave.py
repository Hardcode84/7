...
# CHECK: perf-golden: a4w4_mxfp_4096x4096x16384.after_bridge.wave: asm matches golden
...
NAME = "a4w4_mxfp_4096x4096x16384.after_bridge.wave"
...
def test_a4w4_mxfp_4096x4096x16384_after_bridge_wave() -> None:
