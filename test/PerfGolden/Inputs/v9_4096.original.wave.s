...
.Lv9_beyond_hotloop.exec_endif_1:
		...
		v_cvt_pk_f16_f32 v72, v148, v149
		v_cvt_pk_f16_f32 v73, v150, v151
		v_mfma_f32_16x16x32_f16 v[124:127], v[52:55], v[32:35], v[124:127]
		v_mfma_f32_16x16x32_f16 v[140:143], v[52:55], v[40:43], v[140:143]
		v_mfma_f32_16x16x32_f16 v[128:131], v[60:63], v[32:35], v[128:131]
		v_mfma_f32_16x16x32_f16 v[144:147], v[60:63], v[40:43], v[144:147]
		...
		v_bitop3_b32 v0, v4, v6, v9 bitop3:0x96
		v_and_b32_e32 v1, 1, v1
		v_mov_b32_e32 v46, 8
		v_mul_lo_u32 v46, v46, v1
		v_and_b32_e32 v1, 1, v10
		v_mov_b32_e32 v81, 16
		v_mul_lo_u32 v81, v81, v1
		v_bitop3_b32 v0, v0, v46, v81 bitop3:0x96
		v_and_b32_e32 v1, 1, v80
		v_mov_b32_e32 v80, 32
		v_mul_lo_u32 v80, v80, v1
		v_xad_u32 v0, v0, v80, s15
		v_bitop3_b32 v1, 64, v4, v6 bitop3:0x96
		v_cmp_lt_i32_e64 s[2:3], v0, s8
		v_xor_b32_e32 v0, v1, v9
		v_bitop3_b32 v0, v0, v46, v81 bitop3:0x96
		v_xad_u32 v0, v0, v80, s15
		...
		v_bitop3_b32 v0, v0, v46, v81 bitop3:0x96
		v_xad_u32 v0, v0, v80, s15
		v_xor_b32_e32 v1, 0xc0, v4
		v_xor_b32_e32 v1, v1, v6
		v_xor_b32_e32 v1, v1, v9
		v_bitop3_b32 v1, v1, v46, v81 bitop3:0x96
		...
		v_bitop3_b32 v0, v1, v4, v5 bitop3:0x96
		v_add_u32_e32 v6, s27, v0
		v_bitop3_b32 v9, 32, v1, v4 bitop3:0x96
		v_cmp_lt_i32_e64 s[16:17], v6, s9
		v_xor_b32_e32 v6, v9, v5
		v_add_u32_e32 v9, s27, v6
		v_bitop3_b32 v11, 64, v1, v4 bitop3:0x96
		v_cmp_lt_i32_e64 s[18:19], v9, s9
		...
		v_cmp_lt_i32_e64 s[30:31], v4, s9
...
.Lv9_beyond_hotloop.exec_endif_17:
		...
		v_cmp_lt_i32_e64 s[16:17], v2, s9
		s_waitcnt lgkmcnt(10)
		...
		s_add_i32 s24, s33, s1
		s_add_i32 s24, s24, s13
		v_lshl_add_u32 v0, v4, 5, s24
