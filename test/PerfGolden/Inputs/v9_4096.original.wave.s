...
.Lv9_beyond_hotloop.if_end_0:
		...
		buffer_load_dwordx4 v8, s[16:19], 0 offen lds
		v_lshl_add_u32 v4, v4, 7, v9
		s_add_i32 m0, m0, 0x2100
		s_add_i32 s26, s0, s36
		...
		v_cmp_ne_u32_e64 vcc, v45, s37
		v_cmp_eq_u32_e64 s[38:39], v45, s37
		s_waitcnt lgkmcnt(0)
		s_barrier
...
.Lv9_beyond_hotloop.exec_endif_0:
		...
		s_setprio 0
		v_lshl_add_u32 v46, v2, 1, s25
		v_lshl_add_u32 v47, v2, 1, s27
		v_lshl_add_u32 v80, v2, 1, s30
		v_lshl_add_u32 v2, v2, 1, s31
		s_mov_b32 s25, 0x80
		s_mov_b32 s27, s25
...
.Lv9_beyond_hotloop.exec_endif_1:
		...
		v_bitop3_b32 v6, v4, v9, v11 bitop3:0x96
		...
		v_xad_u32 v1, v1, v45, s15
		v_bitop3_b32 v6, 64, v4, v9 bitop3:0x96
...
.Lv9_beyond_hotloop.exec_endif_15:
		...
		buffer_store_dwordx2 v[70:71], v2, s[20:23], 0 offen
...
.Lv9_beyond_hotloop.exec_endif_16:
		...
		buffer_store_dwordx2 v[82:83], v2, s[20:23], 0 offen
...
.Lv9_beyond_hotloop.exec_endif_17:
		...
		s_and_b64 s[40:41], s[6:7], s[14:15]
		s_and_b64 s[42:43], s[6:7], s[18:19]
		...
		s_and_b64 s[48:49], s[10:11], s[18:19]
