...
.Lv9_beyond_hotloop.exec_endif_1:
		...
		v_cmp_lt_i32_e64 s[16:17], v1, s8
		v_cmp_lt_i32_e64 s[20:21], v4, s8
		...
		s_and_b64 s[32:33], s[2:3], s[24:25]
		...
		s_and_b64 s[44:45], s[10:11], s[24:25]
		s_and_b64 s[46:47], s[10:11], s[26:27]
		s_and_b64 s[48:49], s[10:11], s[30:31]
		s_and_b64 s[50:51], s[10:11], s[36:37]
		s_and_b64 s[52:53], s[16:17], s[24:25]
		s_and_b64 s[54:55], s[16:17], s[26:27]
		s_and_b64 s[56:57], s[16:17], s[30:31]
		s_and_b64 s[58:59], s[16:17], s[36:37]
		...
		v_cndmask_b32_e64 v5, v10, v5, s[32:33]
		s_mov_b32 s60, s6
		s_mov_b32 s61, s7
		s_mov_b32 s62, s22
		s_mov_b32 s63, s23
		buffer_store_dwordx2 v[2:3], v5, s[60:63], 0 offen
		s_add_i32 s6, s1, 64
		s_add_i32 s7, s6, s4
		s_add_i32 s7, s7, s0
		s_add_i32 s7, s7, s5
		s_add_i32 s7, s7, s19
		v_lshl_add_u32 v2, v4, 1, s7
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[38:39]
		buffer_store_dwordx2 v[46:47], v2, s[60:63], 0 offen
		s_add_i32 s7, s1, 0x80
		s_add_i32 s8, s7, s4
		s_add_i32 s8, s8, s0
		s_add_i32 s8, s8, s5
		s_add_i32 s8, s8, s19
		...
		buffer_store_dwordx2 v[48:49], v2, s[60:63], 0 offen
		...
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[44:45]
		...
		v_lshl_add_u32 v2, v4, 1, s14
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[46:47]
		buffer_store_dwordx2 v[58:59], v2, s[60:63], 0 offen
		...
		buffer_store_dwordx2 v[64:65], v2, s[60:63], 0 offen
		...
		v_lshl_add_u32 v2, v4, 1, s15
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[54:55]
		buffer_store_dwordx2 v[74:75], v2, s[60:63], 0 offen
		...
		buffer_store_dwordx2 v[68:69], v2, s[60:63], 0 offen
		...
		s_add_i32 s6, s6, s5
		s_add_i32 s6, s6, s19
		v_lshl_add_u32 v2, v4, 1, s6
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[26:27]
		buffer_store_dwordx2 v[80:81], v2, s[60:63], 0 offen
		s_add_i32 s6, s7, s12
		s_add_i32 s6, s6, s4
		s_add_i32 s6, s6, s0
		s_add_i32 s6, s6, s5
		...
		v_lshl_add_u32 v2, v4, 1, s6
		v_add3_u32 v2, v2, v7, v9
		v_cndmask_b32_e64 v2, v10, v2, s[30:31]
		buffer_store_dwordx2 v[70:71], v2, s[60:63], 0 offen
		s_add_i32 s6, s8, s12
		s_add_i32 s6, s6, s4
		s_add_i32 s6, s6, s0
		s_add_i32 s6, s6, s5
		...
		s_and_b64 s[32:33], s[10:11], s[22:23]
		s_and_b64 s[36:37], s[10:11], s[24:25]
		v_mfma_f32_16x16x32_f16 v[180:183], v[100:103], v[20:23], v[180:183]
		s_and_b64 s[38:39], s[10:11], s[6:7]
		s_and_b64 s[10:11], s[10:11], s[26:27]
		s_and_b64 s[40:41], s[16:17], s[22:23]
		v_mfma_f32_16x16x32_f16 v[168:171], v[52:55], v[20:23], v[168:171]
		s_and_b64 s[42:43], s[16:17], s[24:25]
		...
		v_cvt_pk_f16_f32 v12, v156, v157
		v_mfma_f32_16x16x32_f16 v[184:187], v[60:63], v[32:35], v[184:187]
		v_cvt_pk_f16_f32 v13, v158, v159
		v_cvt_pk_f16_f32 v14, v160, v161
		v_cvt_pk_f16_f32 v15, v162, v163
		v_mfma_f32_16x16x32_f16 v[188:191], v[88:91], v[32:35], v[188:191]
		v_cvt_pk_f16_f32 v16, v164, v165
		v_cvt_pk_f16_f32 v17, v166, v167
		...
		s_add_i32 s9, s9, s5
		s_add_i32 s9, s9, s19
		v_lshl_add_u32 v5, v4, 1, s9
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[28:29]
		buffer_store_dwordx2 v[12:13], v5, s[60:63], 0 offen
		s_add_i32 s9, s1, 0x180
		s_add_i32 s15, s9, s4
		s_add_i32 s15, s15, s0
		s_add_i32 s15, s15, s5
		s_add_i32 s15, s15, s19
		v_lshl_add_u32 v5, v4, 1, s15
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[30:31]
		buffer_store_dwordx2 v[14:15], v5, s[60:63], 0 offen
		...
		buffer_store_dwordx2 v[16:17], v5, s[60:63], 0 offen
		s_add_i32 s2, s35, s13
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		s_add_i32 s2, s2, s19
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[32:33]
		buffer_store_dwordx2 v[18:19], v5, s[60:63], 0 offen
		s_add_i32 s2, s8, s13
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[36:37]
		buffer_store_dwordx2 v[20:21], v5, s[60:63], 0 offen
		s_add_i32 s2, s9, s13
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[38:39]
		buffer_store_dwordx2 v[22:23], v5, s[60:63], 0 offen
		s_add_i32 s2, s1, s13
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		buffer_store_dwordx2 v[24:25], v5, s[60:63], 0 offen
		s_add_i32 s2, s35, s14
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		s_add_i32 s2, s2, s19
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[40:41]
		buffer_store_dwordx2 v[26:27], v5, s[60:63], 0 offen
		s_add_i32 s2, s8, s14
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[42:43]
		buffer_store_dwordx2 v[28:29], v5, s[60:63], 0 offen
		s_add_i32 s2, s9, s14
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[44:45]
		buffer_store_dwordx2 v[30:31], v5, s[60:63], 0 offen
		s_add_i32 s2, s1, s14
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		buffer_store_dwordx2 v[32:33], v5, s[60:63], 0 offen
		...
		v_lshl_add_u32 v5, v4, 1, s2
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[24:25]
		buffer_store_dwordx2 v[36:37], v5, s[60:63], 0 offen
		s_add_i32 s2, s9, s12
		s_add_i32 s2, s2, s4
		s_add_i32 s2, s2, s0
		s_add_i32 s2, s2, s5
		...
		s_add_i32 s0, s0, s5
		s_add_i32 s0, s0, s19
		v_lshl_add_u32 v4, v4, 1, s0
		v_add3_u32 v5, v5, v7, v9
		v_cndmask_b32_e64 v5, v10, v5, s[6:7]
		buffer_store_dwordx2 v[0:1], v5, s[60:63], 0 offen
		v_add3_u32 v0, v4, v7, v9
		v_cndmask_b32_e64 v0, v10, v0, s[20:21]
		buffer_store_dwordx2 v[2:3], v0, s[60:63], 0 offen
		s_endpgm
