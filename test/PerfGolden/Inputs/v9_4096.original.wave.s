...
.Lv9_beyond_hotloop.loop_head_0:
		...
		v_add_u32_e32 v62, s24, v61
		buffer_load_dwordx4 v62, s[16:19], 0 offen lds
		s_add_i32 m0, s2, 0x4200
		v_add_u32_e32 v62, s26, v61
		buffer_load_dwordx4 v62, s[16:19], 0 offen lds
		s_add_i32 m0, s2, 0x6300
		v_add_u32_e32 v61, s27, v61
		buffer_load_dwordx4 v61, s[16:19], 0 offen lds
		s_add_i32 m0, s2, 0x107c0
...
.Lv9_beyond_hotloop.loop_exit_0:
		...
		s_mov_b32 s22, s18
		s_mov_b32 s23, s19
		buffer_store_dwordx2 v[60:61], v19, s[20:23], 0 offen
		...
		buffer_store_dwordx2 v[4:5], v60, s[20:23], 0 offen
		...
		buffer_store_dwordx2 v[62:63], v5, s[20:23], 0 offen
		...
		v_cndmask_b32_e64 v10, v126, v10, s[26:27]
		...
		s_and_b32 s26, s24, s10
		s_and_b32 s27, s25, s11
		v_lshl_add_u32 v8, v4, 1, v8
		v_cndmask_b32_e64 v8, v126, v8, s[26:27]
		...
		s_and_b32 s28, s26, s2
		s_and_b32 s29, s27, s3
		...
		v_cndmask_b32_e64 v12, v126, v12, s[28:29]
		buffer_store_dwordx2 v[106:107], v12, s[20:23], 0 offen
		s_and_b32 s28, s26, s10
		s_and_b32 s29, s27, s11
		...
		s_and_b32 s32, s28, s2
		s_and_b32 s33, s29, s3
		...
		s_and_b32 s2, s28, s18
		s_and_b32 s3, s29, s19
		...
		s_add_i32 s0, s0, s17
		v_lshl_add_u32 v5, v11, 6, s0
		v_add3_u32 v5, v5, v24, v120
		v_add3_u32 v5, v5, v121, v122
		v_add3_u32 v5, v5, v123, v26
		...
		s_and_b32 s4, s26, s10
		s_and_b32 s5, s27, s11
		v_lshl_add_u32 v2, v4, 1, v2
		v_cndmask_b32_e64 v2, v126, v2, s[4:5]
		buffer_store_dwordx2 v[40:41], v2, s[20:23], 0 offen
		s_and_b32 s4, s26, s12
		s_and_b32 s5, s27, s13
