...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_0:
		...
		s_setprio 0
		s_mul_i32 s41, 0x180, s17
		s_add_i32 s41, s41, s23
		s_add_i32 s41, s41, s25
		v_add_u32_e32 v1, s41, v26
		v_add3_u32 v13, v1, v50, v52
		s_mul_i32 s17, 0x188, s17
		s_add_i32 s17, s17, s23
		s_add_i32 s17, s17, s25
		v_add_u32_e32 v1, s17, v26
		v_add3_u32 v49, v1, v50, v52
		v_add_u32_e32 v1, 0x180, v43
		s_lshl_b32 s15, s15, 1
		v_mul_lo_u32 v24, s15, v24
		v_mul_lo_u32 v6, s15, v6
		v_add_u32_e32 v24, v1, v24
		v_add_u32_e32 v1, v1, v6
		v_add_u32_e32 v6, v44, v47
		v_add3_u32 v43, v45, v53, v54
		v_add3_u32 v35, v43, v51, v35
		s_cmp_lt_i32 0, s40
...
.Ltlx_addmm_glu_kernel_optimized_async.loop_head_0:
		...
		v_cmp_lt_i32_e64 s[44:45], v48, s25
		s_mul_i32 s41, -1, s17
		s_add_i32 s41, s41, 0x80000000
		v_mov_b32_e32 v43, s41
		v_cndmask_b32_e32 v44, v43, v24, vcc
		v_cndmask_b32_e32 v43, v43, v1, vcc
		v_cmp_lt_i32_e64 vcc, v12, s25
		s_mul_i32 s15, 0x4200, s15
		s_add_i32 s15, s3, s15
		v_cndmask_b32_e32 v45, v46, v49, vcc
		s_mov_b32 m0, s15
		s_mul_i32 s25, 0x4200, s23
		buffer_load_dwordx4 v44, s[28:31], s17 offen lds
		s_add_i32 s41, s36, s25
		s_add_i32 m0, m0, 0x2100
		s_add_i32 s25, s39, s25
		buffer_load_dwordx4 v43, s[28:31], s17 offen lds
		v_add_u32_e32 v43, s25, v35
		s_add_i32 m0, m0, 0xa4e0
		s_add_i32 m0, s15, 0xc5e0
		v_cndmask_b32_e64 v44, v46, v13, s[44:45]
		buffer_load_dwordx4 v44, s[32:35], 0 offen lds
		s_nop 0
		s_add_i32 m0, s15, 0xe6e0
		v_add_u32_e32 v44, s41, v6
		...
		ds_read_b64_tr_b16 v[88:89], v43 offset:50656
		ds_read_b64_tr_b16 v[90:91], v43 offset:59104
		ds_read_b64_tr_b16 v[92:93], v43 offset:51168
		ds_read_b64_tr_b16 v[94:95], v43 offset:59616
		ds_read_b64_tr_b16 v[96:97], v43 offset:50784
		ds_read_b64_tr_b16 v[98:99], v43 offset:59232
		ds_read_b64_tr_b16 v[100:101], v43 offset:51296
		ds_read_b64_tr_b16 v[102:103], v43 offset:59744
		s_setprio 0
		s_waitcnt lgkmcnt(0)
		s_barrier
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_1:
		...
		s_waitcnt lgkmcnt(6)
		v_mfma_f32_16x16x32_f16 v[52:55], v[68:71], v[20:23], v[52:55]
		...
		v_mfma_f32_16x16x32_f16 v[52:55], v[72:75], v[24:27], v[52:55]
		s_waitcnt lgkmcnt(0)
		...
		s_add_i32 s2, s2, s38
		v_add_u32_e32 v2, s2, v35
		ds_read_b64_tr_b16 v[32:33], v2 offset:50656
		ds_read_b64_tr_b16 v[34:35], v2 offset:59104
		...
		s_waitcnt lgkmcnt(6)
		v_mfma_f32_16x16x32_f16 v[52:55], v[32:35], v[20:23], v[52:55]
		...
		v_mfma_f32_16x16x32_f16 v[124:127], v[32:35], v[60:63], v[124:127]
		...
		v_mfma_f32_16x16x32_f16 v[120:123], v[76:79], v[56:59], v[120:123]
		v_mfma_f32_16x16x32_f16 v[128:131], v[76:79], v[64:67], v[128:131]
		v_mfma_f32_16x16x32_f16 v[124:127], v[68:71], v[64:67], v[124:127]
		s_lshl_b32 s2, s24, 2
		s_lshl_b32 s3, s27, 3
		s_xor_b32 s4, s2, s3
