...
.Ltlx_addmm_glu_kernel_optimized_async.if_end_0:
		...
		v_cndmask_b32_e64 v44, v49, v37, s[24:25]
		...
		v_cndmask_b32_e32 v22, v49, v22, vcc
		s_add_i32 m0, m0, 0x2100
		v_lshlrev_b32_e32 v51, 7, v14
		v_lshrrev_b32_e32 v52, 4, v48
		...
		v_mul_lo_u32 v54, v54, v22
		v_add3_u32 v22, v51, v53, v54
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_1:
		...
		ds_read_b64_tr_b16 v[80:81], v15 offset:50656
		ds_read_b64_tr_b16 v[82:83], v15 offset:59104
		ds_read_b64_tr_b16 v[84:85], v15 offset:51168
		ds_read_b64_tr_b16 v[86:87], v15 offset:59616
		ds_read_b64_tr_b16 v[88:89], v15 offset:50784
		ds_read_b64_tr_b16 v[90:91], v15 offset:59232
		ds_read_b64_tr_b16 v[92:93], v15 offset:51296
		ds_read_b64_tr_b16 v[94:95], v15 offset:59744
		s_waitcnt lgkmcnt(6)
		...
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[108:111], v[84:87], v[20:23], v[108:111]
		...
		v_and_b32_e32 v3, 1, v48
		v_lshl_add_u32 v2, v3, 5, v2
		v_lshlrev_b32_e32 v3, 1, v3
		v_bitop3_b32 v2, v13, v2, v3 bitop3:0x96
		...
		v_pk_add_f32 v[30:31], v[32:33], v[18:19]
		v_pk_add_f32 v[32:33], v[34:35], v[20:21]
		v_pk_add_f32 v[34:35], v[44:45], v[22:23]
		v_pk_add_f32 v[44:45], v[46:47], v[26:27]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[48:51], v2
		ds_read_b128 v[52:55], v2 offset:256
		v_bitop3_b32 v3, v5, v43, v39 bitop3:0x96
		...
		v_pk_add_f32 v[50:51], v[52:53], v[22:23]
		v_pk_add_f32 v[52:53], v[54:55], v[26:27]
		v_bitop3_b32 v0, v6, v39, v42 bitop3:0x96
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_add_f32 v[22:23], v[62:63], v[26:27]
		...
		v_pk_fma_f32 v[70:71], v[8:9], v[26:27], v[8:9]
		v_pk_fma_f32 v[8:9], v[10:11], v[36:37], v[10:11]
		v_pk_fma_f32 v[10:11], v[12:13], v[42:43], v[12:13]
		v_pk_fma_f32 v[12:13], v[14:15], v[54:55], v[14:15]
		v_pk_fma_f32 v[14:15], v[30:31], v[56:57], v[30:31]
		v_pk_fma_f32 v[26:27], v[32:33], v[58:59], v[32:33]
		...
		v_pk_fma_f32 v[36:37], v[48:49], v[74:75], v[48:49]
		...
		v_pk_fma_f32 v[20:21], v[22:23], v[80:81], v[22:23]
		v_xad_u32 v3, v3, v38, s16
		v_xad_u32 v0, v0, v38, s16
		v_xad_u32 v2, v2, v38, s16
		v_xad_u32 v5, v5, v38, s16
		v_xad_u32 v16, v17, v41, s20
