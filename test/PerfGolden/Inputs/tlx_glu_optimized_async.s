...
.Ltlx_addmm_glu_kernel_optimized_async.if_end_0:
		...
		v_xad_u32 v34, v6, -1, 1
		v_cndmask_b32_e32 v6, v6, v34, vcc
		v_mul_hi_u32 v34, v6, v28
		v_mul_lo_u32 v34, v34, v27
		v_xor_b32_e32 v34, -1, v34
		v_add3_u32 v6, 1, v34, v6
		v_add_u32_e32 v34, v6, v29
		v_cmp_ge_u32_e64 vcc, v6, v27
		v_add3_u32 v35, 24, v18, s16
		...
		v_xad_u32 v39, v31, -1, 1
		v_cndmask_b32_e32 v31, v31, v39, vcc
		v_mul_hi_u32 v39, v31, v28
		v_mul_lo_u32 v39, v39, v27
		v_xor_b32_e32 v39, -1, v39
		v_add3_u32 v31, 1, v39, v31
		v_add_u32_e32 v39, v31, v29
		v_cmp_ge_u32_e64 vcc, v31, v27
		v_add3_u32 v40, 56, v18, s16
		...
		v_cndmask_b32_e32 v30, v31, v39, vcc
		...
		v_mul_hi_u32 v41, v33, v28
		v_mul_lo_u32 v41, v41, v27
		v_xor_b32_e32 v41, -1, v41
		v_add3_u32 v33, 1, v41, v33
		v_add_u32_e32 v41, v33, v29
		...
		v_cndmask_b32_e64 v6, v6, v34, s[30:31]
		v_cndmask_b32_e32 v33, v33, v41, vcc
		...
		v_cndmask_b32_e64 v31, v32, v39, s[24:25]
		v_cndmask_b32_e32 v32, v35, v41, vcc
		v_add_u32_e32 v35, v32, v29
		v_cmp_ge_u32_e64 vcc, v32, v27
		...
		s_mov_b64 s[30:31], vcc
		v_xad_u32 v45, v21, -1, 1
		v_cndmask_b32_e32 v21, v21, v45, vcc
		v_mul_hi_u32 v45, v21, v28
		v_mul_lo_u32 v45, v45, v27
		v_xor_b32_e32 v45, -1, v45
		v_add3_u32 v21, 1, v45, v21
		v_cmp_ge_u32_e64 vcc, v21, v27
		v_cndmask_b32_e64 v20, v20, v40, s[24:25]
		v_add_u32_e32 v40, v21, v29
		v_cndmask_b32_e32 v21, v21, v40, vcc
		v_cmp_ge_u32_e64 vcc, v21, v27
		v_add_u32_e32 v40, v21, v29
		v_lshrrev_b32_e32 v45, 2, v0
		v_cndmask_b32_e32 v21, v21, v40, vcc
		v_xad_u32 v40, v21, -1, 1
		v_cmp_lt_i32_e64 vcc, v22, s22
		s_mov_b64 s[24:25], vcc
		v_xad_u32 v46, v22, -1, 1
		v_cndmask_b32_e32 v22, v22, v46, vcc
		v_mul_hi_u32 v46, v22, v28
		v_mul_lo_u32 v46, v46, v27
		v_xor_b32_e32 v46, -1, v46
		v_add3_u32 v22, 1, v46, v22
		v_cmp_ge_u32_e64 vcc, v22, v27
		v_cndmask_b32_e64 v21, v21, v40, s[30:31]
		v_add_u32_e32 v40, v22, v29
		v_cndmask_b32_e32 v22, v22, v40, vcc
		v_cmp_ge_u32_e64 vcc, v22, v27
		v_add_u32_e32 v40, v22, v29
		v_lshrrev_b32_e32 v46, 1, v0
		v_cndmask_b32_e32 v22, v22, v40, vcc
		v_xad_u32 v40, v22, -1, 1
		v_cmp_lt_i32_e64 vcc, v23, s22
		s_mov_b64 s[30:31], vcc
		v_xad_u32 v47, v23, -1, 1
		v_cndmask_b32_e32 v23, v23, v47, vcc
		v_mul_hi_u32 v47, v23, v28
		v_mul_lo_u32 v47, v47, v27
		v_xor_b32_e32 v47, -1, v47
		v_add3_u32 v23, 1, v47, v23
		v_cmp_ge_u32_e64 vcc, v23, v27
		v_cndmask_b32_e64 v22, v22, v40, s[24:25]
		v_add_u32_e32 v40, v23, v29
		...
		s_mov_b64 s[24:25], vcc
		v_xad_u32 v48, v24, -1, 1
		v_cndmask_b32_e32 v24, v24, v48, vcc
		v_mul_hi_u32 v48, v24, v28
		v_mul_lo_u32 v48, v48, v27
		v_xor_b32_e32 v48, -1, v48
		v_add3_u32 v24, 1, v48, v24
		v_cmp_ge_u32_e64 vcc, v24, v27
		v_cndmask_b32_e64 v23, v23, v40, s[30:31]
		v_add_u32_e32 v40, v24, v29
		...
		s_cmp_lt_i32 s13, 0
		s_cselect_b32 s32, s26, s28
		s_cselect_b32 s33, s27, s29
		s_add_i32 s23, s23, 1
		v_mov_b32_e32 v28, s23
		v_cndmask_b32_e64 v28, v48, v28, s[32:33]
		...
		v_mul_lo_u32 v40, v29, v2
		v_mul_hi_u32 v40, v2, v40
		v_add_u32_e32 v2, v2, v40
		v_mul_hi_u32 v40, v16, v2
		v_mul_lo_u32 v40, v40, v28
		v_xor_b32_e32 v40, -1, v40
		v_add3_u32 v16, 1, v40, v16
		v_cmp_ge_u32_e64 vcc, v16, v28
		v_add_u32_e32 v40, v16, v29
		v_mov_b32_e32 v48, 8
		...
		v_cmp_ge_u32_e64 vcc, v2, v28
		v_cndmask_b32_e64 v16, v16, v40, s[24:25]
		v_add_u32_e32 v17, v2, v29
		...
		v_mul_lo_u32 v40, v40, v28
		v_bitop3_b32 v28, v48, v29, v40 bitop3:0x96
		...
		v_cndmask_b32_e32 v47, v46, v40, vcc
		s_lshr_b32 s2, s2, 6
		s_mul_i32 s3, 0x420, s2
		s_mov_b32 m0, s3
		v_cndmask_b32_e64 v25, v25, v27, s[30:31]
		buffer_load_dwordx4 v47, s[32:35], 0 offen lds
		v_lshl_add_u32 v27, v42, 1, v29
		v_add3_u32 v27, v27, v43, v44
		v_cndmask_b32_e32 v42, v46, v27, vcc
		s_add_i32 m0, m0, 0x2100
		s_add_i32 s4, s24, s23
		buffer_load_dwordx4 v42, s[32:35], 0 offen lds
		v_bitop3_b32 v42, v41, v39, v10 bitop3:0x96
		v_bitop3_b32 v42, v42, v13, v36 bitop3:0x96
		v_bitop3_b32 v39, 4, v41, v39 bitop3:0x96
		v_xor_b32_e32 v39, v39, v10
		v_cmp_lt_i32_e64 vcc, v42, s14
		...
		v_cmp_lt_i32_e64 vcc, v42, s5
		s_lshl_b32 s5, s17, 8
		v_add_u32_e32 v27, s5, v47
		v_cndmask_b32_e32 v27, v46, v27, vcc
		s_add_i32 m0, m0, 0xa4e0
		v_add_u32_e32 v41, s5, v17
		buffer_load_dwordx4 v27, s[36:39], 0 offen lds
		v_cndmask_b32_e32 v27, v46, v41, vcc
		s_add_i32 m0, m0, 0x2100
		...
		v_add3_u32 v41, v41, v45, v50
		ds_read_b128 v[52:55], v41
		ds_read_b128 v[56:59], v41 offset:64
		ds_read_b128 v[60:63], v41 offset:256
		ds_read_b128 v[64:67], v41 offset:320
		ds_read_b128 v[68:71], v41 offset:512
		ds_read_b128 v[72:75], v41 offset:576
		ds_read_b128 v[76:79], v41 offset:768
		ds_read_b128 v[80:83], v41 offset:832
...
.Ltlx_addmm_glu_kernel_optimized_async.loop_head_0:
		...
		v_cmp_lt_i32_e64 vcc, v28, s27
		v_cmp_lt_i32_e64 s[28:29], v42, s27
		s_lshl_b32 s30, s22, 7
		v_cndmask_b32_e32 v6, v46, v40, vcc
		s_mul_i32 s23, 0x4200, s23
		v_cndmask_b32_e32 v39, v46, v26, vcc
		s_add_i32 s23, s3, s23
		v_cmp_lt_i32_e64 vcc, v13, s27
		s_mov_b32 m0, s23
		s_nop 0
		buffer_load_dwordx4 v6, s[32:35], s30 offen lds
		s_mul_i32 s23, s17, s22
		s_add_i32 m0, m0, 0x2100
		s_lshl_b32 s23, s23, 7
		buffer_load_dwordx4 v39, s[32:35], s30 offen lds
		s_add_i32 s23, s15, s23
		v_add_u32_e32 v6, s23, v47
		v_cndmask_b32_e64 v6, v46, v6, s[28:29]
		s_add_i32 m0, m0, 0xa4e0
		...
		s_add_i32 m0, m0, 0x2100
		v_add_u32_e32 v45, s27, v9
		buffer_load_dwordx4 v6, s[36:39], 0 offen lds
		s_barrier
		s_waitcnt vmcnt(4)
		ds_read_b128 v[52:55], v39
		ds_read_b128 v[56:59], v39 offset:64
		ds_read_b128 v[60:63], v39 offset:256
		ds_read_b128 v[64:67], v39 offset:320
		ds_read_b128 v[68:71], v39 offset:512
		ds_read_b128 v[72:75], v39 offset:576
		ds_read_b128 v[76:79], v39 offset:768
		ds_read_b128 v[80:83], v39 offset:832
		ds_read_b64_tr_b16 v[84:85], v45 offset:50656
		ds_read_b64_tr_b16 v[86:87], v45 offset:59104
		ds_read_b64_tr_b16 v[88:89], v45 offset:51168
		ds_read_b64_tr_b16 v[90:91], v45 offset:59616
		ds_read_b64_tr_b16 v[92:93], v45 offset:50784
		ds_read_b64_tr_b16 v[94:95], v45 offset:59232
		ds_read_b64_tr_b16 v[96:97], v45 offset:51296
		ds_read_b64_tr_b16 v[98:99], v45 offset:59744
		s_setprio 0
		s_waitcnt lgkmcnt(0)
		s_barrier
		s_add_i32 s22, s22, 1
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_1:
		...
		v_add_lshl_u32 v6, v2, v6, 1
		buffer_load_dword v6, s[28:31], 0 offen lds
		v_mul_lo_u32 v6, s18, v38
		s_add_i32 m0, m0, 0x840
		v_add_lshl_u32 v6, v2, v6, 1
		v_lshl_add_u32 v13, v14, 8, v27
		...
		v_bitop3_b32 v6, v0, v6, v7 bitop3:0x96
		v_mov_b32_e32 v7, 2
		...
		s_mov_b32 s30, s34
		s_mov_b32 s31, s35
		buffer_load_dwordx4 v[20:23], v16, s[28:31], 0 offen
		...
		v_lshl_add_u32 v12, v9, 7, v13
		v_lshrrev_b32_e32 v13, 1, v36
		v_and_b32_e32 v13, 1, v13
		v_lshl_add_u32 v12, v13, 6, v12
		v_and_b32_e32 v14, 1, v36
		v_lshl_add_u32 v12, v14, 5, v12
		v_lshlrev_b32_e32 v14, 1, v14
		v_lshlrev_b32_e32 v13, 2, v13
		v_lshlrev_b32_e32 v9, 3, v9
		v_bitop3_b32 v9, v13, v9, v6 bitop3:0x96
		v_bitop3_b32 v9, v12, v14, v9 bitop3:0x96
		v_lshlrev_b32_e32 v9, 4, v9
		v_lshl_add_u32 v6, v6, 13, v9
		ds_read_b128 v[12:15], v6
		ds_read_b128 v[16:19], v6 offset:256
		s_waitcnt vmcnt(0)
		...
		ds_read_b128 v[36:39], v6 offset:256
		...
		v_pk_add_f32 v[40:41], v[52:53], v[20:21]
		...
		v_bitop3_b32 v6, 32, v5, v7 bitop3:0x96
		...
		v_cvt_f32_f16_sdwa v65, v48 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v66, v49
		v_cvt_f32_f16_sdwa v67, v49 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_sdwa v69, v51 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt lgkmcnt(2)
		...
		v_cvt_f32_f16_sdwa v71, v53 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_sdwa v73, v55 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt lgkmcnt(1)
		...
		v_cvt_f32_f16_sdwa v75, v57 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_sdwa v77, v59 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt lgkmcnt(0)
		...
		v_cvt_f32_f16_sdwa v79, v61 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v60, v62
		v_cvt_f32_f16_sdwa v61, v62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v80, v63
		v_cvt_f32_f16_sdwa v81, v63 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[62:63], v[12:13], v[64:65], v[12:13]
		v_pk_fma_f32 v[12:13], v[14:15], v[66:67], v[14:15]
		v_pk_fma_f32 v[14:15], v[16:17], v[48:49], v[16:17]
		v_pk_fma_f32 v[16:17], v[18:19], v[68:69], v[18:19]
		v_pk_fma_f32 v[18:19], v[22:23], v[50:51], v[22:23]
		v_pk_fma_f32 v[22:23], v[32:33], v[70:71], v[32:33]
		v_pk_fma_f32 v[32:33], v[34:35], v[52:53], v[34:35]
		v_pk_fma_f32 v[34:35], v[36:37], v[72:73], v[36:37]
		v_pk_fma_f32 v[36:37], v[38:39], v[54:55], v[38:39]
		v_pk_fma_f32 v[38:39], v[2:3], v[74:75], v[2:3]
		v_pk_fma_f32 v[2:3], v[40:41], v[56:57], v[40:41]
		v_pk_fma_f32 v[40:41], v[46:47], v[76:77], v[46:47]
		v_pk_fma_f32 v[46:47], v[24:25], v[58:59], v[24:25]
		v_pk_fma_f32 v[24:25], v[26:27], v[78:79], v[26:27]
		v_pk_fma_f32 v[26:27], v[20:21], v[60:61], v[20:21]
		v_pk_fma_f32 v[20:21], v[30:31], v[80:81], v[30:31]
		v_xad_u32 v0, v6, v11, s16
		v_xad_u32 v6, v9, v11, s16
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_else_5:
		s_andn2_b64 exec, s[40:41], s[8:9]
