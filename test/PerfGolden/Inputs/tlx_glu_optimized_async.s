...
.Ltlx_addmm_glu_kernel_optimized_async.if_end_0:
		...
		v_bitop3_b32 v49, 4, v57, v56 bitop3:0x96
		...
		v_mul_lo_u32 v63, s17, v52
		v_lshlrev_b32_e32 v63, 5, v63
		v_add3_u32 v56, v56, v57, v63
		...
		v_bitop3_b32 v13, v49, v13, v55 bitop3:0x96
		v_add3_u32 v39, v41, v57, v63
		v_cndmask_b32_e32 v39, v50, v39, vcc
		s_add_i32 m0, m0, 0x2100
		v_add3_u32 v41, v58, v57, v63
		...
		v_add3_u32 v39, v39, v57, v63
		v_cndmask_b32_e32 v39, v50, v39, vcc
		s_add_i32 m0, m0, 0xa4e0
		v_cndmask_b32_e32 v40, v50, v41, vcc
		buffer_load_dwordx4 v39, s[48:51], 0 offen lds
		...
		v_add3_u32 v28, v38, v54, v53
		v_add3_u32 v28, v28, v57, v63
		v_cndmask_b32_e32 v28, v50, v28, vcc
		s_add_i32 m0, m0, 0xa4e0
		v_and_b32_e32 v38, 63, v0
		buffer_load_dwordx4 v28, s[48:51], 0 offen lds
		v_add3_u32 v28, v61, v57, v63
		v_cndmask_b32_e32 v28, v50, v28, vcc
		s_add_i32 m0, m0, 0x2100
		v_lshlrev_b32_e32 v39, 7, v14
		...
		v_add3_u32 v39, v39, v43, v49
		ds_read_b128 v[64:67], v39
		ds_read_b128 v[68:71], v39 offset:64
		ds_read_b128 v[72:75], v39 offset:256
		ds_read_b128 v[76:79], v39 offset:320
		ds_read_b128 v[80:83], v39 offset:512
		ds_read_b128 v[84:87], v39 offset:576
		ds_read_b128 v[88:91], v39 offset:768
		ds_read_b128 v[92:95], v39 offset:832
		v_lshlrev_b32_e32 v43, 6, v11
		v_lshl_add_u32 v40, v40, 3, v43
		v_lshl_add_u32 v40, v9, 5, v40
		v_lshlrev_b32_e32 v43, 8, v7
		v_mov_b32_e32 v48, 0x1080
		v_mul_lo_u32 v48, v48, v52
		v_add3_u32 v40, v40, v43, v48
		v_mov_b32_e32 v43, 0x420
		v_mul_lo_u32 v43, v43, v41
		v_add3_u32 v40, v40, v51, v43
		ds_read_b64_tr_b16 v[96:97], v40 offset:50656
		ds_read_b64_tr_b16 v[98:99], v40 offset:59104
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_0:
		...
		v_add_u32_e32 v41, 0x180, v41
		s_lshl_b32 s4, s15, 1
		v_mul_lo_u32 v26, s4, v26
		v_mul_lo_u32 v6, s4, v6
		v_add_u32_e32 v43, v41, v26
		v_add_u32_e32 v26, v41, v6
...
.Ltlx_addmm_glu_kernel_optimized_async.loop_head_0:
		...
		v_mfma_f32_16x16x32_f16 v[116:119], v[104:107], v[64:67], v[116:119]
		v_mfma_f32_16x16x32_f16 v[124:127], v[104:107], v[72:75], v[124:127]
		...
		s_cmp_ge_u32 s15, 2
		v_mfma_f32_16x16x32_f16 v[136:139], v[96:99], v[88:91], v[136:139]
		s_cselect_b32 s24, 1, 0
		s_add_i32 s25, s15, -2
		v_mfma_f32_16x16x32_f16 v[112:115], v[100:103], v[68:71], v[112:115]
		s_add_i32 s26, s15, 1
		v_mfma_f32_16x16x32_f16 v[116:119], v[108:111], v[68:71], v[116:119]
		s_cmp_lg_u32 s24, 0
		s_cselect_b32 s24, s25, s26
		v_mfma_f32_16x16x32_f16 v[124:127], v[108:111], v[76:79], v[124:127]
		s_add_i32 s25, s22, 3
		...
		v_mfma_f32_16x16x32_f16 v[132:135], v[108:111], v[84:87], v[132:135]
		v_mfma_f32_16x16x32_f16 v[140:143], v[108:111], v[92:95], v[140:143]
		v_mfma_f32_16x16x32_f16 v[136:139], v[100:103], v[92:95], v[136:139]
		s_setprio 1
		s_barrier
		s_xor_b32 s25, s25, -1
		s_add_i32 s25, s25, 1
		...
		v_cndmask_b32_e32 v41, v6, v43, vcc
		...
		buffer_load_dwordx4 v41, s[44:47], s23 offen lds
		...
		v_add3_u32 v6, v6, v57, v63
		v_cndmask_b32_e64 v6, v50, v6, s[26:27]
		s_add_i32 m0, m0, 0xa4e0
		s_add_i32 s15, s5, s15
		v_add_u32_e32 v41, s15, v27
		buffer_load_dwordx4 v6, s[48:51], 0 offen lds
		v_add3_u32 v6, v41, v54, v53
		v_add3_u32 v6, v6, v57, v63
		...
		buffer_load_dwordx4 v6, s[48:51], 0 offen lds
		s_barrier
		v_add_u32_e32 v6, s15, v39
		v_add_u32_e32 v41, s15, v40
		s_waitcnt vmcnt(4)
		ds_read_b128 v[64:67], v6
		ds_read_b128 v[68:71], v6 offset:64
		ds_read_b128 v[72:75], v6 offset:256
		ds_read_b128 v[76:79], v6 offset:320
		ds_read_b128 v[80:83], v6 offset:512
		ds_read_b128 v[84:87], v6 offset:576
		ds_read_b128 v[88:91], v6 offset:768
		ds_read_b128 v[92:95], v6 offset:832
		ds_read_b64_tr_b16 v[96:97], v41 offset:50656
		ds_read_b64_tr_b16 v[98:99], v41 offset:59104
		ds_read_b64_tr_b16 v[100:101], v41 offset:51168
		ds_read_b64_tr_b16 v[102:103], v41 offset:59616
		ds_read_b64_tr_b16 v[104:105], v41 offset:50784
		ds_read_b64_tr_b16 v[106:107], v41 offset:59232
		ds_read_b64_tr_b16 v[108:109], v41 offset:51296
		ds_read_b64_tr_b16 v[110:111], v41 offset:59744
		s_setprio 0
		s_waitcnt lgkmcnt(0)
		s_barrier
		s_add_i32 s22, s22, 1
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_1:
		...
		buffer_load_ushort v15, v11, s[8:11], 0 offen
		s_waitcnt vmcnt(2)
		s_barrier
		...
		buffer_load_ushort v16, v19, s[8:11], 0 offen
		buffer_load_ushort v17, v20, s[8:11], 0 offen
		buffer_load_ushort v18, v2, s[8:11], 0 offen
		...
		v_mfma_f32_16x16x32_f16 v[120:123], v[40:43], v[44:47], v[120:123]
		s_waitcnt lgkmcnt(2)
		...
		v_mfma_f32_16x16x32_f16 v[136:139], v[40:43], v[60:63], v[136:139]
		...
		v_mfma_f32_16x16x32_f16 v[136:139], v[68:71], v[64:67], v[136:139]
		...
		v_bitop3_b32 v9, 32, v5, v21 bitop3:0x96
		v_bitop3_b32 v9, v9, v8, v10 bitop3:0x96
		v_xad_u32 v9, v9, v12, s16
		s_waitcnt lgkmcnt(1)
		v_pk_add_f32 v[38:39], v[40:41], v[22:23]
		v_cmp_lt_i32_e64 s[6:7], v9, s12
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_write_b128 v2, v[136:139]
		ds_write_b128 v1, v[140:143] offset:8192
		v_pk_add_f32 v[40:41], v[42:43], v[24:25]
		...
		v_bitop3_b32 v1, 64, v5, v21 bitop3:0x96
		v_bitop3_b32 v1, v1, v8, v10 bitop3:0x96
		v_xor_b32_e32 v2, 0x60, v5
		s_waitcnt lgkmcnt(1)
		...
		ds_read_b128 v[8:11], v3 offset:35776
		...
		ds_read_b128 v[48:51], v3 offset:44224
		ds_read_b128 v[52:55], v3 offset:52672
		ds_read_b128 v[56:59], v3 offset:61120
		s_waitcnt lgkmcnt(3)
		v_cvt_f32_f16_e32 v20, v8
		v_cvt_f32_f16_sdwa v21, v8 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[46:47], v[16:17], v[20:21], v[16:17]
		v_cvt_pk_f16_f32 v60, v46, v47
		...
		v_pk_fma_f32 v[10:11], v[28:29], v[8:9], v[28:29]
		s_waitcnt lgkmcnt(2)
		...
		v_pk_fma_f32 v[20:21], v[30:31], v[8:9], v[30:31]
		...
		v_cvt_f32_f16_sdwa v27, v51 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[28:29], v[32:33], v[18:19], v[32:33]
		s_waitcnt lgkmcnt(1)
		...
		v_pk_fma_f32 v[32:33], v[34:35], v[8:9], v[34:35]
		...
		v_pk_fma_f32 v[46:47], v[36:37], v[26:27], v[36:37]
		s_waitcnt lgkmcnt(0)
		...
		v_pk_fma_f32 v[48:49], v[38:39], v[18:19], v[38:39]
		...
		v_pk_fma_f32 v[50:51], v[40:41], v[30:31], v[40:41]
		v_pk_fma_f32 v[30:31], v[42:43], v[8:9], v[42:43]
		v_pk_fma_f32 v[8:9], v[44:45], v[34:35], v[44:45]
		v_pk_fma_f32 v[34:35], v[22:23], v[26:27], v[22:23]
		v_pk_fma_f32 v[22:23], v[24:25], v[36:37], v[24:25]
		v_pk_fma_f32 v[24:25], v[6:7], v[18:19], v[6:7]
		v_pk_fma_f32 v[6:7], v[14:15], v[38:39], v[14:15]
		v_xad_u32 v1, v1, v12, s16
		v_xad_u32 v2, v2, v12, s16
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_else_2:
		s_andn2_b64 exec, s[52:53], s[2:3]
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_else_4:
		s_andn2_b64 exec, s[52:53], s[8:9]
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_else_5:
		s_andn2_b64 exec, s[52:53], s[4:5]
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_5:
	...
	.set .Ltlx_addmm_glu_kernel_optimized_async.numbered_sgpr, 54
