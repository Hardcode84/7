...
.Ltlx_addmm_glu_kernel_optimized_async.if_end_0:
		...
		v_cmp_ge_u32_e64 vcc, v35, v27
		v_add_u32_e32 v41, v35, v29
		v_xor_b32_e32 v43, 0x60, v5
		v_cndmask_b32_e32 v35, v35, v41, vcc
		v_xad_u32 v41, v35, -1, 1
		v_cndmask_b32_e64 v35, v35, v41, s[34:35]
		...
		s_cmp_lt_i32 s13, 0
		s_cselect_b32 s40, s26, s28
		s_cselect_b32 s41, s27, s29
		v_cndmask_b32_e32 v36, v36, v41, vcc
		v_cmp_ge_u32_e64 vcc, v36, v27
		v_add_u32_e32 v41, v36, v29
		v_mov_b32_e32 v44, 16
		v_mul_lo_u32 v44, v44, v15
		v_cndmask_b32_e32 v36, v36, v41, vcc
		v_xad_u32 v41, v36, -1, 1
		v_cndmask_b32_e64 v36, v36, v41, s[34:35]
		v_cmp_lt_i32_e64 vcc, v37, s22
		s_mov_b64 s[26:27], vcc
		v_xad_u32 v41, v37, -1, 1
		v_mov_b32_e32 v45, 8
		v_mul_lo_u32 v45, v45, v15
		v_cndmask_b32_e32 v15, v37, v41, vcc
		v_mul_hi_u32 v37, v15, v28
		v_mul_lo_u32 v37, v37, v27
		v_xor_b32_e32 v37, -1, v37
		v_add3_u32 v15, 1, v37, v15
		v_cmp_ge_u32_e64 vcc, v15, v27
		v_add_u32_e32 v37, v15, v29
		s_add_i32 s28, s36, 1
		...
		v_xad_u32 v37, v8, -1, 1
		v_cndmask_b32_e64 v8, v8, v37, s[26:27]
		...
		v_cndmask_b32_e32 v18, v18, v37, vcc
		v_xad_u32 v37, v18, -1, 1
		v_cndmask_b32_e64 v18, v18, v37, s[26:27]
		...
		v_cndmask_b32_e32 v19, v19, v37, vcc
		v_xad_u32 v37, v19, -1, 1
		v_cndmask_b32_e64 v19, v19, v37, s[26:27]
		...
		v_cndmask_b32_e32 v20, v20, v37, vcc
		v_xad_u32 v37, v20, -1, 1
		v_cndmask_b32_e64 v20, v20, v37, s[26:27]
		...
		v_cndmask_b32_e32 v23, v23, v37, vcc
		v_xad_u32 v37, v23, -1, 1
		v_cndmask_b32_e64 v23, v23, v37, s[26:27]
		v_cmp_lt_i32_e64 vcc, v24, s22
		s_mov_b64 s[2:3], vcc
		v_xad_u32 v37, v24, -1, 1
		v_lshl_add_u32 v53, v53, 1, v54
		v_cndmask_b32_e32 v24, v24, v37, vcc
		v_mul_hi_u32 v37, v24, v28
		v_mul_lo_u32 v37, v37, v27
		v_xor_b32_e32 v37, -1, v37
		v_add3_u32 v24, 1, v37, v24
		v_cmp_ge_u32_e64 vcc, v24, v27
		v_add_u32_e32 v37, v24, v29
		v_lshl_add_u32 v52, v52, 1, v54
		v_cndmask_b32_e32 v24, v24, v37, vcc
		v_cmp_ge_u32_e64 vcc, v24, v27
		v_add_u32_e32 v37, v24, v29
		...
		s_mov_b64 s[2:3], vcc
		v_xad_u32 v37, v25, -1, 1
		v_mov_b32_e32 v56, s13
		v_cndmask_b32_e64 v41, v56, v41, s[40:41]
		...
		s_mov_b64 s[2:3], vcc
		v_xad_u32 v27, v17, -1, 1
		v_mov_b32_e32 v56, 8
		v_mul_lo_u32 v56, v56, v37
		...
		v_and_b32_e32 v27, 1, v55
		v_mov_b32_e32 v28, 32
		v_mul_lo_u32 v28, v28, v27
		v_bitop3_b32 v17, v56, v17, v28 bitop3:0x96
		v_cmp_lt_i32_e64 vcc, v17, s14
		v_and_b32_e32 v27, 1, v55
		v_lshlrev_b32_e32 v27, 6, v27
		v_and_b32_e32 v28, 1, v29
		v_lshlrev_b32_e32 v28, 5, v28
		v_add3_u32 v29, v53, v27, v28
		v_mov_b32_e32 v37, 0x80000000
		v_cndmask_b32_e32 v41, v37, v29, vcc
		buffer_load_dwordx4 v41, s[36:39], 0 offen lds
		v_add3_u32 v41, v52, v27, v28
		v_cndmask_b32_e32 v52, v37, v41, vcc
		s_add_i32 m0, m0, 0x2100
		v_cndmask_b32_e64 v31, v31, v32, s[24:25]
		buffer_load_dwordx4 v52, s[36:39], 0 offen lds
		s_ashr_i32 s2, s28, 6
		v_bitop3_b32 v32, v51, v48, v10 bitop3:0x96
		v_bitop3_b32 v32, v32, v13, v45 bitop3:0x96
		v_bitop3_b32 v48, 4, v51, v48 bitop3:0x96
		v_xor_b32_e32 v10, v48, v10
		v_cmp_lt_i32_e64 vcc, v32, s14
		v_lshlrev_b32_e32 v48, 1, v11
		v_add3_u32 v48, v50, v48, v49
		v_lshl_add_u32 v48, v7, 5, v48
		v_lshl_add_u32 v38, v38, 4, v48
		v_mul_lo_u32 v48, s17, v38
		v_lshl_add_u32 v48, v48, 1, v16
		v_cndmask_b32_e32 v50, v37, v48, vcc
		...
		s_lshl_b32 s3, s17, 8
		v_add_u32_e32 v34, s3, v48
		v_add_u32_e32 v41, s3, v12
		v_cndmask_b32_e32 v34, v37, v34, vcc
		s_add_i32 m0, m0, 0xa4e0
		v_add3_u32 v9, v9, v13, v29
		buffer_load_dwordx4 v34, s[44:47], 0 offen lds
		v_cndmask_b32_e32 v13, v37, v41, vcc
		s_add_i32 m0, m0, 0x2100
		...
		v_add3_u32 v29, v29, v34, v45
		ds_read_b128 v[56:59], v29
		ds_read_b128 v[60:63], v29 offset:64
		ds_read_b128 v[64:67], v29 offset:256
		ds_read_b128 v[68:71], v29 offset:320
		ds_read_b128 v[72:75], v29 offset:512
		ds_read_b128 v[76:79], v29 offset:576
		ds_read_b128 v[80:83], v29 offset:768
		ds_read_b128 v[84:87], v29 offset:832
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_0:
		...
		s_setprio 0
		v_add3_u32 v34, v54, v27, v28
		v_add_u32_e32 v34, 0x180, v34
		v_mul_lo_u32 v26, s23, v26
		v_mul_lo_u32 v6, s23, v6
		v_add_u32_e32 v41, v34, v26
		v_add_u32_e32 v26, v34, v6
...
.Ltlx_addmm_glu_kernel_optimized_async.loop_head_0:
		...
		v_cmp_lt_i32_e64 s[24:25], v32, s23
		s_lshl_b32 s26, s22, 7
		v_cndmask_b32_e32 v6, v37, v41, vcc
		s_mul_i32 s5, 0x4200, s5
		v_cndmask_b32_e32 v34, v37, v26, vcc
		...
		s_add_i32 m0, m0, 0x2100
		s_lshl_b32 s5, s5, 7
		buffer_load_dwordx4 v34, s[36:39], s26 offen lds
		s_add_i32 s5, s4, s5
		v_add_u32_e32 v6, s5, v48
		v_cndmask_b32_e64 v6, v37, v6, s[24:25]
		v_add_u32_e32 v34, s5, v12
		v_cndmask_b32_e32 v34, v37, v34, vcc
		s_add_i32 m0, m0, 0xa4e0
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_1:
		...
		v_xad_u32 v10, v17, v40, s20
		s_mul_i32 s3, 0x108, s29
		v_cmp_lt_i32_e64 s[4:5], v10, s13
		s_add_i32 m0, s3, 0x18bc0
		v_add_lshl_u32 v10, v2, v30, 1
		s_mov_b32 s28, s8
		s_mov_b32 s29, s9
		s_mov_b32 s30, s38
		s_mov_b32 s31, s39
		buffer_load_dword v10, s[28:31], 0 offen lds
		v_mul_lo_u32 v10, s18, v31
		...
		v_mul_lo_u32 v14, s18, v22
		v_add_lshl_u32 v14, v2, v14, 1
		v_mul_lo_u32 v15, s18, v23
		v_add_lshl_u32 v15, v2, v15, 1
		v_mul_lo_u32 v17, s18, v24
		...
		s_mul_hi_u32 s10, s3, 0xaaaaaaab
		...
		s_waitcnt lgkmcnt(6)
		v_mfma_f32_16x16x32_f16 v[104:107], v[68:71], v[16:19], v[104:107]
		v_mfma_f32_16x16x32_f16 v[112:115], v[68:71], v[32:35], v[112:115]
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[108:111], v[76:79], v[16:19], v[108:111]
		s_xor_b32 s3, s10, -1
		s_add_i32 s3, s3, 1
		s_add_i32 s2, s2, s3
		...
		v_mfma_f32_16x16x32_f16 v[120:123], v[68:71], v[48:51], v[120:123]
		s_mul_i32 s2, 0x4200, s2
		v_add_u32_e32 v2, s2, v29
		...
		v_bitop3_b32 v2, v10, v2, v3 bitop3:0x96
		v_bitop3_b32 v2, v6, v9, v2 bitop3:0x96
		v_lshlrev_b32_e32 v2, 4, v2
		v_lshl_add_u32 v2, v6, 13, v2
		ds_read_b128 v[16:19], v2
		ds_read_b128 v[20:23], v2 offset:256
		s_waitcnt vmcnt(0)
		...
		v_pk_add_f32 v[32:33], v[34:35], v[24:25]
		v_pk_add_f32 v[34:35], v[40:41], v[18:19]
		v_pk_add_f32 v[36:37], v[42:43], v[30:31]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[40:43], v2
		ds_read_b128 v[48:51], v2 offset:256
		v_bitop3_b32 v3, v5, v47, v46 bitop3:0x96
		v_xor_b32_e32 v3, v3, v39
		v_xad_u32 v3, v3, v44, s16
		s_waitcnt lgkmcnt(1)
		...
		v_pk_add_f32 v[8:9], v[42:43], v[24:25]
		v_pk_add_f32 v[42:43], v[48:49], v[18:19]
		...
		v_bitop3_b32 v0, 32, v5, v47 bitop3:0x96
		v_bitop3_b32 v2, 64, v5, v47 bitop3:0x96
		v_bitop3_b32 v0, v0, v46, v39 bitop3:0x96
		s_waitcnt lgkmcnt(1)
		...
		v_pk_fma_f32 v[12:13], v[14:15], v[6:7], v[14:15]
		v_cvt_pk_f16_f32 v75, v12, v13
		s_waitcnt lgkmcnt(2)
		v_cvt_f32_f16_e32 v6, v60
		v_cvt_f32_f16_sdwa v7, v60 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[12:13], v[22:23], v[6:7], v[22:23]
		...
		v_cvt_f32_f16_sdwa v15, v62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[16:17], v[32:33], v[6:7], v[32:33]
		...
		v_pk_fma_f32 v[22:23], v[34:35], v[14:15], v[34:35]
		...
		v_cvt_f32_f16_sdwa v33, v66 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[34:35], v[36:37], v[6:7], v[36:37]
		...
		v_cvt_f32_f16_sdwa v37, v68 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[38:39], v[40:41], v[20:21], v[40:41]
		...
		v_pk_fma_f32 v[46:47], v[8:9], v[14:15], v[8:9]
		v_cvt_f32_f16_e32 v8, v71
		v_cvt_f32_f16_sdwa v9, v71 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_pk_fma_f32 v[14:15], v[42:43], v[32:33], v[42:43]
		v_pk_fma_f32 v[32:33], v[48:49], v[6:7], v[48:49]
		v_pk_fma_f32 v[6:7], v[10:11], v[36:37], v[10:11]
		v_pk_fma_f32 v[10:11], v[24:25], v[20:21], v[24:25]
		v_pk_fma_f32 v[20:21], v[18:19], v[40:41], v[18:19]
		v_pk_fma_f32 v[18:19], v[30:31], v[8:9], v[30:31]
		v_xad_u32 v0, v0, v44, s16
		v_xad_u32 v2, v2, v44, s16
		...
		buffer_store_dwordx4 v[72:75], v2, s[24:27], 0 offen sc0 nt
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_2:
		s_mov_b64 exec, s[48:49]
		v_cvt_pk_f16_f32 v40, v12, v13
		v_cvt_pk_f16_f32 v41, v16, v17
		v_cvt_pk_f16_f32 v42, v22, v23
		v_cvt_pk_f16_f32 v43, v34, v35
		s_lshl_b32 s2, s19, 6
		s_add_i32 s2, s0, s2
		s_add_i32 s2, s2, s1
		s_add_i32 s2, s2, s9
...
.Ltlx_addmm_glu_kernel_optimized_async.exec_endif_4:
		...
		buffer_store_dwordx4 v[12:15], v0, s[24:27], 0 offen sc0 nt
