...
.Ltlx_addmm_glu_kernel_persistent.if_end_0:
		...
		s_mov_b64 s[76:77], vcc
		v_cndmask_b32_e64 v72, v72, v74, s[74:75]
		v_mul_lo_u32 v72, s18, v72
		v_cndmask_b32_e32 v73, v68, v73, vcc
		...
		v_add_u32_e32 v74, s71, v25
		v_cndmask_b32_e32 v75, v69, v75, vcc
		v_mul_hi_u32 v79, v75, v30
		v_mul_lo_u32 v79, v79, v16
		v_xor_b32_e32 v79, -1, v79
		v_add3_u32 v75, 1, v79, v75
		v_cmp_ge_u32_e64 vcc, v75, v16
		v_add_u32_e32 v79, v75, v32
		v_add_u32_e32 v80, s71, v28
		...
		v_cndmask_b32_e32 v74, v74, v83, vcc
		v_mul_hi_u32 v79, v74, v34
		v_mul_lo_u32 v79, v79, v33
		v_xor_b32_e32 v79, -1, v79
		v_add3_u32 v74, 1, v79, v74
		v_cmp_ge_u32_e64 vcc, v74, v33
		v_add_u32_e32 v79, v74, v35
		v_xad_u32 v83, v81, -1, 1
		v_cndmask_b32_e32 v74, v74, v79, vcc
		v_cmp_ge_u32_e64 vcc, v74, v33
		v_add_u32_e32 v79, v74, v35
		v_lshl_add_u32 v77, v77, 1, v10
		v_cndmask_b32_e32 v74, v74, v79, vcc
		v_xad_u32 v79, v74, -1, 1
		v_cmp_lt_i32_e64 vcc, v80, s9
		s_mov_b64 s[74:75], vcc
		v_cndmask_b32_e64 v74, v74, v79, s[76:77]
		v_mul_lo_u32 v13, s15, v13
		v_cndmask_b32_e32 v79, v80, v82, vcc
		...
		v_cndmask_b32_e32 v80, v81, v83, vcc
		v_mul_hi_u32 v81, v80, v34
		v_mul_lo_u32 v81, v81, v33
		v_xor_b32_e32 v81, -1, v81
		v_add3_u32 v80, 1, v81, v80
		v_cmp_ge_u32_e64 vcc, v80, v33
		v_add_u32_e32 v81, v80, v35
...
.Ltlx_addmm_glu_kernel_persistent.exec_endif_11:
		...
		v_add3_u32 v77, s76, v36, v39
		v_add3_u32 v77, v77, v42, v44
		ds_read_b128 v[88:91], v77
		ds_read_b128 v[92:95], v77 offset:2112
		ds_read_b128 v[96:99], v77 offset:4224
		ds_read_b128 v[100:103], v77 offset:6336
		s_mul_i32 s75, 0x4200, s75
		v_add_u32_e32 v77, s75, v37
		v_add3_u32 v77, v77, v45, v43
		v_add3_u32 v77, v77, v47, v38
		ds_read_b64_tr_b16 v[104:105], v77 offset:25312
		ds_read_b64_tr_b16 v[106:107], v77 offset:33760
		ds_read_b64_tr_b16 v[108:109], v77 offset:25440
		ds_read_b64_tr_b16 v[110:111], v77 offset:33888
		ds_read_b64_tr_b16 v[112:113], v77 offset:25568
		ds_read_b64_tr_b16 v[114:115], v77 offset:34016
		ds_read_b64_tr_b16 v[116:117], v77 offset:25696
		ds_read_b64_tr_b16 v[118:119], v77 offset:34144
...
.Ltlx_addmm_glu_kernel_persistent.loop_exit_1:
		...
		ds_read_b128 v[92:95], v53 offset:2112
		ds_read_b128 v[96:99], v53 offset:4224
		ds_read_b128 v[100:103], v53 offset:6336
		...
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[128:131], v[112:115], v[88:91], v[128:131]
		buffer_load_dwordx2 v[82:83], v78, s[52:55], 0 offen
		s_waitcnt lgkmcnt(0)
		v_mfma_f32_16x16x32_f16 v[132:135], v[116:119], v[88:91], v[132:135]
		v_mfma_f32_16x16x32_f16 v[148:151], v[116:119], v[92:95], v[148:151]
		...
		v_cvt_f32_f16_sdwa v89, v82 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v90, v83
		v_cvt_f32_f16_sdwa v91, v83 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt vmcnt(2)
		...
		v_lshl_add_u32 v13, v15, 1, v85
		buffer_load_dwordx4 v[104:107], v13, s[4:7], 0 offen sc0 nt
		v_cvt_f32_f16_sdwa v101, v80 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v102, v81
		v_cvt_f32_f16_sdwa v103, v81 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_lshl_add_u32 v13, v60, 1, v85
		buffer_load_dwordx4 v[80:83], v13, s[4:7], 0 offen sc0 nt
		v_lshl_add_u32 v13, v70, 1, v85
		buffer_load_dwordx4 v[108:111], v13, s[4:7], 0 offen sc0 nt
		v_lshl_add_u32 v13, v71, 1, v85
		buffer_load_dwordx4 v[112:115], v13, s[4:7], 0 offen sc0 nt
		v_lshl_add_u32 v13, v65, 1, v85
		buffer_load_dwordx4 v[116:119], v13, s[4:7], 0 offen sc0 nt
		v_lshl_add_u32 v13, v72, 1, v85
		buffer_load_dwordx4 v[184:187], v13, s[4:7], 0 offen sc0 nt
		v_mul_lo_u32 v13, s18, v73
		v_lshl_add_u32 v13, v13, 1, v85
		...
		s_barrier
		s_waitcnt vmcnt(7)
		v_cvt_f32_f16_e32 v70, v104
		v_cvt_f32_f16_sdwa v71, v104 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v78, v105
		v_cvt_f32_f16_sdwa v79, v105 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v84, v106
		v_cvt_f32_f16_sdwa v85, v106 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v86, v107
		v_cvt_f32_f16_sdwa v87, v107 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt vmcnt(6)
		v_cvt_f32_f16_e32 v104, v80
		v_cvt_f32_f16_sdwa v105, v80 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v106, v81
		v_cvt_f32_f16_sdwa v107, v81 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v80, v82
		v_cvt_f32_f16_sdwa v81, v82 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v192, v83
		v_cvt_f32_f16_sdwa v193, v83 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt vmcnt(5)
		v_cvt_f32_f16_e32 v82, v108
		v_cvt_f32_f16_sdwa v83, v108 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_mov_b64_e32 v[100:101], v[132:133]
		v_pk_add_f32 v[120:121], v[100:101], v[98:99]
		v_mov_b64_e32 v[100:101], v[102:103]
		v_mov_b64_e32 v[102:103], v[134:135]
		v_pk_add_f32 v[122:123], v[102:103], v[100:101]
		ds_write_b128 v55, v[120:123] offset:10432
		v_mov_b64_e32 v[102:103], v[136:137]
		v_pk_add_f32 v[120:121], v[102:103], v[74:75]
		v_mov_b64_e32 v[102:103], v[138:139]
		v_pk_add_f32 v[122:123], v[102:103], v[88:89]
		v_mov_b64_e32 v[102:103], v[140:141]
		v_pk_add_f32 v[124:125], v[102:103], v[90:91]
		v_mov_b64_e32 v[102:103], v[142:143]
		v_pk_add_f32 v[126:127], v[102:103], v[92:93]
		s_waitcnt lgkmcnt(0)
		s_barrier
		v_mov_b64_e32 v[102:103], v[144:145]
		v_pk_add_f32 v[128:129], v[102:103], v[94:95]
		v_mov_b64_e32 v[102:103], v[146:147]
		v_pk_add_f32 v[130:131], v[102:103], v[96:97]
		v_mov_b64_e32 v[102:103], v[148:149]
		v_pk_add_f32 v[132:133], v[102:103], v[98:99]
		v_mov_b64_e32 v[102:103], v[150:151]
		v_pk_add_f32 v[134:135], v[102:103], v[100:101]
		v_mov_b64_e32 v[102:103], v[152:153]
		v_pk_add_f32 v[136:137], v[102:103], v[74:75]
		v_mov_b64_e32 v[102:103], v[154:155]
		v_pk_add_f32 v[138:139], v[102:103], v[88:89]
		v_mov_b64_e32 v[102:103], v[156:157]
		v_pk_add_f32 v[140:141], v[102:103], v[90:91]
		v_mov_b64_e32 v[102:103], v[158:159]
		v_pk_add_f32 v[142:143], v[102:103], v[92:93]
		v_mov_b64_e32 v[102:103], v[160:161]
		v_pk_add_f32 v[144:145], v[102:103], v[94:95]
		v_mov_b64_e32 v[102:103], v[162:163]
		v_pk_add_f32 v[146:147], v[102:103], v[96:97]
		v_mov_b64_e32 v[102:103], v[164:165]
		v_pk_add_f32 v[148:149], v[102:103], v[98:99]
		v_mov_b64_e32 v[102:103], v[166:167]
		v_pk_add_f32 v[150:151], v[102:103], v[100:101]
		v_mov_b64_e32 v[102:103], v[168:169]
		v_pk_add_f32 v[152:153], v[102:103], v[74:75]
		...
		v_pk_add_f32 v[94:95], v[74:75], v[100:101]
		ds_read_b128 v[96:99], v48 offset:10432
		ds_read_b128 v[100:103], v62 offset:10432
		...
		v_pk_fma_f32 v[168:169], v[74:75], v[70:71], v[74:75]
		v_mov_b64_e32 v[70:71], v[98:99]
		v_pk_fma_f32 v[170:171], v[70:71], v[78:79], v[70:71]
		s_waitcnt lgkmcnt(2)
		v_mov_b64_e32 v[70:71], v[100:101]
		v_pk_fma_f32 v[172:173], v[70:71], v[84:85], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[174:175], v[70:71], v[86:87], v[70:71]
		v_mov_b64_e32 v[70:71], v[160:161]
		v_pk_fma_f32 v[96:97], v[70:71], v[104:105], v[70:71]
		v_mov_b64_e32 v[70:71], v[162:163]
		v_pk_fma_f32 v[98:99], v[70:71], v[106:107], v[70:71]
		v_mov_b64_e32 v[70:71], v[164:165]
		v_pk_fma_f32 v[100:101], v[70:71], v[80:81], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[84:87], v48 offset:10432
		ds_read_b128 v[104:107], v62 offset:10432
		ds_read_b128 v[120:123], v63 offset:10432
		ds_read_b128 v[124:127], v1 offset:10432
		v_mov_b64_e32 v[70:71], v[166:167]
		v_pk_fma_f32 v[102:103], v[70:71], v[192:193], v[70:71]
		s_waitcnt lgkmcnt(3)
		v_mov_b64_e32 v[70:71], v[84:85]
		v_pk_fma_f32 v[128:129], v[70:71], v[82:83], v[70:71]
		v_mov_b64_e32 v[70:71], v[86:87]
		v_pk_fma_f32 v[130:131], v[70:71], v[194:195], v[70:71]
		s_waitcnt lgkmcnt(2)
		v_mov_b64_e32 v[70:71], v[104:105]
		v_pk_fma_f32 v[132:133], v[70:71], v[108:109], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[134:135], v[70:71], v[196:197], v[70:71]
		v_mov_b64_e32 v[70:71], v[120:121]
		v_pk_fma_f32 v[80:81], v[70:71], v[110:111], v[70:71]
		v_mov_b64_e32 v[70:71], v[122:123]
		v_pk_fma_f32 v[82:83], v[70:71], v[198:199], v[70:71]
		v_mov_b64_e32 v[70:71], v[124:125]
		v_pk_fma_f32 v[84:85], v[70:71], v[112:113], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[104:107], v48 offset:10432
		ds_read_b128 v[108:111], v62 offset:10432
		ds_read_b128 v[120:123], v63 offset:10432
		ds_read_b128 v[136:139], v1 offset:10432
		v_mov_b64_e32 v[70:71], v[126:127]
		v_pk_fma_f32 v[86:87], v[70:71], v[200:201], v[70:71]
		s_waitcnt lgkmcnt(3)
		v_mov_b64_e32 v[70:71], v[104:105]
		v_pk_fma_f32 v[144:145], v[70:71], v[114:115], v[70:71]
		v_mov_b64_e32 v[70:71], v[106:107]
		v_pk_fma_f32 v[146:147], v[70:71], v[202:203], v[70:71]
		s_waitcnt lgkmcnt(2)
		v_mov_b64_e32 v[70:71], v[108:109]
		v_pk_fma_f32 v[148:149], v[70:71], v[116:117], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[150:151], v[70:71], v[204:205], v[70:71]
		v_mov_b64_e32 v[70:71], v[120:121]
		v_pk_fma_f32 v[88:89], v[70:71], v[118:119], v[70:71]
		v_mov_b64_e32 v[70:71], v[122:123]
		v_pk_fma_f32 v[90:91], v[70:71], v[206:207], v[70:71]
		v_mov_b64_e32 v[70:71], v[136:137]
		v_pk_fma_f32 v[92:93], v[70:71], v[184:185], v[70:71]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[104:107], v48 offset:10432
		ds_read_b128 v[108:111], v62 offset:10432
		ds_read_b128 v[112:115], v63 offset:10432
		ds_read_b128 v[116:119], v1 offset:10432
		v_mov_b64_e32 v[70:71], v[138:139]
		v_pk_fma_f32 v[94:95], v[70:71], v[208:209], v[70:71]
		s_waitcnt lgkmcnt(3)
		v_mov_b64_e32 v[70:71], v[104:105]
		v_pk_fma_f32 v[120:121], v[70:71], v[186:187], v[70:71]
		v_mov_b64_e32 v[70:71], v[106:107]
		v_pk_fma_f32 v[122:123], v[70:71], v[210:211], v[70:71]
		s_waitcnt lgkmcnt(2)
		v_mov_b64_e32 v[70:71], v[108:109]
		v_pk_fma_f32 v[124:125], v[70:71], v[188:189], v[70:71]
		v_mov_b64_e32 v[70:71], v[110:111]
		v_pk_fma_f32 v[126:127], v[70:71], v[212:213], v[70:71]
		s_waitcnt lgkmcnt(1)
		v_mov_b64_e32 v[70:71], v[112:113]
		v_pk_fma_f32 v[104:105], v[70:71], v[190:191], v[70:71]
		v_mov_b64_e32 v[70:71], v[114:115]
		v_pk_fma_f32 v[106:107], v[70:71], v[214:215], v[70:71]
		s_waitcnt lgkmcnt(0)
		v_mov_b64_e32 v[70:71], v[116:117]
		v_pk_fma_f32 v[108:109], v[70:71], v[72:73], v[70:71]
		v_mov_b64_e32 v[70:71], v[118:119]
		v_pk_fma_f32 v[110:111], v[70:71], v[216:217], v[70:71]
		v_cmp_lt_i32_e64 vcc, v76, s13
		s_mov_b64 s[76:77], vcc
		s_and_b32 s78, s74, s76
		s_and_b32 s79, s75, s77
		v_cvt_pk_f16_f32 v72, v168, v169
		v_cvt_pk_f16_f32 v73, v170, v171
		v_cvt_pk_f16_f32 v74, v172, v173
		v_cvt_pk_f16_f32 v75, v174, v175
		...
		v_cvt_pk_f16_f32 v74, v100, v101
		v_cvt_pk_f16_f32 v75, v102, v103
