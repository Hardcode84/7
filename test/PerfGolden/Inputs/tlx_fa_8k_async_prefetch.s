...
.L_attn_fwd_async_prefetch.loop_head_0:
		...
		v_pk_add_f32 v[236:237], v[38:39], v[40:41]
		...
		ds_bpermute_b32 v194, v4, v37
		ds_bpermute_b32 v196, v2, v37
		...
		v_add_f32_e32 v6, v243, v240
		v_add_f32_e32 v6, v241, v6
		v_mov_b32_e32 v228, v6
		v_mov_b32_e32 v229, v6
		s_nop 1
		...
		v_pk_fma_f32 v[32:33], v[32:33], v[228:229], v[240:241]
		v_cvt_pk_bf16_f32 v236, v230, v232
		v_cvt_pk_bf16_f32 v237, v231, v233
		v_cvt_pk_bf16_f32 v238, v38, v40
		v_cvt_pk_bf16_f32 v239, v39, v41
...
.L_attn_fwd_async_prefetch.loop_exit_0:
		...
		v_exp_f32_e32 v204, v208
		v_exp_f32_e32 v206, v209
		v_pk_add_f32 v[208:209], v[22:23], v[210:211]
		v_pk_add_f32 v[216:217], v[10:11], v[212:213]
		v_pk_add_f32 v[218:219], v[16:17], v[18:19]
		v_pk_add_f32 v[220:221], v[24:25], v[26:27]
		v_pk_add_f32 v[222:223], v[28:29], v[30:31]
		v_pk_add_f32 v[224:225], v[34:35], v[36:37]
		...
		v_add_f32_e32 v7, v208, v209
		ds_bpermute_b32 v46, v4, v7
		ds_bpermute_b32 v176, v2, v7
		v_pk_add_f32 v[208:209], v[178:179], v[214:215]
		...
		s_waitcnt lgkmcnt(0)
		v_pk_add_f32 v[222:223], v[46:47], v[176:177]
		...
		v_pk_add_f32 v[208:209], v[232:233], v[216:217]
		v_mov_b32_e32 v216, v219
		...
		v_mov_b32_e32 v224, v209
		v_mov_b32_e32 v225, v220
		v_pk_add_f32 v[208:209], v[224:225], v[216:217]
		v_mov_b32_e32 v216, v221
		v_mov_b32_e32 v217, v208
		v_pk_add_f32 v[220:221], v[216:217], v[218:219]
		v_add_f32_e32 v2, v209, v220
		v_add_f32_e32 v2, v221, v2
		v_mov_b32_e32 v208, v2
		v_mov_b32_e32 v209, v2
		s_nop 1
		v_permlane32_swap_b32_e32 v208, v209
		v_add_f32_e32 v217, v208, v209
		v_sub_f32_e32 v0, v6, v0
		v_sub_f32_e32 v1, v21, v1
		v_exp_f32_e32 v6, v0
		v_exp_f32_e32 v208, v1
		v_mov_b32_e32 v7, v6
		v_pk_mul_f32 v[224:225], v[48:49], v[6:7]
		v_pk_mul_f32 v[226:227], v[50:51], v[6:7]
		v_pk_mul_f32 v[228:229], v[52:53], v[6:7]
		v_pk_mul_f32 v[230:231], v[54:55], v[6:7]
		v_pk_mul_f32 v[232:233], v[56:57], v[6:7]
		v_pk_mul_f32 v[234:235], v[58:59], v[6:7]
		v_pk_mul_f32 v[236:237], v[60:61], v[6:7]
		v_pk_mul_f32 v[238:239], v[62:63], v[6:7]
		...
		v_pk_fma_f32 v[6:7], v[32:33], v[0:1], v[216:217]
		v_cvt_pk_bf16_f32 v160, v22, v210
		v_cvt_pk_bf16_f32 v161, v23, v211
		v_cvt_pk_bf16_f32 v162, v10, v212
		v_cvt_pk_bf16_f32 v163, v11, v213
		v_cvt_pk_bf16_f32 v164, v16, v18
		v_cvt_pk_bf16_f32 v165, v17, v19
		v_cvt_pk_bf16_f32 v166, v24, v26
		v_cvt_pk_bf16_f32 v167, v25, v27
		v_cvt_pk_bf16_f32 v16, v28, v30
		v_cvt_pk_bf16_f32 v17, v29, v31
		v_cvt_pk_bf16_f32 v18, v34, v36
		v_cvt_pk_bf16_f32 v19, v35, v37
		...
		s_nop 0
		v_mfma_f32_32x32x16_bf16 v[224:239], a[92:95], v[160:163], v[224:239]
		...
		v_mul_lo_u32 v2, s23, v13
		v_lshl_add_u32 v1, v2, 6, s3
		v_mul_lo_u32 v4, s23, v15
		v_lshl_add_u32 v1, v4, 1, v1
		v_mul_lo_u32 v6, s23, v9
		v_lshl_add_u32 v1, v6, 5, v1
		v_mul_lo_u32 v7, s23, v8
		v_mfma_f32_32x32x16_bf16 v[144:159], a[140:143], v[28:31], v[144:159]
		v_lshl_add_u32 v1, v7, 4, v1
		v_mul_lo_u32 v8, s23, v20
		v_lshl_add_u32 v1, v8, 3, v1
		v_mul_lo_u32 v3, s23, v3
		v_lshl_add_u32 v1, v3, 2, v1
		v_lshl_add_u32 v9, v5, 4, v1
		v_mfma_f32_32x32x16_bf16 v[96:111], a[92:95], v[28:31], v[96:111]
		v_mfma_f32_32x32x16_bf16 v[112:127], a[108:111], v[28:31], v[112:127]
		v_mfma_f32_32x32x16_bf16 v[128:143], a[124:127], v[28:31], v[128:143]
		v_mfma_f32_32x32x16_bf16 v[224:239], a[96:99], v[164:167], v[224:239]
		...
		v_mfma_f32_32x32x16_bf16 v[144:159], a[144:147], v[32:35], v[144:159]
		v_mfma_f32_32x32x16_bf16 v[96:111], a[96:99], v[32:35], v[96:111]
		v_mfma_f32_32x32x16_bf16 v[112:127], a[112:115], v[32:35], v[112:127]
		v_mfma_f32_32x32x16_bf16 v[128:143], a[128:131], v[32:35], v[128:143]
		v_mfma_f32_32x32x16_bf16 v[224:239], a[100:103], v[16:19], v[224:239]
		v_mfma_f32_32x32x16_bf16 v[48:63], a[116:119], v[16:19], v[48:63]
		v_mfma_f32_32x32x16_bf16 v[64:79], a[132:135], v[16:19], v[64:79]
		v_mfma_f32_32x32x16_bf16 v[80:95], a[148:151], v[16:19], v[80:95]
		v_mfma_f32_32x32x16_bf16 v[144:159], a[148:151], v[36:39], v[144:159]
		v_mfma_f32_32x32x16_bf16 v[96:111], a[100:103], v[36:39], v[96:111]
		v_mfma_f32_32x32x16_bf16 v[112:127], a[116:119], v[36:39], v[112:127]
		v_mfma_f32_32x32x16_bf16 v[128:143], a[132:135], v[36:39], v[128:143]
		v_mfma_f32_32x32x16_bf16 v[224:239], a[104:107], v[24:27], v[224:239]
		v_mfma_f32_32x32x16_bf16 v[48:63], a[120:123], v[24:27], v[48:63]
		v_mfma_f32_32x32x16_bf16 v[64:79], a[136:139], v[24:27], v[64:79]
		v_mfma_f32_32x32x16_bf16 v[80:95], a[152:155], v[24:27], v[80:95]
		v_mfma_f32_32x32x16_bf16 v[144:159], a[152:155], v[40:43], v[144:159]
		v_mfma_f32_32x32x16_bf16 v[96:111], a[104:107], v[40:43], v[96:111]
		...
		v_mov_b32_e32 v1, v0
		s_nop 3
		v_pk_mul_f32 v[12:13], v[224:225], v[0:1]
		v_pk_mul_f32 v[14:15], v[226:227], v[0:1]
		v_pk_mul_f32 v[16:17], v[228:229], v[0:1]
		v_pk_mul_f32 v[18:19], v[230:231], v[0:1]
		v_pk_mul_f32 v[20:21], v[232:233], v[0:1]
		v_pk_mul_f32 v[22:23], v[234:235], v[0:1]
		...
		v_pk_mul_f32 v[0:1], v[96:97], v[10:11]
