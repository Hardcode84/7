...
.Lgfx950_persistent_f16_gemm.if_end_8:
		...
		ds_read_b128 v[124:127], v9 offset:60416
		s_cmp_lg_u32 s0, 0
...
.Lgfx950_persistent_f16_gemm.if_end_9:
		...
		ds_read_b128 v[124:127], v9 offset:62464
		s_waitcnt lgkmcnt(1)
		...
		ds_read_b128 v[124:127], v9 offset:64512
		s_waitcnt lgkmcnt(1)
...
.Lgfx950_persistent_f16_gemm.exec_endif_2:
		s_mov_b64 exec, s[24:25]
		s_waitcnt lgkmcnt(0)
		v_mfma_f32_16x16x32_f16 v[28:31], v[104:107], v[124:127], v[28:31]
...
.Lgfx950_persistent_f16_gemm.if_end_13:
		...
		s_waitcnt lgkmcnt(0)
		ds_add_rtn_u32 v9, v3, v10 offset:32780
