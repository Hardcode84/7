...
.Lwmma_f16_matmul_tiled.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		s_lshl_b32 s9, s8, 17
		s_lshr_b32 s1, s1, 1
		s_lshl_b32 s10, s1, 23
		s_add_i32 s9, s9, s10
		s_and_b32 s0, s0, 3
		s_lshl_b32 s10, s0, 21
		s_add_i32 s9, s9, s10
		s_add_u32 s16, s6, s9
		s_addc_u32 s17, s7, 0
		...
		s_lshl_b32 s0, s0, 22
		s_add_i32 s9, s1, s0
		buffer_load_dwordx4 v3, s[20:23], s9 offen lds
		...
		s_add_i32 m0, m0, 0x4000
		s_add_i32 s0, s8, 64
		buffer_load_dwordx4 v3, s[24:27], s0 offen lds
...
.Lwmma_f16_matmul_tiled.if_end_0:
		...
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[48:51], v[16:19], v[12:15], v[48:51]
		s_waitcnt lgkmcnt(1)
		...
		v_mfma_f32_16x16x32_f16 v[60:63], v[20:23], v[8:11], v[60:63]
		v_mfma_f32_16x16x32_f16 v[64:67], v[20:23], v[12:15], v[64:67]
		...
		v_cvt_pk_f16_f32 v16, v56, v57
		v_cvt_pk_f16_f32 v17, v58, v59
		...
		v_mfma_f32_16x16x32_f16 v[76:79], v[24:27], v[8:11], v[76:79]
		v_mfma_f32_16x16x32_f16 v[92:95], v[28:31], v[8:11], v[92:95]
		v_mfma_f32_16x16x32_f16 v[80:83], v[24:27], v[12:15], v[80:83]
		v_mfma_f32_16x16x32_f16 v[88:91], v[24:27], v[36:39], v[88:91]
		v_mfma_f32_16x16x32_f16 v[104:107], v[28:31], v[36:39], v[104:107]
		v_mfma_f32_16x16x32_f16 v[96:99], v[28:31], v[12:15], v[96:99]
		buffer_store_dwordx2 v[2:3], v0, s[16:19], 0 offen
		buffer_store_dwordx2 v[4:5], v0, s[16:19], 0 offen offset:512
		buffer_store_dwordx2 v[6:7], v0, s[16:19], 0 offen offset:1024
		buffer_store_dwordx2 v[16:17], v0, s[16:19], 0 offen offset:1536
		buffer_store_dwordx2 v[18:19], v0, s[16:19], 0 offen offset:2048
		buffer_store_dwordx2 v[20:21], v0, s[16:19], 0 offen offset:2560
		buffer_store_dwordx2 v[22:23], v0, s[16:19], 0 offen offset:3072
		buffer_store_dwordx2 v[40:41], v0, s[16:19], 0 offen offset:3584
		...
		buffer_store_dwordx2 v[6:7], v0, s[16:19], s0 offen offset:1024
		buffer_store_dwordx2 v[8:9], v0, s[16:19], s0 offen offset:1536
		buffer_store_dwordx2 v[10:11], v0, s[16:19], s0 offen offset:2048
		buffer_store_dwordx2 v[12:13], v0, s[16:19], s0 offen offset:2560
		buffer_store_dwordx2 v[14:15], v0, s[16:19], s0 offen offset:3072
		buffer_store_dwordx2 v[16:17], v0, s[16:19], s0 offen offset:3584
		s_endpgm
