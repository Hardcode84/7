...
.Ltlx_addmm_glu_kernel_optimized.if_end_0:
		...
		v_add3_u32 v7, v38, v7, v12
		v_mad_u32_u24 v12, v13, 8, v7
		...
		v_mul_lo_u32 v26, s17, v26
		v_lshl_add_u32 v10, v26, 5, v10
		s_add_i32 m0, s2, 0xc5e0
		v_cmp_lt_i32_e64 vcc, v12, s14
		s_mov_b64 s[4:5], vcc
		v_cndmask_b32_e64 v26, v39, v10, s[4:5]
		...
		v_add_u32_e32 v26, 0x80, v5
		s_add_i32 m0, s2, 0x6300
		v_cndmask_b32_e32 v26, v39, v26, vcc
		buffer_load_dwordx4 v26, s[20:23], 0 offen lds
		s_lshl_b32 s4, s17, 7
		v_add_u32_e32 v26, s4, v10
		...
		s_mov_b64 s[4:5], vcc
		v_cndmask_b32_e64 v26, v39, v26, s[4:5]
		v_add_u32_e32 v28, s3, v10
		v_cmp_lt_i32_e64 vcc, v33, s1
		s_mov_b64 s[4:5], vcc
		v_cndmask_b32_e64 v28, v39, v28, s[4:5]
		s_mul_i32 s3, 0xc8, s17
		buffer_load_dwordx4 v26, s[24:27], 0 offen lds
		s_add_i32 m0, s2, 0x18be0
		v_add_u32_e32 v26, s3, v10
		v_cmp_lt_i32_e64 vcc, v34, s1
		s_nop 1
		v_cndmask_b32_e32 v26, v39, v26, vcc
		...
		v_add_u32_e32 v5, s3, v10
		s_add_i32 m0, s2, 0x1cde0
		v_cmp_lt_i32_e64 vcc, v12, s1
		s_mov_b64 s[4:5], vcc
		v_cndmask_b32_e64 v5, v39, v5, s[4:5]
...
.Ltlx_addmm_glu_kernel_optimized.loop_exit_0:
		...
		s_mov_b32 s2, s22
		s_mov_b32 s3, s23
		buffer_load_dwordx4 v[52:55], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v22
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[56:59], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v24
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[60:63], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v25
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[64:67], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v14
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[68:71], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v15
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[72:75], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v16
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[76:79], v2, s[0:3], 0 offen
		v_mul_lo_u32 v2, s18, v17
		v_lshl_add_u32 v2, v2, 1, v19
		buffer_load_dwordx4 v[80:83], v2, s[0:3], 0 offen
		s_barrier
		s_waitcnt vmcnt(7)
		...
		v_lshlrev_b32_e32 v4, 9, v32
		v_lshl_add_u32 v4, v9, 4, v4
		v_and_b32_e32 v5, 1, v8
		v_lshl_add_u32 v4, v5, 14, v4
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[112:113], v[8:9], v[2:3], v[8:9]
		v_mov_b64_e32 v[2:3], v[6:7]
		v_pk_fma_f32 v[114:115], v[2:3], v[10:11], v[2:3]
		v_mov_b64_e32 v[2:3], v[40:41]
		v_pk_fma_f32 v[116:117], v[2:3], v[12:13], v[2:3]
		v_mov_b64_e32 v[2:3], v[42:43]
		v_pk_fma_f32 v[118:119], v[2:3], v[20:21], v[2:3]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[4:7], v1
		...
		v_pk_fma_f32 v[120:121], v[2:3], v[26:27], v[2:3]
		v_mov_b64_e32 v[2:3], v[46:47]
		v_pk_fma_f32 v[122:123], v[2:3], v[28:29], v[2:3]
		v_mov_b64_e32 v[2:3], v[104:105]
		v_pk_fma_f32 v[124:125], v[2:3], v[34:35], v[2:3]
		v_mov_b64_e32 v[2:3], v[106:107]
		v_pk_fma_f32 v[126:127], v[2:3], v[52:53], v[2:3]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[128:129], v[2:3], v[54:55], v[2:3]
		v_mov_b64_e32 v[2:3], v[6:7]
		v_pk_fma_f32 v[130:131], v[2:3], v[56:57], v[2:3]
		v_mov_b64_e32 v[2:3], v[8:9]
		v_pk_fma_f32 v[132:133], v[2:3], v[58:59], v[2:3]
		v_mov_b64_e32 v[2:3], v[10:11]
		v_pk_fma_f32 v[134:135], v[2:3], v[60:61], v[2:3]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[4:7], v1
		ds_read_b128 v[8:11], v1 offset:256
