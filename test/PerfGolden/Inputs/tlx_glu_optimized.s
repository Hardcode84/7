...
.Ltlx_addmm_glu_kernel_optimized.if_end_0:
		...
		v_cndmask_b32_e32 v18, v28, v21, vcc
		s_add_i32 m0, m0, 0x2100
		s_lshl_b32 s5, s17, 8
		v_cmp_lt_i32_e64 vcc, v30, s4
		s_mov_b64 s[12:13], vcc
		...
		ds_read_b128 v[52:55], v21 offset:512
		ds_read_b128 v[56:59], v21 offset:576
		ds_read_b128 v[60:63], v21 offset:768
		ds_read_b128 v[64:67], v21 offset:832
		v_lshlrev_b32_e32 v22, 3, v22
		v_lshl_add_u32 v23, v5, 5, v22
		v_lshlrev_b32_e32 v27, 9, v3
		v_mov_b32_e32 v34, 0x420
		v_mul_lo_u32 v34, v34, v26
		v_add3_u32 v23, v23, v27, v34
		ds_read_b64_tr_b16 v[68:69], v23 offset:50656
		ds_read_b64_tr_b16 v[70:71], v23 offset:59104
		v_add_u32_e32 v22, 0x10000, v22
		v_lshl_add_u32 v5, v5, 5, v22
...
.Ltlx_addmm_glu_kernel_optimized.loop_head_0:
		...
		v_cmp_lt_i32_e64 vcc, v16, s32
		s_lshl_b32 s33, s16, 7
		s_mul_i32 s34, 0x4200, s15
		v_cndmask_b32_e32 v1, v28, v15, vcc
		v_cndmask_b32_e32 v5, v28, v8, vcc
		s_add_i32 s34, s2, s34
		v_cmp_lt_i32_e64 vcc, v30, s32
		s_mov_b64 s[36:37], vcc
		s_mov_b32 m0, s34
		s_mul_i32 s15, 0x8400, s15
		buffer_load_dwordx4 v1, s[28:31], s33 offen lds
		v_cmp_lt_i32_e64 vcc, v31, s32
		s_mov_b64 s[34:35], vcc
		v_cmp_lt_i32_e64 vcc, v32, s32
		s_mov_b64 s[38:39], vcc
		s_add_i32 m0, m0, 0x2100
		s_mul_i32 s40, s17, s16
		buffer_load_dwordx4 v5, s[28:31], s33 offen lds
		v_cmp_lt_i32_e64 vcc, v6, s32
		s_lshl_b32 s32, s40, 7
		s_add_i32 s33, s3, s32
		v_add_u32_e32 v1, s33, v33
		v_cndmask_b32_e64 v1, v28, v1, s[36:37]
		s_add_i32 s15, s2, s15
		v_add_u32_e32 v5, s33, v9
		s_add_i32 m0, s15, 0xc5e0
		v_cndmask_b32_e64 v5, v28, v5, s[34:35]
		buffer_load_dwordx4 v1, s[24:27], 0 offen lds
		s_add_i32 s15, s5, s32
		s_add_i32 m0, m0, 0x2100
		...
		s_mul_i32 s15, 0x8400, s20
		s_add_i32 m0, m0, 0x2100
		v_add_u32_e32 v5, s15, v23
		buffer_load_dwordx4 v1, s[24:27], 0 offen lds
		s_barrier
		s_mul_i32 s20, 0x4200, s20
		v_add_u32_e32 v1, s20, v21
		s_waitcnt vmcnt(6)
		...
		ds_read_b64_tr_b16 v[68:69], v5 offset:50656
		ds_read_b64_tr_b16 v[70:71], v5 offset:59104
		s_add_i32 s15, s15, 0x10000
		v_add_u32_e32 v1, s15, v23
		ds_read_b64_tr_b16 v[72:73], v1 offset:2016
		ds_read_b64_tr_b16 v[74:75], v1 offset:10464
...
.Ltlx_addmm_glu_kernel_optimized.exec_endif_1:
		...
		s_mov_b32 s14, s30
		s_mov_b32 s15, s31
		buffer_load_dwordx4 v[32:35], v2, s[12:15], 0 offen
		...
		v_bitop3_b32 v8, v6, 1, v7 bitop3:0x6a
		v_lshlrev_b32_e32 v8, 4, v8
		v_lshl_add_u32 v6, v6, 13, v8
		...
		v_add_u32_e32 v9, 0xffff0100, v6
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[60:63], v8
		ds_read_b128 v[64:67], v9
		...
		v_bitop3_b32 v5, v3, 1, v7 bitop3:0x6a
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_add_u32_e32 v3, 0xfffe8100, v0
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_cvt_f32_f16_sdwa v1, v32 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_e32 v32, v165
		v_cvt_f32_f16_sdwa v33, v165 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v34, v166
		v_cvt_f32_f16_sdwa v35, v166 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_pk_fma_f32 v[22:23], v[26:27], v[32:33], v[26:27]
		v_pk_fma_f32 v[24:25], v[28:29], v[34:35], v[28:29]
		v_pk_fma_f32 v[26:27], v[30:31], v[92:93], v[30:31]
