...
.Ltlx_addmm_glu_kernel_optimized.exec_endif_14:
		...
		v_add3_u32 v35, v5, v35, v38
		ds_read_b128 v[44:47], v35
		ds_read_b128 v[48:51], v35 offset:64
		ds_read_b128 v[52:55], v35 offset:256
		ds_read_b128 v[56:59], v35 offset:320
		ds_read_b128 v[60:63], v35 offset:512
		ds_read_b128 v[64:67], v35 offset:576
		ds_read_b128 v[68:71], v35 offset:768
		ds_read_b128 v[72:75], v35 offset:832
		...
		v_add3_u32 v7, v0, v38, v5
		v_and_b32_e32 v6, 1, v6
		v_mov_b32_e32 v39, 0x1080
		v_mul_lo_u32 v39, v39, v6
		v_and_b32_e32 v6, 3, v37
		v_lshlrev_b32_e32 v6, 3, v6
		v_add3_u32 v37, v7, v39, v6
		ds_read_b64_tr_b16 v[76:77], v37 offset:50656
		ds_read_b64_tr_b16 v[78:79], v37 offset:59104
		v_add_u32_e32 v0, 0x10000, v0
		v_add3_u32 v0, v0, v38, v5
		v_add3_u32 v0, v0, v39, v6
		ds_read_b64_tr_b16 v[80:81], v0 offset:2016
		ds_read_b64_tr_b16 v[82:83], v0 offset:10464
		ds_read_b64_tr_b16 v[84:85], v37 offset:50784
		ds_read_b64_tr_b16 v[86:87], v37 offset:59232
		ds_read_b64_tr_b16 v[88:89], v0 offset:2144
		ds_read_b64_tr_b16 v[90:91], v0 offset:10592
		ds_read_b64_tr_b16 v[92:93], v37 offset:50912
		ds_read_b64_tr_b16 v[94:95], v37 offset:59360
		ds_read_b64_tr_b16 v[96:97], v0 offset:2272
		ds_read_b64_tr_b16 v[98:99], v0 offset:10720
		ds_read_b64_tr_b16 v[100:101], v37 offset:51040
		ds_read_b64_tr_b16 v[102:103], v37 offset:59488
		ds_read_b64_tr_b16 v[104:105], v0 offset:2400
		ds_read_b64_tr_b16 v[106:107], v0 offset:10848
		s_add_i32 s1, s0, -3
		v_lshl_add_u32 v0, v36, 4, v33
		v_lshl_add_u32 v0, v30, 5, v0
		v_add_u32_e32 v0, 0x180, v0
		s_lshl_b32 s3, s15, 1
		v_mul_lo_u32 v5, s3, v18
		v_add_u32_e32 v18, v0, v5
		v_mul_lo_u32 v3, s3, v3
		v_add_u32_e32 v33, v0, v3
...
.Ltlx_addmm_glu_kernel_optimized.loop_head_0:
		...
		v_mfma_f32_16x16x32_f16 v[4:7], v[80:83], v[48:51], v[4:7]
		...
		s_xor_b32 s24, s24, -1
		s_add_i32 s24, s24, 1
		s_add_i32 s24, s14, s24
		s_barrier
		s_mul_i32 s25, 0x4200, s13
		s_add_i32 s25, s2, s25
		v_cmp_lt_i32_e64 vcc, v20, s24
		s_mov_b32 m0, s25
		s_and_saveexec_b64 s[36:37], vcc
		s_cbranch_execz .Ltlx_addmm_glu_kernel_optimized.exec_endif_15
		buffer_load_dwordx4 v18, s[28:31], s15 offen lds
		s_add_i32 m0, s25, 0x2100
		s_nop 0
		buffer_load_dwordx4 v33, s[28:31], s15 offen lds
.Ltlx_addmm_glu_kernel_optimized.exec_endif_15:
		...
		s_add_i32 s25, s3, s15
		v_add3_u32 v0, v28, v29, s25
		v_cmp_lt_i32_e64 vcc, v9, s24
...
.Ltlx_addmm_glu_kernel_optimized.exec_endif_17:
		s_mov_b64 exec, s[36:37]
		s_add_i32 s25, s5, s15
		v_add3_u32 v0, v28, v29, s25
		v_cmp_lt_i32_e64 vcc, v13, s24
...
.Ltlx_addmm_glu_kernel_optimized.loop_exit_0:
		...
		v_pk_add_f32 v[168:169], v[4:5], v[40:41]
		v_pk_add_f32 v[170:171], v[6:7], v[42:43]
		v_pk_add_f32 v[4:5], v[108:109], v[44:45]
		v_pk_add_f32 v[6:7], v[110:111], v[46:47]
		...
		v_mov_b32_e32 v33, 0x408
		v_mul_lo_u32 v33, v33, v26
		v_lshlrev_b32_e32 v37, 2, v36
		v_and_b32_e32 v8, 1, v8
		v_lshlrev_b32_e32 v52, 6, v8
		v_and_b32_e32 v1, 1, v1
		v_lshlrev_b32_e32 v53, 5, v1
		v_add3_u32 v54, v37, v52, v53
		v_lshlrev_b32_e32 v55, 4, v32
		v_lshlrev_b32_e32 v86, 3, v30
		v_add3_u32 v54, v54, v55, v86
		v_mov_b32_e32 v87, 0x204
		v_mul_lo_u32 v87, v87, v27
		v_bitop3_b32 v54, v33, v54, v87 bitop3:0x96
		v_bitop3_b32 v54, v9, v31, v54 bitop3:0x96
		v_lshlrev_b32_e32 v54, 2, v54
		ds_write_b128 v54, v[168:171]
		v_add_u32_e32 v152, 0x810, v37
		v_bitop3_b32 v152, v55, v152, v86 bitop3:0x96
		v_bitop3_b32 v152, v52, v53, v152 bitop3:0x96
		v_bitop3_b32 v152, v33, v87, v152 bitop3:0x96
		v_bitop3_b32 v152, v9, v31, v152 bitop3:0x96
		v_lshlrev_b32_e32 v152, 2, v152
		ds_write_b128 v152, v[4:7]
		v_add_u32_e32 v4, 0x1020, v37
		v_bitop3_b32 v4, v55, v4, v86 bitop3:0x96
		v_bitop3_b32 v4, v52, v53, v4 bitop3:0x96
		v_bitop3_b32 v4, v33, v87, v4 bitop3:0x96
		v_bitop3_b32 v4, v9, v31, v4 bitop3:0x96
		v_lshlrev_b32_e32 v4, 2, v4
		ds_write_b128 v4, v[108:111]
		v_add_u32_e32 v5, 0x1830, v37
		v_bitop3_b32 v5, v55, v5, v86 bitop3:0x96
		v_bitop3_b32 v5, v52, v53, v5 bitop3:0x96
		v_bitop3_b32 v5, v33, v87, v5 bitop3:0x96
		v_bitop3_b32 v5, v9, v31, v5 bitop3:0x96
		...
		s_waitcnt lgkmcnt(0)
		s_barrier
		v_mov_b32_e32 v11, 0x1020
		v_mul_lo_u32 v11, v11, v8
		v_mov_b32_e32 v8, 0x810
		v_mul_lo_u32 v8, v8, v1
		v_lshlrev_b32_e32 v1, 7, v32
		v_mov_b32_e32 v26, 0x204
		v_mul_lo_u32 v26, v26, v36
		v_mov_b32_e32 v27, 0x408
		v_mul_lo_u32 v27, v27, v30
		v_bitop3_b32 v30, v1, v26, v27 bitop3:0x96
		v_bitop3_b32 v30, v11, v8, v30 bitop3:0x96
		v_bitop3_b32 v30, v9, v10, v30 bitop3:0x96
		v_bitop3_b32 v30, v6, v7, v30 bitop3:0x96
		v_lshlrev_b32_e32 v30, 2, v30
		ds_read_b128 v[108:111], v30
		v_xor_b32_e32 v31, 64, v26
		v_bitop3_b32 v31, v1, v27, v31 bitop3:0x96
		v_bitop3_b32 v31, v11, v8, v31 bitop3:0x96
		v_bitop3_b32 v31, v9, v10, v31 bitop3:0x96
		v_bitop3_b32 v31, v6, v7, v31 bitop3:0x96
		v_lshlrev_b32_e32 v31, 2, v31
		ds_read_b128 v[112:115], v31
		v_xor_b32_e32 v32, 0x100, v26
		v_bitop3_b32 v32, v1, v27, v32 bitop3:0x96
		v_bitop3_b32 v32, v11, v8, v32 bitop3:0x96
		v_bitop3_b32 v32, v9, v10, v32 bitop3:0x96
		v_bitop3_b32 v32, v6, v7, v32 bitop3:0x96
		v_lshlrev_b32_e32 v32, 2, v32
		ds_read_b128 v[156:159], v32
		v_xor_b32_e32 v26, 0x140, v26
		v_bitop3_b32 v1, v1, v27, v26 bitop3:0x96
		v_bitop3_b32 v1, v11, v8, v1 bitop3:0x96
		v_bitop3_b32 v1, v9, v10, v1 bitop3:0x96
		v_bitop3_b32 v1, v6, v7, v1 bitop3:0x96
		v_lshlrev_b32_e32 v1, 2, v1
		ds_read_b128 v[8:11], v1
		s_waitcnt lgkmcnt(3)
		v_pk_fma_f32 v[160:161], v[108:109], v[2:3], v[108:109]
		v_pk_fma_f32 v[162:163], v[110:111], v[12:13], v[110:111]
		s_waitcnt lgkmcnt(2)
		v_pk_fma_f32 v[164:165], v[112:113], v[18:19], v[112:113]
		v_pk_fma_f32 v[166:167], v[114:115], v[20:21], v[114:115]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_write_b128 v54, v[116:119]
		ds_write_b128 v152, v[120:123]
		ds_write_b128 v4, v[124:127]
		ds_write_b128 v5, v[128:131]
		v_pk_fma_f32 v[112:113], v[156:157], v[28:29], v[156:157]
		v_pk_fma_f32 v[114:115], v[158:159], v[34:35], v[158:159]
		v_pk_fma_f32 v[116:117], v[8:9], v[38:39], v[8:9]
		v_pk_fma_f32 v[118:119], v[10:11], v[56:57], v[10:11]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[8:11], v30
		ds_read_b128 v[36:39], v31
		ds_read_b128 v[108:111], v32
		ds_read_b128 v[120:123], v1
		v_cvt_pk_f16_f32 v124, v160, v161
		s_waitcnt lgkmcnt(3)
		v_pk_fma_f32 v[168:169], v[8:9], v[58:59], v[8:9]
		v_pk_fma_f32 v[170:171], v[10:11], v[60:61], v[10:11]
		s_waitcnt lgkmcnt(2)
		v_pk_fma_f32 v[172:173], v[36:37], v[62:63], v[36:37]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_write_b128 v54, v[132:135]
		ds_write_b128 v152, v[136:139]
		ds_write_b128 v4, v[140:143]
		ds_write_b128 v5, v[144:147]
		v_pk_fma_f32 v[174:175], v[38:39], v[64:65], v[38:39]
		v_pk_fma_f32 v[56:57], v[108:109], v[66:67], v[108:109]
		v_pk_fma_f32 v[58:59], v[110:111], v[88:89], v[110:111]
		v_pk_fma_f32 v[60:61], v[120:121], v[68:69], v[120:121]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_read_b128 v[8:11], v30
		ds_read_b128 v[36:39], v31
		...
		v_pk_fma_f32 v[62:63], v[122:123], v[90:91], v[122:123]
		s_waitcnt lgkmcnt(3)
		v_pk_fma_f32 v[128:129], v[8:9], v[70:71], v[8:9]
		v_pk_fma_f32 v[130:131], v[10:11], v[92:93], v[10:11]
		s_waitcnt lgkmcnt(2)
		v_pk_fma_f32 v[132:133], v[36:37], v[72:73], v[36:37]
		s_waitcnt lgkmcnt(0)
		s_barrier
		ds_write_b128 v54, v[148:151]
		ds_write_b128 v152, v[40:43]
		ds_write_b128 v4, v[44:47]
		ds_write_b128 v5, v[48:51]
		v_pk_fma_f32 v[134:135], v[38:39], v[94:95], v[38:39]
		v_pk_fma_f32 v[40:41], v[64:65], v[74:75], v[64:65]
		v_pk_fma_f32 v[42:43], v[66:67], v[96:97], v[66:67]
		v_pk_fma_f32 v[44:45], v[108:109], v[76:77], v[108:109]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_fma_f32 v[46:47], v[110:111], v[98:99], v[110:111]
		s_waitcnt lgkmcnt(3)
		v_pk_fma_f32 v[48:49], v[4:5], v[78:79], v[4:5]
		v_pk_fma_f32 v[50:51], v[6:7], v[100:101], v[6:7]
		s_waitcnt lgkmcnt(2)
		v_pk_fma_f32 v[52:53], v[8:9], v[80:81], v[8:9]
		v_pk_fma_f32 v[54:55], v[10:11], v[102:103], v[10:11]
		s_waitcnt lgkmcnt(1)
		v_pk_fma_f32 v[64:65], v[28:29], v[82:83], v[28:29]
		v_pk_fma_f32 v[66:67], v[30:31], v[104:105], v[30:31]
		s_waitcnt lgkmcnt(0)
		v_pk_fma_f32 v[68:69], v[32:33], v[84:85], v[32:33]
		v_pk_fma_f32 v[70:71], v[34:35], v[106:107], v[34:35]
		v_cvt_pk_f16_f32 v125, v162, v163
		v_cvt_pk_f16_f32 v126, v164, v165
		v_cvt_pk_f16_f32 v127, v166, v167
		...
		s_mov_b32 s2, s30
		s_mov_b32 s3, s31
		buffer_store_dwordx4 v[124:127], v1, s[0:3], 0 offen sc0 nt
