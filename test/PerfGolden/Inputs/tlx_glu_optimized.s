...
.Ltlx_addmm_glu_kernel_optimized.if_end_0:
		...
		v_xad_u32 v19, v10, -1, 1
		v_cmp_lt_i32_e64 vcc, v21, s16
		s_mov_b64 s[26:27], vcc
		v_xad_u32 v20, v21, -1, 1
		v_cndmask_b32_e64 v10, v10, v19, s[20:21]
		...
		v_xad_u32 v19, v4, -1, 1
		v_cmp_lt_i32_e64 vcc, v22, s16
		s_mov_b64 s[20:21], vcc
		v_xad_u32 v20, v22, -1, 1
		...
		v_bitop3_b32 v16, v23, v17, v18 bitop3:0x96
		...
		v_cndmask_b32_e32 v30, v28, v22, vcc
		s_add_i32 m0, m0, 0x2100
		s_add_i32 s0, s1, s0
		buffer_load_dwordx4 v30, s[28:31], 0 offen lds
		v_bitop3_b32 v30, v26, v6, v9 bitop3:0x96
		v_xor_b32_e32 v30, v30, v25
		v_bitop3_b32 v31, 4, v26, v6 bitop3:0x96
		v_bitop3_b32 v32, 32, v26, v6 bitop3:0x96
		v_bitop3_b32 v32, v32, v9, v25 bitop3:0x96
		v_cmp_lt_i32_e64 s[4:5], v30, s14
		v_cmp_lt_i32_e64 vcc, v32, s14
		v_lshlrev_b32_e32 v33, 1, v2
		v_lshlrev_b32_e32 v34, 1, v7
		v_add3_u32 v21, v21, v34, v24
		v_and_b32_e32 v3, 1, v3
		v_lshl_add_u32 v21, v3, 4, v21
		s_waitcnt lgkmcnt(0)
		v_mul_lo_u32 v34, s17, v21
		...
		v_add_u32_e32 v26, 32, v21
		v_mul_lo_u32 v26, s17, v26
		v_lshl_add_u32 v26, v26, 1, v33
		v_cndmask_b32_e32 v36, v28, v26, vcc
		s_add_i32 m0, m0, 0x2100
		v_bitop3_b32 v31, v31, v9, v25 bitop3:0x96
		buffer_load_dwordx4 v36, s[24:27], 0 offen lds
		v_add_u32_e32 v21, 36, v21
		v_mul_lo_u32 v21, s17, v21
		v_lshl_add_u32 v21, v21, 1, v33
		v_cndmask_b32_e32 v36, v28, v21, vcc
		s_add_i32 m0, m0, 0x2100
		v_bitop3_b32 v6, v6, v9, v25 bitop3:0x96
		buffer_load_dwordx4 v36, s[24:27], 0 offen lds
		...
		buffer_load_dwordx4 v9, s[24:27], 0 offen lds
		v_add_u32_e32 v9, s4, v26
		v_cndmask_b32_e32 v9, v28, v9, vcc
		s_add_i32 m0, m0, 0x2100
		v_add_u32_e32 v36, s4, v21
		...
		v_add_u32_e32 v29, s4, v34
		buffer_load_dwordx4 v22, s[28:31], 0 offen lds
		v_cndmask_b32_e64 v22, v28, v29, s[12:13]
		s_add_i32 m0, m0, 0x128e0
		v_add_u32_e32 v29, s4, v35
		buffer_load_dwordx4 v22, s[24:27], 0 offen lds
		v_cndmask_b32_e64 v22, v28, v29, s[12:13]
		s_add_i32 m0, m0, 0x2100
		v_add_u32_e32 v29, s4, v26
		...
		v_lshl_add_u32 v38, v5, 5, v9
		buffer_load_dwordx4 v22, s[24:27], 0 offen lds
		s_waitcnt vmcnt(6)
		s_barrier
		v_mov_b32_e32 v22, 0x420
		v_mul_lo_u32 v22, v22, v37
		v_add3_u32 v8, v8, v36, v22
		...
		v_lshlrev_b32_e32 v22, 9, v3
		v_add3_u32 v36, v38, v22, v18
		ds_read_b64_tr_b16 v[72:73], v36 offset:50656
		ds_read_b64_tr_b16 v[74:75], v36 offset:59104
		v_add_u32_e32 v9, 0x10000, v9
		v_lshl_add_u32 v5, v5, 5, v9
		v_add3_u32 v5, v5, v22, v18
		ds_read_b64_tr_b16 v[76:77], v5 offset:2016
		ds_read_b64_tr_b16 v[78:79], v5 offset:10464
		ds_read_b64_tr_b16 v[80:81], v36 offset:50784
		ds_read_b64_tr_b16 v[82:83], v36 offset:59232
		ds_read_b64_tr_b16 v[84:85], v5 offset:2144
		ds_read_b64_tr_b16 v[86:87], v5 offset:10592
		ds_read_b64_tr_b16 v[88:89], v36 offset:50912
		ds_read_b64_tr_b16 v[90:91], v36 offset:59360
		ds_read_b64_tr_b16 v[92:93], v5 offset:2272
		ds_read_b64_tr_b16 v[94:95], v5 offset:10720
		ds_read_b64_tr_b16 v[96:97], v36 offset:51040
		ds_read_b64_tr_b16 v[98:99], v36 offset:59488
...
.Ltlx_addmm_glu_kernel_optimized.loop_head_0:
		...
		buffer_load_dwordx4 v1, s[24:27], 0 offen lds
		v_add_u32_e32 v1, s13, v21
		v_cndmask_b32_e32 v1, v28, v1, vcc
		v_add_u32_e32 v5, s15, v8
		s_add_i32 m0, m0, 0x2100
		v_add_u32_e32 v17, s5, v36
		buffer_load_dwordx4 v1, s[24:27], 0 offen lds
		s_barrier
		s_waitcnt vmcnt(6)
		ds_read_b128 v[40:43], v5
		ds_read_b128 v[44:47], v5 offset:64
		ds_read_b128 v[48:51], v5 offset:256
		ds_read_b128 v[52:55], v5 offset:320
		ds_read_b128 v[56:59], v5 offset:512
		ds_read_b128 v[60:63], v5 offset:576
		ds_read_b128 v[64:67], v5 offset:768
		ds_read_b128 v[68:71], v5 offset:832
		ds_read_b64_tr_b16 v[72:73], v17 offset:50656
		ds_read_b64_tr_b16 v[74:75], v17 offset:59104
		v_add_u32_e32 v1, s22, v36
		ds_read_b64_tr_b16 v[76:77], v1 offset:2016
		ds_read_b64_tr_b16 v[78:79], v1 offset:10464
		ds_read_b64_tr_b16 v[80:81], v17 offset:50784
		ds_read_b64_tr_b16 v[82:83], v17 offset:59232
		ds_read_b64_tr_b16 v[84:85], v1 offset:2144
		ds_read_b64_tr_b16 v[86:87], v1 offset:10592
		ds_read_b64_tr_b16 v[88:89], v17 offset:50912
		ds_read_b64_tr_b16 v[90:91], v17 offset:59360
		ds_read_b64_tr_b16 v[92:93], v1 offset:2272
		ds_read_b64_tr_b16 v[94:95], v1 offset:10720
		ds_read_b64_tr_b16 v[96:97], v17 offset:51040
		ds_read_b64_tr_b16 v[98:99], v17 offset:59488
...
.Ltlx_addmm_glu_kernel_optimized.exec_endif_1:
		...
		v_add_u32_e32 v1, s0, v36
		ds_read_b64_tr_b16 v[72:73], v1 offset:50656
		ds_read_b64_tr_b16 v[74:75], v1 offset:59104
		s_add_i32 s0, s0, 0x10000
		v_add_u32_e32 v5, s0, v36
		ds_read_b64_tr_b16 v[36:37], v5 offset:2016
		ds_read_b64_tr_b16 v[38:39], v5 offset:10464
		...
		s_waitcnt lgkmcnt(1)
		v_pk_add_f32 v[16:17], v[36:37], v[6:7]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_cvt_f32_f16_e32 v22, v169
		v_cvt_f32_f16_sdwa v23, v169 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_e32 v56, v170
		v_cvt_f32_f16_sdwa v57, v170 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		s_waitcnt lgkmcnt(3)
		v_pk_add_f32 v[58:59], v[60:61], v[6:7]
		v_pk_add_f32 v[60:61], v[62:63], v[22:23]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_pk_add_f32 v[0:1], v[64:65], v[56:57]
		v_pk_add_f32 v[62:63], v[68:69], v[6:7]
		v_pk_add_f32 v[64:65], v[70:71], v[22:23]
		v_pk_add_f32 v[68:69], v[72:73], v[56:57]
		s_waitcnt lgkmcnt(0)
		s_barrier
		...
		v_cvt_f32_f16_sdwa v93, v33 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_cvt_f32_f16_e32 v96, v173
		v_cvt_f32_f16_sdwa v97, v173 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v98, v174
		v_cvt_f32_f16_sdwa v99, v174 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		v_cvt_f32_f16_e32 v100, v175
		v_cvt_f32_f16_sdwa v101, v175 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		s_waitcnt vmcnt(5)
		v_cvt_f32_f16_e32 v102, v176
		v_cvt_f32_f16_sdwa v103, v176 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
		...
		v_pk_fma_f32 v[84:85], v[8:9], v[72:73], v[8:9]
		v_pk_fma_f32 v[8:9], v[24:25], v[92:93], v[24:25]
		v_pk_fma_f32 v[24:25], v[28:29], v[32:33], v[28:29]
		v_pk_fma_f32 v[28:29], v[30:31], v[94:95], v[30:31]
		v_pk_fma_f32 v[30:31], v[16:17], v[34:35], v[16:17]
		v_pk_fma_f32 v[16:17], v[26:27], v[96:97], v[26:27]
		v_pk_fma_f32 v[26:27], v[40:41], v[98:99], v[40:41]
		v_pk_fma_f32 v[32:33], v[42:43], v[100:101], v[42:43]
		v_pk_fma_f32 v[34:35], v[36:37], v[102:103], v[36:37]
		v_pk_fma_f32 v[36:37], v[38:39], v[104:105], v[38:39]
		v_pk_fma_f32 v[38:39], v[44:45], v[106:107], v[44:45]
		v_pk_fma_f32 v[40:41], v[46:47], v[108:109], v[46:47]
		v_pk_fma_f32 v[42:43], v[48:49], v[110:111], v[48:49]
		v_pk_fma_f32 v[44:45], v[50:51], v[112:113], v[50:51]
		v_pk_fma_f32 v[46:47], v[52:53], v[114:115], v[52:53]
		v_pk_fma_f32 v[48:49], v[54:55], v[116:117], v[54:55]
		v_pk_fma_f32 v[50:51], v[58:59], v[118:119], v[58:59]
		v_pk_fma_f32 v[52:53], v[60:61], v[120:121], v[60:61]
		v_pk_fma_f32 v[54:55], v[0:1], v[122:123], v[0:1]
		v_pk_fma_f32 v[0:1], v[66:67], v[124:125], v[66:67]
		v_pk_fma_f32 v[58:59], v[62:63], v[126:127], v[62:63]
		v_pk_fma_f32 v[60:61], v[64:65], v[128:129], v[64:65]
		v_pk_fma_f32 v[62:63], v[68:69], v[130:131], v[68:69]
		v_pk_fma_f32 v[64:65], v[74:75], v[132:133], v[74:75]
		v_pk_fma_f32 v[66:67], v[76:77], v[134:135], v[76:77]
		v_pk_fma_f32 v[68:69], v[78:79], v[136:137], v[78:79]
		...
		v_pk_fma_f32 v[6:7], v[22:23], v[144:145], v[22:23]
		v_pk_fma_f32 v[22:23], v[56:57], v[146:147], v[56:57]
		v_pk_fma_f32 v[56:57], v[70:71], v[148:149], v[70:71]
		...
		buffer_store_dwordx4 v[8:11], v3, s[0:3], 0 offen sc0 nt
		v_mul_lo_u32 v0, s19, v12
		v_add_lshl_u32 v0, v2, v0, 1
		v_cvt_pk_f16_f32 v8, v58, v59
		v_cvt_pk_f16_f32 v9, v60, v61
		...
		v_add_lshl_u32 v0, v2, v0, 1
		v_cvt_pk_f16_f32 v8, v66, v67
		v_cvt_pk_f16_f32 v9, v68, v69
		v_cvt_pk_f16_f32 v10, v72, v73
		v_cvt_pk_f16_f32 v11, v74, v75
		buffer_store_dwordx4 v[8:11], v0, s[0:3], 0 offen sc0 nt
