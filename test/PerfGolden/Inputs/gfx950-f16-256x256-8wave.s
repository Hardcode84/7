...
.Lwmma_f16_matmul_tiled.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		s_add_i32 s2, s2, s12
		buffer_load_dwordx4 v9, s[16:19], s2 offen lds
		...
		ds_read_b128 v[24:27], v3 offset:49152
		ds_read_b128 v[28:31], v3 offset:50176
...
.Lwmma_f16_matmul_tiled.if_end_0:
		...
		v_add_u32_e32 v11, 0x200100, v4
		v_add_u32_e32 v64, 0x140, v4
		v_add_u32_e32 v65, 0x200140, v4
		v_add_u32_e32 v66, 0x100, v10
		v_add_u32_e32 v67, 0x200100, v10
		v_add_u32_e32 v68, 0x140, v10
		v_add_u32_e32 v69, 0x200140, v10
		v_add_u32_e32 v70, 0x180, v4
		v_add_u32_e32 v71, 0x200180, v4
		v_add_u32_e32 v72, 0x1c0, v4
		v_add_u32_e32 v73, 0x2001c0, v4
		v_add_u32_e32 v4, 0x180, v10
		v_add_u32_e32 v74, 0x200180, v10
		v_add_u32_e32 v75, 0x1c0, v10
		v_add_u32_e32 v76, 0x2001c0, v10
		v_add_u32_e32 v10, 0x10000, v7
...
.Lwmma_f16_matmul_tiled.loop_head_0:
		...
		ds_read_b128 v[204:207], v3 offset:8192
		ds_read_b128 v[208:211], v3 offset:9216
		ds_read_b128 v[212:215], v3 offset:10240
		ds_read_b128 v[216:219], v3 offset:11264
		ds_read_b128 v[220:223], v3 offset:24576
		ds_read_b128 v[224:227], v3 offset:25600
		ds_read_b128 v[228:231], v3 offset:26624
		ds_read_b128 v[232:235], v3 offset:27648
		s_setprio 0
		s_waitcnt vmcnt(10) lgkmcnt(0)
		s_barrier
		...
		ds_read_b128 v[32:35], v10 offset:8192
		ds_read_b128 v[36:39], v10 offset:9216
		ds_read_b128 v[40:43], v10 offset:24576
		ds_read_b128 v[44:47], v10 offset:25600
		s_setprio 0
		s_waitcnt vmcnt(10) lgkmcnt(0)
		s_barrier
		...
		ds_read_b128 v[40:43], v3 offset:2048
		ds_read_b128 v[44:47], v3 offset:3072
...
.Lwmma_f16_matmul_tiled.if_end_1:
		...
		s_waitcnt vmcnt(10)
		s_barrier
		ds_read_b128 v[64:67], v3 offset:8192
		ds_read_b128 v[68:71], v3 offset:9216
		ds_read_b128 v[72:75], v3 offset:10240
		ds_read_b128 v[204:207], v3 offset:11264
		ds_read_b128 v[208:211], v3 offset:24576
		ds_read_b128 v[212:215], v3 offset:25600
		ds_read_b128 v[216:219], v3 offset:26624
		ds_read_b128 v[220:223], v3 offset:27648
		s_setprio 0
		s_waitcnt lgkmcnt(7)
		...
		s_waitcnt vmcnt(2)
		s_barrier
		ds_read_b128 v[64:67], v77 offset:8192
		ds_read_b128 v[68:71], v77 offset:9216
		ds_read_b128 v[72:75], v77 offset:10240
		ds_read_b128 v[204:207], v77 offset:11264
		ds_read_b128 v[208:211], v77 offset:24576
		ds_read_b128 v[212:215], v77 offset:25600
		ds_read_b128 v[216:219], v77 offset:26624
		ds_read_b128 v[220:223], v77 offset:27648
		s_setprio 0
		s_waitcnt lgkmcnt(7)
		v_mfma_f32_16x16x32_f16 v[140:143], v[64:67], v[32:35], v[140:143]
		s_waitcnt lgkmcnt(6)
		v_mfma_f32_16x16x32_f16 v[156:159], v[68:71], v[32:35], v[156:159]
		s_waitcnt lgkmcnt(5)
		v_mfma_f32_16x16x32_f16 v[172:175], v[72:75], v[32:35], v[172:175]
		s_waitcnt lgkmcnt(4)
		v_mfma_f32_16x16x32_f16 v[188:191], v[204:207], v[32:35], v[188:191]
		v_mfma_f32_16x16x32_f16 v[192:195], v[204:207], v[36:39], v[192:195]
		...
		s_waitcnt lgkmcnt(3)
		v_mfma_f32_16x16x32_f16 v[140:143], v[208:211], v[40:43], v[140:143]
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[156:159], v[212:215], v[40:43], v[156:159]
		s_waitcnt lgkmcnt(1)
		v_mfma_f32_16x16x32_f16 v[172:175], v[216:219], v[40:43], v[172:175]
		s_waitcnt lgkmcnt(0)
		v_mfma_f32_16x16x32_f16 v[188:191], v[220:223], v[40:43], v[188:191]
		v_mfma_f32_16x16x32_f16 v[192:195], v[220:223], v[44:47], v[192:195]
		v_mfma_f32_16x16x32_f16 v[176:179], v[216:219], v[44:47], v[176:179]
		v_mfma_f32_16x16x32_f16 v[160:163], v[212:215], v[44:47], v[160:163]
		v_mfma_f32_16x16x32_f16 v[144:147], v[208:211], v[44:47], v[144:147]
		s_setprio 1
		s_waitcnt vmcnt(0)
		s_barrier
		ds_read_b128 v[32:35], v10 offset:8192
		...
		v_cvt_pk_f16_f32 v9, v98, v99
		v_cvt_pk_f16_f32 v10, v108, v109
		v_cvt_pk_f16_f32 v11, v110, v111
		v_cvt_pk_f16_f32 v12, v112, v113
		v_cvt_pk_f16_f32 v13, v114, v115
		v_cvt_pk_f16_f32 v14, v124, v125
		v_cvt_pk_f16_f32 v15, v126, v127
		v_cvt_pk_f16_f32 v76, v128, v129
		v_cvt_pk_f16_f32 v77, v130, v131
		v_cvt_pk_f16_f32 v78, v140, v141
		v_cvt_pk_f16_f32 v79, v142, v143
		v_cvt_pk_f16_f32 v80, v144, v145
		v_cvt_pk_f16_f32 v81, v146, v147
		v_cvt_pk_f16_f32 v82, v156, v157
		v_cvt_pk_f16_f32 v83, v158, v159
		v_cvt_pk_f16_f32 v92, v160, v161
		v_cvt_pk_f16_f32 v93, v162, v163
		v_cvt_pk_f16_f32 v94, v172, v173
		v_cvt_pk_f16_f32 v95, v174, v175
		v_cvt_pk_f16_f32 v96, v176, v177
		v_cvt_pk_f16_f32 v97, v178, v179
		v_cvt_pk_f16_f32 v98, v188, v189
		v_cvt_pk_f16_f32 v99, v190, v191
		v_cvt_pk_f16_f32 v108, v192, v193
		v_cvt_pk_f16_f32 v109, v194, v195
		s_waitcnt lgkmcnt(3)
		v_mfma_f32_16x16x32_f16 v[84:87], v[16:19], v[32:35], v[84:87]
		s_waitcnt lgkmcnt(2)
		v_mfma_f32_16x16x32_f16 v[88:91], v[16:19], v[36:39], v[88:91]
		...
		v_mfma_f32_16x16x32_f16 v[132:135], v[28:31], v[32:35], v[132:135]
		v_mfma_f32_16x16x32_f16 v[136:139], v[28:31], v[36:39], v[136:139]
		v_mfma_f32_16x16x32_f16 v[200:203], v[204:207], v[36:39], v[200:203]
		v_mfma_f32_16x16x32_f16 v[196:199], v[204:207], v[32:35], v[196:199]
		v_mfma_f32_16x16x32_f16 v[148:151], v[64:67], v[32:35], v[148:151]
		v_mfma_f32_16x16x32_f16 v[152:155], v[64:67], v[36:39], v[152:155]
		...
		v_mfma_f32_16x16x32_f16 v[132:135], v[60:63], v[40:43], v[132:135]
		v_mfma_f32_16x16x32_f16 v[136:139], v[60:63], v[44:47], v[136:139]
		v_mfma_f32_16x16x32_f16 v[200:203], v[220:223], v[44:47], v[200:203]
		v_mfma_f32_16x16x32_f16 v[196:199], v[220:223], v[40:43], v[196:199]
		v_cvt_pk_f16_f32 v16, v84, v85
		v_cvt_pk_f16_f32 v17, v86, v87
		v_cvt_pk_f16_f32 v18, v88, v89
		v_cvt_pk_f16_f32 v19, v90, v91
		v_cvt_pk_f16_f32 v20, v100, v101
		v_cvt_pk_f16_f32 v21, v102, v103
		v_cvt_pk_f16_f32 v22, v104, v105
		v_cvt_pk_f16_f32 v23, v106, v107
		v_cvt_pk_f16_f32 v24, v116, v117
		v_cvt_pk_f16_f32 v25, v118, v119
		v_cvt_pk_f16_f32 v26, v120, v121
		v_cvt_pk_f16_f32 v27, v122, v123
		v_cvt_pk_f16_f32 v28, v132, v133
		v_cvt_pk_f16_f32 v29, v134, v135
		v_cvt_pk_f16_f32 v30, v136, v137
		v_cvt_pk_f16_f32 v31, v138, v139
		v_cvt_pk_f16_f32 v32, v196, v197
		v_cvt_pk_f16_f32 v33, v198, v199
		v_cvt_pk_f16_f32 v34, v200, v201
		v_cvt_pk_f16_f32 v35, v202, v203
		v_mfma_f32_16x16x32_f16 v[148:151], v[208:211], v[40:43], v[148:151]
		v_mfma_f32_16x16x32_f16 v[152:155], v[208:211], v[44:47], v[152:155]
		v_mfma_f32_16x16x32_f16 v[164:167], v[212:215], v[40:43], v[164:167]
		v_mfma_f32_16x16x32_f16 v[180:183], v[216:219], v[40:43], v[180:183]
		...
		v_cvt_pk_f16_f32 v36, v152, v153
		v_cvt_pk_f16_f32 v37, v154, v155
		v_cvt_pk_f16_f32 v38, v164, v165
		v_cvt_pk_f16_f32 v39, v166, v167
		v_cvt_pk_f16_f32 v40, v168, v169
		v_cvt_pk_f16_f32 v41, v170, v171
		v_cvt_pk_f16_f32 v42, v180, v181
		v_cvt_pk_f16_f32 v43, v182, v183
		v_cvt_pk_f16_f32 v44, v184, v185
		v_cvt_pk_f16_f32 v45, v186, v187
		s_add_i32 s2, s2, s9
		buffer_store_dwordx2 v[4:5], v0, s[12:15], s2 offen
		s_add_i32 s3, s24, s0
		s_add_i32 s3, s3, s9
		buffer_store_dwordx2 v[16:17], v0, s[12:15], s3 offen
		s_add_i32 s4, s8, 0x240000
		s_add_i32 s0, s4, s0
		s_add_i32 s0, s0, s9
		buffer_store_dwordx2 v[18:19], v0, s[12:15], s0 offen
		buffer_store_dwordx2 v[6:7], v0, s[12:15], s1 offen offset:32
		buffer_store_dwordx2 v[8:9], v0, s[12:15], s2 offen offset:32
		buffer_store_dwordx2 v[20:21], v0, s[12:15], s3 offen offset:32
		buffer_store_dwordx2 v[22:23], v0, s[12:15], s0 offen offset:32
		buffer_store_dwordx2 v[10:11], v0, s[12:15], s1 offen offset:64
		buffer_store_dwordx2 v[12:13], v0, s[12:15], s2 offen offset:64
		buffer_store_dwordx2 v[24:25], v0, s[12:15], s3 offen offset:64
		buffer_store_dwordx2 v[26:27], v0, s[12:15], s0 offen offset:64
		buffer_store_dwordx2 v[14:15], v0, s[12:15], s1 offen offset:96
		buffer_store_dwordx2 v[76:77], v0, s[12:15], s2 offen offset:96
		buffer_store_dwordx2 v[28:29], v0, s[12:15], s3 offen offset:96
		buffer_store_dwordx2 v[30:31], v0, s[12:15], s0 offen offset:96
		buffer_store_dwordx2 v[78:79], v0, s[12:15], s1 offen offset:256
		buffer_store_dwordx2 v[80:81], v0, s[12:15], s2 offen offset:256
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:256
		buffer_store_dwordx2 v[36:37], v0, s[12:15], s0 offen offset:256
		buffer_store_dwordx2 v[82:83], v0, s[12:15], s1 offen offset:288
		buffer_store_dwordx2 v[92:93], v0, s[12:15], s2 offen offset:288
		buffer_store_dwordx2 v[38:39], v0, s[12:15], s3 offen offset:288
		buffer_store_dwordx2 v[40:41], v0, s[12:15], s0 offen offset:288
		buffer_store_dwordx2 v[94:95], v0, s[12:15], s1 offen offset:320
		buffer_store_dwordx2 v[96:97], v0, s[12:15], s2 offen offset:320
		buffer_store_dwordx2 v[42:43], v0, s[12:15], s3 offen offset:320
		buffer_store_dwordx2 v[44:45], v0, s[12:15], s0 offen offset:320
		buffer_store_dwordx2 v[98:99], v0, s[12:15], s1 offen offset:352
		buffer_store_dwordx2 v[108:109], v0, s[12:15], s2 offen offset:352
		buffer_store_dwordx2 v[32:33], v0, s[12:15], s3 offen offset:352
		buffer_store_dwordx2 v[34:35], v0, s[12:15], s0 offen offset:352
		s_endpgm
