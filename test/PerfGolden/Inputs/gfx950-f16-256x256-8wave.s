...
.Lwmma_f16_matmul_tiled.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		v_add_u32_e32 v11, 0x200080, v10
		s_add_i32 m0, m0, 0x2000
		s_mov_b32 s6, 0x2000
		buffer_load_dwordx4 v11, s[12:15], 0 offen lds
		...
		buffer_load_dwordx4 v11, s[12:15], 0 offen lds
		v_add_u32_e32 v10, 0x2000c0, v10
		s_add_i32 m0, m0, 0x2000
		s_add_i32 s7, s10, 0x80
		buffer_load_dwordx4 v10, s[12:15], 0 offen lds
		...
		v_lshlrev_b32_e32 v1, 12, v9
		v_add3_u32 v9, v10, v1, v0
		ds_read_b128 v[80:83], v9 offset:32768
		ds_read_b128 v[84:87], v9 offset:33792
		ds_read_b128 v[88:91], v9 offset:34816
		ds_read_b128 v[92:95], v9 offset:35840
		ds_read_b128 v[96:99], v9 offset:49152
		ds_read_b128 v[100:103], v9 offset:50176
		ds_read_b128 v[104:107], v9 offset:51200
		ds_read_b128 v[108:111], v9 offset:52224
		v_add_u32_e32 v9, 0x100, v3
		v_add_u32_e32 v11, 0x200100, v3
		v_add_u32_e32 v13, 0x140, v3
		v_add_u32_e32 v14, 0x200140, v3
		v_add_u32_e32 v3, 0x100, v8
		v_add_u32_e32 v15, 0x200100, v8
		v_add_u32_e32 v112, 0x140, v8
		v_add_u32_e32 v113, 0x200140, v8
		s_mov_b32 vcc_lo, s5
		s_mov_b32 vcc_hi, 0
...
.Lwmma_f16_matmul_tiled.loop_head_0:
		s_mov_b32 m0, s17
		s_lshl_b32 s5, s7, 7
		s_add_i32 s8, s17, 0x10000
		s_add_i32 s7, s7, 1
		s_and_b32 s9, s7, 1
		s_lshl_b32 s9, s9, 16
		v_add_u32_e32 v8, s9, v2
		v_add3_u32 v8, v8, v10, v0
		v_add_u32_e32 v114, s9, v10
		v_add3_u32 v114, v114, v1, v0
		s_and_b32 s17, s8, 0x1ffff
		s_waitcnt lgkmcnt(0)
		buffer_load_dwordx4 v9, s[12:15], s5 offen lds
		v_mfma_f32_16x16x32_f16 v[4:7], v[16:19], v[80:83], v[4:7]
		s_add_i32 m0, m0, 0x2000
		v_mfma_f32_16x16x32_f16 v[116:119], v[16:19], v[84:87], v[116:119]
		buffer_load_dwordx4 v11, s[12:15], s5 offen lds
		...
		buffer_load_dwordx4 v3, s[0:3], s5 offen lds
...
.Lwmma_f16_matmul_tiled.dma_issue_delay_0:
		...
		ds_read_b128 v[64:67], v8 offset:20480
		...
		ds_read_b128 v[68:71], v8 offset:21504
		...
		ds_read_b128 v[72:75], v8 offset:22528
		...
		ds_read_b128 v[76:79], v8 offset:23552
		s_cmp_lt_i32 s7, 0x7e
...
.Lwmma_f16_matmul_tiled.loop_exit_0:
		...
		s_waitcnt lgkmcnt(7)
		v_mfma_f32_16x16x32_f16 v[4:7], v[16:19], v[8:11], v[4:7]
		v_lshl_add_u32 v0, s4, 14, v12
		s_waitcnt lgkmcnt(6)
		...
		v_mfma_f32_16x16x32_f16 v[128:131], v[20:23], v[8:11], v[128:131]
		...
		v_mfma_f32_16x16x32_f16 v[144:147], v[24:27], v[8:11], v[144:147]
		...
		v_mfma_f32_16x16x32_f16 v[160:163], v[28:31], v[8:11], v[160:163]
		...
		v_mfma_f32_16x16x32_f16 v[176:179], v[32:35], v[8:11], v[176:179]
		...
		v_mfma_f32_16x16x32_f16 v[192:195], v[36:39], v[8:11], v[192:195]
		...
		v_mfma_f32_16x16x32_f16 v[208:211], v[40:43], v[8:11], v[208:211]
		...
		v_mfma_f32_16x16x32_f16 v[224:227], v[44:47], v[8:11], v[224:227]
