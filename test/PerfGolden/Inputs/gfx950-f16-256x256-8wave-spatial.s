...
.Lwmma_f16_matmul_tiled.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		buffer_load_dwordx4 v9, s[20:23], s3 offen lds
		s_mov_b32 s3, 0
...
.Lwmma_f16_matmul_tiled.loop_head_0:
		...
		ds_read_b128 v[204:207], v8 offset:8192
		ds_read_b128 v[208:211], v8 offset:9216
		ds_read_b128 v[212:215], v8 offset:10240
		ds_read_b128 v[216:219], v8 offset:11264
		ds_read_b128 v[220:223], v8 offset:24576
		ds_read_b128 v[224:227], v8 offset:25600
		ds_read_b128 v[228:231], v8 offset:26624
		ds_read_b128 v[232:235], v8 offset:27648
		s_setprio 0
		s_waitcnt vmcnt(10) lgkmcnt(0)
		s_barrier
		...
		ds_read_b128 v[36:39], v8 offset:1024
		ds_read_b128 v[40:43], v8 offset:2048
		ds_read_b128 v[44:47], v8 offset:3072
		ds_read_b128 v[48:51], v8 offset:16384
		ds_read_b128 v[52:55], v8 offset:17408
		ds_read_b128 v[56:59], v8 offset:18432
		ds_read_b128 v[60:63], v8 offset:19456
...
.Lwmma_f16_matmul_tiled.if_end_1:
		...
		s_waitcnt vmcnt(10)
		s_barrier
		ds_read_b128 v[64:67], v8 offset:8192
		ds_read_b128 v[68:71], v8 offset:9216
		ds_read_b128 v[72:75], v8 offset:10240
		ds_read_b128 v[204:207], v8 offset:11264
		ds_read_b128 v[208:211], v8 offset:24576
		ds_read_b128 v[212:215], v8 offset:25600
		ds_read_b128 v[216:219], v8 offset:26624
		ds_read_b128 v[220:223], v8 offset:27648
		s_setprio 0
		s_waitcnt lgkmcnt(7)
		...
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:32
		v_cvt_pk_f16_f32 v2, v96, v97
		v_cvt_pk_f16_f32 v3, v98, v99
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:32
		v_cvt_pk_f16_f32 v2, v100, v101
		v_cvt_pk_f16_f32 v3, v102, v103
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:32
		v_cvt_pk_f16_f32 v2, v104, v105
		v_cvt_pk_f16_f32 v3, v106, v107
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:32
		v_cvt_pk_f16_f32 v2, v108, v109
		v_cvt_pk_f16_f32 v3, v110, v111
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:64
		v_cvt_pk_f16_f32 v2, v112, v113
		v_cvt_pk_f16_f32 v3, v114, v115
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:64
		v_cvt_pk_f16_f32 v2, v116, v117
		v_cvt_pk_f16_f32 v3, v118, v119
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:64
		v_cvt_pk_f16_f32 v2, v120, v121
		v_cvt_pk_f16_f32 v3, v122, v123
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:64
		v_cvt_pk_f16_f32 v2, v124, v125
		v_cvt_pk_f16_f32 v3, v126, v127
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:96
		v_cvt_pk_f16_f32 v2, v128, v129
		v_cvt_pk_f16_f32 v3, v130, v131
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:96
		v_cvt_pk_f16_f32 v2, v132, v133
		v_cvt_pk_f16_f32 v3, v134, v135
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:96
		v_cvt_pk_f16_f32 v2, v136, v137
		v_cvt_pk_f16_f32 v3, v138, v139
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:96
		v_cvt_pk_f16_f32 v2, v140, v141
		v_cvt_pk_f16_f32 v3, v142, v143
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:256
		v_cvt_pk_f16_f32 v2, v144, v145
		v_cvt_pk_f16_f32 v3, v146, v147
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:256
		...
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:256
		v_cvt_pk_f16_f32 v2, v156, v157
		v_cvt_pk_f16_f32 v3, v158, v159
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:288
		v_cvt_pk_f16_f32 v2, v160, v161
		v_cvt_pk_f16_f32 v3, v162, v163
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:288
		v_cvt_pk_f16_f32 v2, v164, v165
		v_cvt_pk_f16_f32 v3, v166, v167
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:288
		v_cvt_pk_f16_f32 v2, v168, v169
		v_cvt_pk_f16_f32 v3, v170, v171
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:288
		v_cvt_pk_f16_f32 v2, v172, v173
		v_cvt_pk_f16_f32 v3, v174, v175
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:320
		v_cvt_pk_f16_f32 v2, v176, v177
		v_cvt_pk_f16_f32 v3, v178, v179
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:320
		v_cvt_pk_f16_f32 v2, v180, v181
		v_cvt_pk_f16_f32 v3, v182, v183
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:320
		v_cvt_pk_f16_f32 v2, v184, v185
		v_cvt_pk_f16_f32 v3, v186, v187
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:320
		v_cvt_pk_f16_f32 v2, v188, v189
		v_cvt_pk_f16_f32 v3, v190, v191
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s1 offen offset:352
		v_cvt_pk_f16_f32 v2, v192, v193
		v_cvt_pk_f16_f32 v3, v194, v195
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s2 offen offset:352
		v_cvt_pk_f16_f32 v2, v196, v197
		v_cvt_pk_f16_f32 v3, v198, v199
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s3 offen offset:352
		v_cvt_pk_f16_f32 v2, v200, v201
		v_cvt_pk_f16_f32 v3, v202, v203
		buffer_store_dwordx2 v[2:3], v0, s[12:15], s0 offen offset:352
		s_endpgm
