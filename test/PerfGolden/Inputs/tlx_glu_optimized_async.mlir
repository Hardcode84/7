module attributes {gpu.container_module, tlx_wave.new_converter = true, tlx_wave.num_ctas = 1 : i32, tlx_wave.num_warps = 8 : i32, tlx_wave.source_target = "hip:gfx950", tlx_wave.threads_per_warp = 64 : i32, waveamdmachine.target = "amdgcn-amd-amdhsa--gfx950"} {
  gpu.module @kernels {
    func.func @tlx_addmm_glu_kernel_optimized_async(%arg0: !wave.ptr<#wave.global, f16>, %arg1: !wave.ptr<#wave.global, f16>, %arg2: !wave.ptr<#wave.global, f16>, %arg3: !wave.ptr<#wave.global, f16>, %arg4: !wave.ptr<#wave.global, f16>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32) -> !wave.mem.token attributes {gpu.kernel, gpu.known_block_size = array<i32: 512, 1, 1>, tlx_wave.converter.stage = "structural-emission", tlx_wave.num_warps = 8 : i32, tlx_wave.ttgir.noinline = false, tlx_wave.wave_size = 64 : i32, wave.kernel, wave.waves_per_workgroup = 8 : i64, wave.workgroup_size = array<i32: 512, 1, 1>, waveamdmachine.target_waves = 2 : i64} {
      ...
      %value_14, %token_15 = wave.gather %181 mapping <bit_offset = <"16*(128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_16, %token_17 = wave.gather %181 mapping <bit_offset = <"16*(4224 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_18, %token_19 = wave.gather %181 mapping <bit_offset = <"16*(256 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_20, %token_21 = wave.gather %181 mapping <bit_offset = <"16*(4480 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_22, %token_23 = wave.gather %181 mapping <bit_offset = <"16*(64 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_24, %token_25 = wave.gather %181 mapping <bit_offset = <"16*(4288 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_26, %token_27 = wave.gather %181 mapping <bit_offset = <"16*(320 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_28, %token_29 = wave.gather %181 mapping <bit_offset = <"16*(4544 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %334 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %395:24 = scf.for %arg12 = %c0_i32 to %389 step %c1_i32 iter_args(%arg13 = %value, %arg14 = %value_0, %arg15 = %value_2, %arg16 = %value_4, %arg17 = %value_6, %arg18 = %value_8, %arg19 = %value_10, %arg20 = %value_12, %arg21 = %360, %arg22 = %369, %arg23 = %378, %arg24 = %387, %arg25 = %43, %arg26 = %43, %arg27 = %43, %arg28 = %43, %arg29 = %43, %arg30 = %43, %arg31 = %43, %arg32 = %43, %arg33 = %332, %arg34 = %334, %arg35 = %390, %arg36 = %394) -> (!wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<8xf16>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.simd<vector<4xf32>, 64>, !wave.mem.token, !wave.mem.token, !wave.mem.token, !wave.mem.token)  : i32 {
        ...
        %value_114, %token_115 = wave.gather %1957 mapping <bit_offset = <"16*(128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_116, %token_117 = wave.gather %1957 mapping <bit_offset = <"16*(4224 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_118, %token_119 = wave.gather %1957 mapping <bit_offset = <"16*(256 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_120, %token_121 = wave.gather %1957 mapping <bit_offset = <"16*(4480 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_122, %token_123 = wave.gather %1957 mapping <bit_offset = <"16*(64 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_124, %token_125 = wave.gather %1957 mapping <bit_offset = <"16*(4288 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_126, %token_127 = wave.gather %1957 mapping <bit_offset = <"16*(320 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
        ...
        %value_128, %token_129 = wave.gather %1957 mapping <bit_offset = <"16*(4544 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %1947 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_46, %token_47 = wave.gather %589 mapping <bit_offset = <"16*(128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_48, %token_49 = wave.gather %589 mapping <bit_offset = <"16*(4224 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_50, %token_51 = wave.gather %589 mapping <bit_offset = <"16*(256 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_52, %token_53 = wave.gather %589 mapping <bit_offset = <"16*(4480 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_54, %token_55 = wave.gather %589 mapping <bit_offset = <"16*(64 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_56, %token_57 = wave.gather %589 mapping <bit_offset = <"16*(4288 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_58, %token_59 = wave.gather %589 mapping <bit_offset = <"16*(320 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_60, %token_61 = wave.gather %589 mapping <bit_offset = <"16*(4544 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %591 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_78, %token_79 = wave.gather %687 mapping <bit_offset = <"16*(128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_80, %token_81 = wave.gather %687 mapping <bit_offset = <"16*(4224 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_82, %token_83 = wave.gather %687 mapping <bit_offset = <"16*(256 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_84, %token_85 = wave.gather %687 mapping <bit_offset = <"16*(4480 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_86, %token_87 = wave.gather %687 mapping <bit_offset = <"16*(64 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_88, %token_89 = wave.gather %687 mapping <bit_offset = <"16*(4288 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_90, %token_91 = wave.gather %687 mapping <bit_offset = <"16*(320 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_92, %token_93 = wave.gather %687 mapping <bit_offset = <"16*(4544 + 128*floor(1/32*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)) + 528*floor(1/4*Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16)) + 16*Mod(floor(1/64*item + 1/16*slot + 1/64*floor(1/4*Mod(Mod(item, 64), 16)) - 1/64*Mod(Mod(item, 64), 16)), 4) + 2112*Mod(floor(1/16*Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64)), 2) + Mod(Mod(item, 64), 4) + 4*Mod(Mod(Mod(item + 4*slot + floor(1/4*Mod(Mod(item, 64), 16)) - Mod(Mod(item, 64), 16), 64), 16), 4))">> bindings ["item"](%68) after %688 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<4xf16>, 64>, !wave.mem.token)
      ...
      %value_94, %token_95 = wave.gather %834 mapping <bit_offset = <"16*Piecewise((offset0, slot == 0), (offset1, slot == 1), (offset2, slot == 2), (offset3, slot == 3), (offset4, slot == 4), (offset5, slot == 5), (offset6, slot == 6), (offset7, True))">> bindings ["offset0", "offset1", "offset2", "offset3", "offset4", "offset5", "offset6", "offset7"](%812, %815, %818, %821, %824, %827, %830, %833) : (!wave.ptr<#waveamd.buffer, f16>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>) -> (!wave.simd<vector<8xf16>, 64>, !wave.mem.token)
      ...
      %value_96, %token_97 = wave.gather %396 mapping <bit_offset = <"16*Piecewise((offset0, slot == 0), (offset1, slot == 1), (offset2, slot == 2), (offset3, slot == 3), (offset4, slot == 4), (offset5, slot == 5), (offset6, slot == 6), (offset7, slot == 7), (offset8, slot == 8), (offset9, slot == 9), (offset10, slot == 10), (offset11, slot == 11), (offset12, slot == 12), (offset13, slot == 13), (offset14, slot == 14), (offset15, slot == 15), (offset16, slot == 16), (offset17, slot == 17), (offset18, slot == 18), (offset19, slot == 19), (offset20, slot == 20), (offset21, slot == 21), (offset22, slot == 22), (offset23, slot == 23), (offset24, slot == 24), (offset25, slot == 25), (offset26, slot == 26), (offset27, slot == 27), (offset28, slot == 28), (offset29, slot == 29), (offset30, slot == 30), (offset31, True))">> bindings ["offset0", "offset1", "offset2", "offset3", "offset4", "offset5", "offset6", "offset7", "offset8", "offset9", "offset10", "offset11", "offset12", "offset13", "offset14", "offset15", "offset16", "offset17", "offset18", "offset19", "offset20", "offset21", "offset22", "offset23", "offset24", "offset25", "offset26", "offset27", "offset28", "offset29", "offset30", "offset31"](%948, %988, %1028, %1068, %1108, %1148, %1188, %1228, %1264, %1275, %1286, %1297, %1308, %1319, %1330, %1341, %1377, %1388, %1399, %1410, %1421, %1432, %1443, %1454, %1490, %1501, %1512, %1523, %1534, %1545, %1556, %1567) after %1568 : (!wave.ptr<#wave.shared, f16>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.simd<i32, 64>, !wave.mem.token) -> (!wave.simd<vector<32xf16>, 64>, !wave.mem.token)
      ...
      %observe_region_2 = wave.where %1690, %1691, %1692, %1693, %1694, %1695, %1696, %1697, %1698, %1699, %1700, %1701, %1702, %1703, %1704, %1705, %1706, %1707, %1708, %1709, %1710, %1711, %1712, %1713, %1714, %1715, %1716, %1717, %1718, %1719, %1720, %1721 {
        %1855 = wave.scatter %1854 to %1853 mapping <bit_offset = <"16*Piecewise((offset0, slot == 0), (offset1, slot == 1), (offset2, slot == 2), (offset3, slot == 3), (offset4, slot == 4), (offset5, slot == 5), (offset6, slot == 6), (offset7, slot == 7), (offset8, slot == 8), (offset9, slot == 9), (offset10, slot == 10), (offset11, slot == 11), (offset12, slot == 12), (offset13, slot == 13), (offset14, slot == 14), (offset15, slot == 15), (offset16, slot == 16), (offset17, slot == 17), (offset18, slot == 18), (offset19, slot == 19), (offset20, slot == 20), (offset21, slot == 21), (offset22, slot == 22), (offset23, slot == 23), (offset24, slot == 24), (offset25, slot == 25), (offset26, slot == 26), (offset27, slot == 27), (offset28, slot == 28), (offset29, slot == 29), (offset30, slot == 30), (offset31, True))">> bindings ["offset0", "offset1", "offset2", "offset3", "offset4", "offset5", "offset6", "offset7", "offset8", "offset9", "offset10", "offset11", "offset12", "offset13", "offset14", "offset15", "offset16", "offset17", "offset18", "offset19", "offset20", "offset21", "offset22", "offset23", "offset24", "offset25", "offset26", "offset27", "offset28", "offset29", "offset30", "offset31"](%1759, %1762, %1765, %1768, %1771, %1774, %1777, %1780, %1783, %1786, %1789, %1792, %1795, %1798, %1801, %1804, %1807, %1810, %1813, %1816, %1819, %1822, %1825, %1828, %1831, %1834, %1837, %1840, %1843, %1846, %1849, %1852) {cache = #waveamd.store_cache<cs>} : (!wave.simd<vector<32xf16>, 64>, !wave.ptr<#waveamd.buffer, f16>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>, !wave.simd<index, 64>) -> !wave.mem.token
        wave.yield %1855 : !wave.mem.token
      } otherwise {
        wave.yield %observe_seed_1 : !wave.mem.token
      } : !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64>, !wave.mask<64> -> !wave.mem.token
