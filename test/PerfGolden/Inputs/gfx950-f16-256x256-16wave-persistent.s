...
.Lgfx950_persistent_f16_gemm.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		v_mov_b32_e32 v3, 0
		ds_write_b64 v1, v[2:3] offset:32768
		ds_write_b32 v1, v2 offset:32776
		ds_write_b64 v1, v[2:3] offset:32780
		ds_write_b32 v1, v2 offset:32788
...
.Lgfx950_persistent_f16_gemm.loop_head_3:
		s_lshl_b32 s8, s5, 4
		s_add_i32 s8, s8, 15
		s_mul_hi_u32 s11, s5, 0xaaaaaaab
		...
		ds_read_b32 v9, v3 offset:32768
...
.Lgfx950_persistent_f16_gemm.if_end_8:
		...
		ds_read_b128 v[108:111], v9 offset:1024
		ds_read_b128 v[112:115], v9 offset:2048
		ds_read_b128 v[116:119], v9 offset:3072
		v_add_u32_e32 v9, s8, v2
		ds_read_b128 v[120:123], v9 offset:59392
		s_waitcnt lgkmcnt(0)
		...
		ds_read_b128 v[120:123], v9 offset:60416
		s_waitcnt lgkmcnt(0)
		...
		ds_read_b128 v[120:123], v9 offset:61440
		s_waitcnt lgkmcnt(0)
		...
		ds_read_b128 v[120:123], v9 offset:62464
		s_waitcnt lgkmcnt(0)
		...
		ds_read_b128 v[120:123], v9 offset:63488
		s_waitcnt lgkmcnt(0)
		...
		ds_read_b128 v[120:123], v9 offset:64512
		s_waitcnt lgkmcnt(0)
		v_mfma_f32_16x16x32_f16 v[28:31], v[104:107], v[120:123], v[28:31]
		v_mfma_f32_16x16x32_f16 v[52:55], v[108:111], v[120:123], v[52:55]
		v_mfma_f32_16x16x32_f16 v[76:79], v[112:115], v[120:123], v[76:79]
		v_mfma_f32_16x16x32_f16 v[100:103], v[116:119], v[120:123], v[100:103]
		s_cmp_lg_u32 s0, 0
...
.Lgfx950_persistent_f16_gemm.loop_exit_3:
		...
		v_cvt_pk_f16_f32 v44, v92, v93
		v_cvt_pk_f16_f32 v45, v94, v95
		v_cvt_pk_f16_f32 v46, v96, v97
		v_cvt_pk_f16_f32 v47, v98, v99
		...
		buffer_store_dwordx2 v[4:5], v0, s[12:15], s2 offen sc0 nt
		s_add_i32 s3, s0, 0x300000
		buffer_store_dwordx2 v[6:7], v0, s[12:15], s3 offen sc0 nt
		s_add_i32 s4, s0, 0x340000
		buffer_store_dwordx2 v[8:9], v0, s[12:15], s4 offen sc0 nt
		s_add_i32 s5, s0, 0x380000
		buffer_store_dwordx2 v[10:11], v0, s[12:15], s5 offen sc0 nt
		...
		buffer_store_dwordx2 v[16:17], v0, s[12:15], s2 offen offset:32 sc0 nt
		buffer_store_dwordx2 v[18:19], v0, s[12:15], s3 offen offset:32 sc0 nt
		buffer_store_dwordx2 v[20:21], v0, s[12:15], s4 offen offset:32 sc0 nt
		buffer_store_dwordx2 v[22:23], v0, s[12:15], s5 offen offset:32 sc0 nt
		...
		buffer_store_dwordx2 v[28:29], v0, s[12:15], s2 offen offset:64 sc0 nt
		buffer_store_dwordx2 v[30:31], v0, s[12:15], s3 offen offset:64 sc0 nt
		buffer_store_dwordx2 v[32:33], v0, s[12:15], s4 offen offset:64 sc0 nt
		buffer_store_dwordx2 v[34:35], v0, s[12:15], s5 offen offset:64 sc0 nt
		...
		buffer_store_dwordx2 v[40:41], v0, s[12:15], s2 offen offset:96 sc0 nt
		buffer_store_dwordx2 v[42:43], v0, s[12:15], s3 offen offset:96 sc0 nt
		buffer_store_dwordx2 v[44:45], v0, s[12:15], s4 offen offset:96 sc0 nt
		buffer_store_dwordx2 v[46:47], v0, s[12:15], s5 offen offset:96 sc0 nt
...
.Lgfx950_persistent_f16_gemm.if_else_7:
		...
		v_lshlrev_b32_e32 v3, 4, v3
		v_add3_u32 v8, s8, v2, v3
		v_add_u32_e32 v2, v2, v3
		s_mul_i32 s8, 0xffffc400, s2
		s_mul_i32 s11, 0x1400, s0
		s_add_i32 s8, s8, s11
		s_mov_b32 s11, s1
		v_mov_b64_e32 v[12:13], 0
		v_mov_b64_e32 v[14:15], 0
...
.Lgfx950_persistent_f16_gemm.loop_head_5:
		...
		s_mul_hi_u32 s17, s11, 0xaaaaaaab
...
.Lgfx950_persistent_f16_gemm.if_end_12:
		...
		s_lshl_b32 s16, s17, 14
		v_add_u32_e32 v9, s16, v8
		ds_read_b128 v[88:91], v9
		ds_read_b128 v[92:95], v9 offset:1024
		ds_read_b128 v[96:99], v9 offset:2048
		ds_read_b128 v[100:103], v9 offset:3072
		s_add_i32 s16, s8, s16
		v_add_u32_e32 v9, s16, v2
		ds_read_b128 v[104:107], v9 offset:49152
		ds_read_b128 v[108:111], v9 offset:50176
		ds_read_b128 v[112:115], v9 offset:51200
		ds_read_b128 v[116:119], v9 offset:52224
		s_waitcnt lgkmcnt(3)
		...
		ds_read_b128 v[104:107], v9 offset:53248
		s_waitcnt lgkmcnt(0)
...
.Lgfx950_persistent_f16_gemm.if_end_0:
	...
	.amdhsa_kernel gfx950_persistent_f16_gemm
		.amdhsa_group_segment_fixed_size 98328
...
amdhsa.kernels:
  - .args:
      ...
      - .name:           arg3
        ...
        .size:           4
        .value_kind:     by_value
    .group_segment_fixed_size: 98328
