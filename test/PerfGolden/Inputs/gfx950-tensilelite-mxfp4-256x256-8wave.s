...
.Lwmma_f16_matmul_tiled.kernarg_preload_entry:
	; wave backend: WaveAMDMachine MLIR pipeline finalized
		...
		s_mov_b32 s29, 0
		scratch_store_dword off, v7, s29 offset:100
		v_lshlrev_b32_e32 v8, 2, v4
		s_mov_b32 s29, 0
		scratch_store_dword off, v8, s29 offset:124
		...
		s_mov_b32 s8, 0
		scratch_store_dword off, v16, s8 offset:104
...
.Lwmma_f16_matmul_tiled.loop_head_0:
		...
		s_mov_b32 s52, 0
		s_waitcnt vmcnt(24)
		scratch_load_dword v2, off, s52 offset:128
		s_waitcnt vmcnt(0)
		v_add_u32_e32 v2, 0x800, v2
		v_add_u32_e32 v2, 0x800, v2
		v_add_u32_e32 v2, 0x800, v2
		...
		s_mov_b32 s52, 0
		scratch_load_dword v0, off, s52 offset:100
		s_mov_b32 s52, 0
		scratch_load_dword v2, off, s52 offset:124
		s_waitcnt vmcnt(0)
		...
		s_mov_b32 s52, 0
		s_waitcnt lgkmcnt(0)
		scratch_store_dword off, v5, s52 offset:244
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		...
		s_mov_b32 s52, 0
		s_waitcnt lgkmcnt(0)
		scratch_store_dword off, v2, s52 offset:248
		s_mov_b32 s52, 0
		scratch_load_dword v0, off, s52 offset:104
		s_mov_b32 s52, 0
		scratch_load_dword v2, off, s52 offset:124
		s_waitcnt vmcnt(0)
		...
		s_mov_b32 s50, 0
		s_waitcnt lgkmcnt(0)
		scratch_store_dword off, v5, s50 offset:252
		v_add_u32_e32 v2, 0x800, v0
		v_add_u32_e32 v2, 0x800, v2
		v_add_u32_e32 v2, 0x800, v2
		v_add_u32_e32 v2, 0x800, v2
		...
		s_mov_b32 s50, 0
		s_waitcnt lgkmcnt(0)
		scratch_store_dword off, v5, s50 offset:260
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		v_add_u32_e32 v0, 0x800, v0
		...
		s_mov_b32 s52, 0
		scratch_load_dword v5, off, s52 offset:112
		s_waitcnt vmcnt(0)
		...
		s_mov_b32 s51, 0
		scratch_load_dword v5, off, s51 offset:112
		s_waitcnt vmcnt(0)
		v_add3_u32 v0, v0, v2, v5
		s_mov_b32 s51, 0
		...
		s_mov_b32 s51, 0
		scratch_load_dword v5, off, s51 offset:124
		s_waitcnt vmcnt(0)
		v_add3_u32 v2, s50, v2, v5
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(34)
		scratch_load_dword v0, off, s50 offset:304
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(33)
		scratch_load_dword v0, off, s50 offset:308
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(32)
		scratch_load_dword v0, off, s50 offset:312
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(31)
		scratch_load_dword v0, off, s50 offset:316
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(30)
		scratch_load_dword v0, off, s50 offset:320
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(29)
		scratch_load_dword v0, off, s50 offset:324
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(28)
		scratch_load_dword v0, off, s50 offset:328
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(27)
		scratch_load_dword v0, off, s50 offset:332
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(26)
		scratch_load_dword v0, off, s50 offset:336
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(25)
		scratch_load_dword v0, off, s50 offset:340
		...
		s_mov_b32 s50, 0
		s_waitcnt vmcnt(24)
		scratch_load_dword v0, off, s50 offset:344
		...
		s_mov_b32 s50, 0
		scratch_load_dword v32, off, s50 offset:512
		scratch_load_dword v33, off, s50 offset:516
		scratch_load_dword v34, off, s50 offset:520
		scratch_load_dword v35, off, s50 offset:524
		s_waitcnt vmcnt(0)
		...
		s_mov_b32 s50, 0
		scratch_load_dword v32, off, s50 offset:528
		scratch_load_dword v33, off, s50 offset:532
		scratch_load_dword v34, off, s50 offset:536
		scratch_load_dword v35, off, s50 offset:540
		s_waitcnt vmcnt(0)
		...
		s_mov_b32 s50, 0
		scratch_load_dword v32, off, s50 offset:560
		scratch_load_dword v33, off, s50 offset:564
		scratch_load_dword v34, off, s50 offset:568
		scratch_load_dword v35, off, s50 offset:572
		s_waitcnt vmcnt(0)
