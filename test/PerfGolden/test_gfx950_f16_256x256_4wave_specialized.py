...
# CHECK: perf-golden: gfx950-f16-256x256-4wave-specialized: asm matches golden
...
def check_asm(
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        golden = (
            normalize_asm(GOLDEN.read_text(encoding="utf-8")) if GOLDEN.exists() else ""
        )
...
def test_gfx950_f16_256x256_4wave_specialized() -> None:
