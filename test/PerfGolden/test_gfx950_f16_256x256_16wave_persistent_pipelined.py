...
# CHECK: perf-golden: gfx950-f16-256x256-16wave-persistent-pipelined: asm matches golden
...
NAME = "gfx950-f16-256x256-16wave-persistent-pipelined"
GOLDEN = REPO_ROOT / "test/PerfGolden/Inputs" / f"{NAME}.s"


def test_gfx950_f16_256x256_16wave_persistent_pipelined() -> None:
