...
// RUN: wave-opt %s --pass-pipeline='builtin.module(waveamd-to-machine,waveamd-abi-lowering,transform-preload-library{transform-library-paths=%wave_pipelines},transform-interpreter{entry-point=waveamd_regalloc_transform_loop},waveamd-insert-hazard-waits,waveamd-resource-info,waveamd-metadata)' | FileCheck %s --check-prefix=PIPELINE
...
// SELECT: waveamdmachine.wmma_f32_16x16x16_f16{{.*}} : (!waveamdmachine.reg<vgpr, 8>, !waveamdmachine.reg<vgpr, 8>, !waveamdmachine.imm) -> !waveamdmachine.reg<vgpr, 8>

// PIPELINE-LABEL: func.func @matrix_f16_zero_acc_kernel
// PIPELINE: waveamdmachine.wmma_f32_16x16x16_f16{{.*}} -> !waveamdmachine.reg<vgpr, 8,

// ASM-LABEL: matrix_f16_zero_acc_kernel:
// ASM: v_wmma_f32_16x16x16_f16 [[DST:v\[[0-9]+:[0-9]+\]]], [[A:v\[[0-9]+:[0-9]+\]]], [[B:v\[[0-9]+:[0-9]+\]]], 0
// ASM: global_store_b128 {{v[0-9]+}}, {{v\[[0-9]+:[0-9]+\]}}, {{s\[[0-9]+:[0-9]+\]}}{{$}}
// ASM: global_store_b128 {{v[0-9]+}}, {{v\[[0-9]+:[0-9]+\]}}, {{s\[[0-9]+:[0-9]+\]}} offset:16
// ASM: s_endpgm
func.func @matrix_f16_zero_acc_kernel(%out: !wave.ptr<#wave.global, i32>) attributes {wave.kernel} {
  ...
  %a = waveamd.fragment_fill %zero : i32 -> !waveamd.fragment<0, f16, 16, 16, 32, 8>
  %b = waveamd.fragment_fill %zero : i32 -> !waveamd.fragment<1, f16, 16, 16, 32, 8>
  %acc = waveamd.fragment_fill %zero : i32 -> !waveamd.fragment<2, f32, 16, 16, 32, 8>
  %result = waveamd.mma "wmma.f32.16x16x16.f16" %a, %b, %acc : !waveamd.fragment<0, f16, 16, 16, 32, 8>, !waveamd.fragment<1, f16, 16, 16, 32, 8>, !waveamd.fragment<2, f32, 16, 16, 32, 8> -> !waveamd.fragment<2, f32, 16, 16, 32, 8>
  %lane = wave.lane_id : !wave.simd<i32, 32>
  %r = arith.constant 8 : i32
  %r_simd = wave.splat %r : i32 -> !wave.simd<i32, 32>
...
// SELECT: waveamdmachine.v_mov_b32_tuple{{.*}} : (!waveamdmachine.imm) -> !waveamdmachine.reg<vgpr, 8>
// SELECT: waveamdmachine.v_mov_b32_tuple{{.*}} : (!waveamdmachine.imm) -> !waveamdmachine.reg<vgpr, 8>
// SELECT: waveamdmachine.wmma_f32_16x16x16_bf16{{.*}} : (!waveamdmachine.reg<vgpr, 8>, !waveamdmachine.reg<vgpr, 8>, !waveamdmachine.reg<vgpr, 8>) -> !waveamdmachine.reg<vgpr, 8>

// PIPELINE-LABEL: func.func @matrix_bf16_kernel
// PIPELINE-SAME: waveamdmachine.metadata
// PIPELINE: waveamdmachine.wmma_f32_16x16x16_bf16{{.*}} -> !waveamdmachine.reg<vgpr, 8,

// ASM-LABEL: matrix_bf16_kernel:
// ASM: v_wmma_f32_16x16x16_bf16 [[DST:v\[[0-9]+:[0-9]+\]]], [[A:v\[[0-9]+:[0-9]+\]]], [[B:v\[[0-9]+:[0-9]+\]]], [[C:v\[[0-9]+:[0-9]+\]]]
// ASM: global_store_b128 {{v[0-9]+}}, {{v\[[0-9]+:[0-9]+\]}}, {{s\[[0-9]+:[0-9]+\]}}{{$}}
// ASM: global_store_b128 {{v[0-9]+}}, {{v\[[0-9]+:[0-9]+\]}}, {{s\[[0-9]+:[0-9]+\]}} offset:16
// ASM: s_endpgm
func.func @matrix_bf16_kernel(%out: !wave.ptr<#wave.global, i32>) attributes {wave.kernel} {
  ...
  %base = arith.constant 0 : i32
  %ptr = wave.ptr_add %out, %base : !wave.ptr<#wave.global, i32>, i32 -> !wave.ptr<#wave.global, i32>
  %a = waveamd.fragment_fill %zero : i32 -> !waveamd.fragment<0, bf16, 16, 16, 32, 8>
  %b = waveamd.fragment_fill %zero : i32 -> !waveamd.fragment<1, bf16, 16, 16, 32, 8>
  %acc = waveamd.fragment_fill %seven_as_f32_bits : i32 -> !waveamd.fragment<2, f32, 16, 16, 32, 8>
  %result = waveamd.mma "wmma.f32.16x16x16.bf16" %a, %b, %acc : !waveamd.fragment<0, bf16, 16, 16, 32, 8>, !waveamd.fragment<1, bf16, 16, 16, 32, 8>, !waveamd.fragment<2, f32, 16, 16, 32, 8> -> !waveamd.fragment<2, f32, 16, 16, 32, 8>
  %lane = wave.lane_id : !wave.simd<i32, 32>
  %r = arith.constant 8 : i32
  %r_simd = wave.splat %r : i32 -> !wave.simd<i32, 32>
  %lane_off = wave.binary muli %lane, %r_simd : !wave.simd<i32, 32>, !wave.simd<i32, 32> -> !wave.simd<i32, 32>
