...
// RUN: wave-opt --waveamd-to-waveamdmachine --waveamd-abi-lowering --waveamd-insert-hazard-waits --waveamd-reg-alloc --waveamd-resource-info --waveamd-metadata %s | FileCheck %s --check-prefix=PIPELINE
