...
module attributes {waveamdmachine.target = "amdgcn-amd-amdhsa--gfx950"} {
  ...
  // CHECK-LABEL: func.func @regalloc_transform_loop_sinks_vcc_compare_masks
  // CHECK-SAME: waveamdmachine.regalloc_assignments
  // CHECK-SAME: stage = "linear-scan-success"
  ...
  func.func @regalloc_transform_loop_sinks_vcc_compare_masks(
  ...
  // CHECK-LABEL: func.func @regalloc_transform_loop_sinks_scc_compare_mask
  ...
  // CHECK: return [[PICK]]
  func.func @regalloc_transform_loop_sinks_scc_compare_mask(
  ...
  // CHECK-LABEL: func.func @regalloc_transform_loop_keeps_scc_reload_local
  ...
  // CHECK: return [[PICK]]
  func.func @regalloc_transform_loop_keeps_scc_reload_local(
