...
// RUN: wave-opt --waveamd-to-machine --waveamd-abi-lowering --waveamd-insert-ticket-waits --waveamd-linearize-exec-if %s | FileCheck %s --check-prefix=TICKET
// RUN: wave-opt --waveamd-to-machine --waveamd-abi-lowering --waveamd-insert-ticket-waits --waveamd-linearize-exec-if --waveamd-insert-hazard-waits %s | FileCheck %s --check-prefix=HAZARD
// RUN: wave-opt --waveamd-to-machine --waveamd-abi-lowering --waveamd-insert-ticket-waits --waveamd-linearize-exec-if --waveamd-reg-alloc --waveamd-insert-hazard-waits %s | FileCheck %s --check-prefix=REGALLOC
// RUN: wave-opt --waveamd-to-machine --waveamd-abi-lowering --waveamd-insert-ticket-waits --waveamd-linearize-exec-if --waveamd-reg-alloc --waveamd-insert-hazard-waits --waveamd-resource-info %s | FileCheck %s --check-prefix=RESOURCE
// RUN: wave-opt --waveamd-to-machine --waveamd-abi-lowering --waveamd-insert-ticket-waits --waveamd-linearize-exec-if --waveamd-reg-alloc --waveamd-insert-hazard-waits --waveamd-resource-info --waveamd-metadata %s | FileCheck %s --check-prefix=METADATA
