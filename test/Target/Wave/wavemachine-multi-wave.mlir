...
// SELECT: wavemachine.s_workgroup_id_x : !wavemachine.reg<sgpr, 1, 2>
// SELECT: wavemachine.v_workitem_id_x : !wavemachine.reg<vgpr, 1, 0>
// SELECT: wavemachine.v_add_u32

// REGALLOC-LABEL: func.func @multi_wave_kernel
// REGALLOC: wavemachine.s_workgroup_id_x : !wavemachine.reg<sgpr, 1, 2>
// REGALLOC: wavemachine.v_workitem_id_x : !wavemachine.reg<vgpr, 1, 0>
