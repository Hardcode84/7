...
// SELECT: wavemachine.s_mov_b64_imm 100
// SELECT: wavemachine.s_mov_b64_imm 200
// SELECT: wavemachine.s_add_u64 {{.*}} : (!wavemachine.reg<sgpr, 2>, !wavemachine.reg<sgpr, 2>) -> !wavemachine.reg<sgpr, 2>
...
// SELECT: wavemachine.v_add_u64 {{.*}} : (!wavemachine.reg<vgpr, 2>, !wavemachine.reg<vgpr, 2>) -> !wavemachine.reg<vgpr, 2>
...
// SELECT: wavemachine.s_mul_u64 {{.*}} : (!wavemachine.reg<sgpr, 2>, !wavemachine.reg<sgpr, 2>) -> (!wavemachine.reg<sgpr, 2>, !wavemachine.reg<sgpr, 1>)
...
// SELECT: wavemachine.v_mul_u64 {{.*}} : (!wavemachine.reg<vgpr, 2>, !wavemachine.reg<vgpr, 2>) -> (!wavemachine.reg<vgpr, 2>, !wavemachine.reg<vgpr, 1>)
...
// SELECT: wavemachine.s_lshl_b64 {{.*}} : (!wavemachine.reg<sgpr, 2>, !wavemachine.reg<sgpr, 2>) -> !wavemachine.reg<sgpr, 2>
...
// SELECT: wavemachine.v_lshlrev_b64 {{.*}} : (!wavemachine.reg<vgpr, 2>, !wavemachine.reg<vgpr, 2>) -> !wavemachine.reg<vgpr, 2>
