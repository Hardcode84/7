...
// ROUNDTRIP: %[[B16:.*]], %[[B16TOK:.*]] = waveamdmachine.ds_read_tr_b64_b16 %[[ADDR]] after %[[B8TOK]] offset 48
...
// ASM: ds_read_b64_tr_b16 {{v\[[0-9]+:[0-9]+\]}}, {{v[0-9]+}} offset:48
// ASM: s_endpgm
func.func @gfx950_ds_memory_ops() attributes {wave.kernel, waveamdmachine.lds_size = 256 : i64} {
  ...
  %b8, %b8_tok = waveamdmachine.ds_read_tr_b64_b8 %addr after %b4_tok offset 32
      : (!waveamdmachine.reg<vgpr, 1>, !waveamdmachine.mem.token)
        -> (!waveamdmachine.reg<vgpr, 2>, !waveamdmachine.mem.token)
  %b16, %b16_tok = waveamdmachine.ds_read_tr_b64_b16 %addr after %b8_tok offset 48
      : (!waveamdmachine.reg<vgpr, 1>, !waveamdmachine.mem.token)
        -> (!waveamdmachine.reg<vgpr, 2>, !waveamdmachine.mem.token)
