...
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "waveamd-deduplicate-writes"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
...
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "waveamd-lower-buffer-predication"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "loop-invariant-code-motion"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "wave-optimize-masks"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
...
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "wave-materialize-memory-variants"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
...
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "waveamd-canonicalize-packed-tuples"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "canonicalize"
// PIPELINE-NEXT: : (!transform.any_op) -> !transform.any_op
// PIPELINE-NEXT: transform.apply_registered_pass "cse"
