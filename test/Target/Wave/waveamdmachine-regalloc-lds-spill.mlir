...
// CHECK-LABEL: func.func @lds_spill_after_dynamic_lds
...
// CHECK: waveamdmachine.ds_load_b32 {{.*}} after %[[STORE]]
// CHECK-SAME: offset 1024
func.func @lds_spill_after_dynamic_lds()
    attributes {wave.kernel, wave.workgroup_size = array<i32: 64, 1, 1>,
...
// CHECK-SAME: waveamdmachine.lds_size = 2560 : i64
// CHECK-SAME: waveamdmachine.lds_spill_bytes = 2560 : i64
// CHECK-SAME: waveamdmachine.vgpr_count = 4 : i64
...
func.func @many_lds_spills()
  ...
  %v7 = waveamdmachine.uninit : !waveamdmachine.reg<vgpr, 1>
  %v8 = waveamdmachine.uninit : !waveamdmachine.reg<vgpr, 1>
  %v9 = waveamdmachine.uninit : !waveamdmachine.reg<vgpr, 1>
...
// CHECK-LABEL: func.func @lds_spill_reuses_parent_workitem
// CHECK: %[[WI:.+]] = waveamdmachine.v_workitem_id_x
// CHECK: waveamdmachine.uniform_loop
// CHECK-NOT: waveamdmachine.v_workitem_id_x
// CHECK: waveamdmachine.v_lshlrev_b32 %[[WI]]
// CHECK: waveamdmachine.ds_store_b32
func.func @lds_spill_reuses_parent_workitem()
    attributes {wave.kernel, wave.workgroup_size = array<i32: 64, 1, 1>,
                waveamdmachine.target_waves = 4 : i64} {
  %zero = waveamdmachine.imm 0 : !waveamdmachine.imm
