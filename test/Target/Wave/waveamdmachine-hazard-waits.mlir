...
// A gfx950 permlane source needs two slots after a VALU write.
// CHECK-LABEL: func.func @gfx950_valu_to_permlane_delay
// CHECK: waveamdmachine.v_mov_b32_tuple
// CHECK-NEXT: waveamdmachine.imm 1
// CHECK-NEXT: waveamdmachine.s_nop
// CHECK-NEXT: waveamdmachine.v_permlane32_swap_b32_tuple
func.func @gfx950_valu_to_permlane_delay(
...
// A gfx950 VCMPX/EXEC write needs four slots before permlane.
// CHECK-LABEL: func.func @gfx950_cmpx_to_permlane_delay
// CHECK: waveamdmachine.v_cmpx_eq_u32
// CHECK-NEXT: waveamdmachine.imm 3
// CHECK-NEXT: waveamdmachine.s_nop
// CHECK-NEXT: waveamdmachine.v_permlane32_swap_b32_tuple
func.func @gfx950_cmpx_to_permlane_delay(
    %x: !waveamdmachine.reg<vgpr, 1, 0>,
    %y: !waveamdmachine.reg<vgpr, 1, 1>,
