...
module attributes {transform.with_named_sequence} {
  ...
  module @payload_module attributes {waveamdmachine.target = "amdgcn-amd-amdhsa--gfx950"} {
    ...
    // A failed wide request must not prevent incremental relief through a
    // narrower, directly AGPR-bankable overlap. The outer allocation loop can
    // promote more narrow overlaps before retrying the wide request.
