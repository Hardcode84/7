...
// `wavemachine.buffer_store_tuple_b32` is the single op that covers
...
func.func @buffer_store_tuple_kernel(%arg0: !wave.ptr<i32, #wave.global>) attributes {wave.kernel} {
  ...
  %t = wavemachine.buffer_store_tuple_b32 %off, %tuple, %desc, %zero : (!wavemachine.reg<vgpr, 1>, !wavemachine.reg<vgpr, 4>, !wavemachine.reg<sgpr, 4>, !wavemachine.imm) -> !wavemachine.mem.token
