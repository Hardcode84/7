...
func.func @buffer_store_tuple_kernel(%arg0: !wave.ptr<i32, #wave.global>) attributes {wave.kernel} {
  ...
  %t0 = wavemachine.buffer_store_tuple_b32 %off, %tuple, %desc {component = 0 : i64} : (!wavemachine.reg<vgpr, 1>, !wavemachine.reg<vgpr, 4>, !wavemachine.reg<sgpr, 4>) -> !wavemachine.mem.token
  %t1 = wavemachine.buffer_store_tuple_b32 %off, %tuple, %desc {component = 3 : i64} : (!wavemachine.reg<vgpr, 1>, !wavemachine.reg<vgpr, 4>, !wavemachine.reg<sgpr, 4>) -> !wavemachine.mem.token
