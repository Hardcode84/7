module attributes {gpu.container_module} {
  func.func @where_otherwise(%arg0: !wave.ptr<#wave.global, i32>, %arg1: i32) attributes {wave.kernel} {
    ...
    %3 = wave.where %2 {
      ...
      %6 = wave.splat %c0_i32 : i32 -> !wave.simd<i32, 32>
      wave.yield %6 : !wave.simd<i32, 32>
