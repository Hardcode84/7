...
static inline bool isSupportedSchedulerSALU(Operation *op) {
  return isa<waveamdmachine::SAddI32Op, waveamdmachine::SSubI32Op,
             ...
             waveamdmachine::SReadVccB64Op, waveamdmachine::SSetprioOp,
             waveamdmachine::SSetprioIncWgOp, waveamdmachine::SClusterIdXOp,
