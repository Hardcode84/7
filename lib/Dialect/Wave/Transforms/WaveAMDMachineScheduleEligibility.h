...
static inline bool isSupportedSchedulerPseudo(Operation *op) {
  return isa<waveamdmachine::ArgOp, waveamdmachine::KernargPreloadOp,
             ...
             waveamdmachine::IssueTokenOp, waveamdmachine::ScheduleTokenOp,
...
static inline bool isSupportedSchedulerSALU(Operation *op) {
  return isa<
      waveamdmachine::SAddI32Op, waveamdmachine::SSubI32Op,
      waveamdmachine::SAddM0I32Op, waveamdmachine::SAddU64Op,
      waveamdmachine::SAddU64U32Op, waveamdmachine::DmaIssueDelayOp,
      waveamdmachine::SAndB32Op, waveamdmachine::SAndB64Op,
      waveamdmachine::SAndn2ExecB32Op, waveamdmachine::SAndn2ExecB64Op,
      waveamdmachine::SAndSaveexecB32Op, waveamdmachine::SAndSaveexecB64Op,
      waveamdmachine::SCmpEqI32Op, waveamdmachine::SCmpLgI32Op,
      waveamdmachine::SCmpGtI32Op, waveamdmachine::SCmpGeI32Op,
      waveamdmachine::SCmpLtI32Op, waveamdmachine::SCmpLeI32Op,
      waveamdmachine::SCmpEqU32Op, waveamdmachine::SCmpEqU32BarrierSeedOp,
      ...
      waveamdmachine::SCmpLgU64Op, waveamdmachine::SCSelectB32Op,
      ...
      waveamdmachine::SMovVccB64Op, waveamdmachine::SMulI32Op,
      waveamdmachine::SMulHiU32Op, waveamdmachine::SMulU64Op,
      waveamdmachine::SFf1I32B32Op, waveamdmachine::SFf1I32B64Op,
      waveamdmachine::SFlbitI32B32Op, waveamdmachine::SFlbitI32B64Op,
      waveamdmachine::SOrB32Op, waveamdmachine::SOrB64Op,
      waveamdmachine::SReadVccB32Op, waveamdmachine::SReadVccB64Op,
      waveamdmachine::SSetprioOp, waveamdmachine::SSetprioIncWgOp,
      waveamdmachine::SClusterIdXOp, waveamdmachine::SClusterIdYOp,
      waveamdmachine::SClusterIdZOp, waveamdmachine::SClusterWorkgroupIdXOp,
      ...
      waveamdmachine::SGetregShaderCyclesOp, waveamdmachine::SGetregHwIdOp,
