...
static constexpr std::array<MmaKindInfo, 13> kMmaKindInfos = {{
    {isMmaOpSupportedOnIsa<waveamdmachine::WmmaI32_16x16x16_IU8Op>,
     createMmaMachineOp<waveamdmachine::WmmaI32_16x16x16_IU8Op>, nullptr,
     "gfx11", MmaKind::WmmaI32_16x16x16_IU8,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::WmmaF32_16x16x16_F16Op>,
     createMmaMachineOp<waveamdmachine::WmmaF32_16x16x16_F16Op>, nullptr,
     "gfx11", MmaKind::WmmaF32_16x16x16_F16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::WmmaF32_16x16x16_BF16Op>,
     createMmaMachineOp<waveamdmachine::WmmaF32_16x16x16_BF16Op>, nullptr,
     "gfx11", MmaKind::WmmaF32_16x16x16_BF16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::WmmaF32_16x16x32_F16Op>,
     createMmaMachineOp<waveamdmachine::WmmaF32_16x16x32_F16Op>, nullptr,
     "gfx1250", MmaKind::WmmaF32_16x16x32_F16,
     waveamdmachine::MatrixFamily::Gfx1250},
    {isMmaOpSupportedOnIsa<waveamdmachine::WmmaF32_16x16x32_BF16Op>,
     createMmaMachineOp<waveamdmachine::WmmaF32_16x16x32_BF16Op>, nullptr,
     "gfx1250", MmaKind::WmmaF32_16x16x32_BF16,
     waveamdmachine::MatrixFamily::Gfx1250},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_16x16x16_F16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_16x16x16_F16Op>, nullptr,
     "gfx90a+", MmaKind::MfmaF32_16x16x16_F16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_16x16x16_BF16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_16x16x16_BF16Op>, nullptr,
     "gfx940+", MmaKind::MfmaF32_16x16x16_BF16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_16x16x32_F16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_16x16x32_F16Op>, nullptr,
     "gfx950", MmaKind::MfmaF32_16x16x32_F16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_16x16x32_BF16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_16x16x32_BF16Op>, nullptr,
     "gfx950", MmaKind::MfmaF32_16x16x32_BF16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_32x32x16_F16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_32x32x16_F16Op>, nullptr,
     "gfx950", MmaKind::MfmaF32_32x32x16_F16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaF32_32x32x16_BF16Op>,
     createMmaMachineOp<waveamdmachine::MfmaF32_32x32x16_BF16Op>, nullptr,
     "gfx950", MmaKind::MfmaF32_32x32x16_BF16,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaScaleF32_16x16x128_F4F4Op>,
     ...
     "gfx950", MmaKind::MfmaScaleF32_16x16x128_F4F4,
     waveamdmachine::MatrixFamily::None},
    {isMmaOpSupportedOnIsa<waveamdmachine::MfmaScaleF32_32x32x64_F4F4Op>,
     ...
     "gfx950", MmaKind::MfmaScaleF32_32x32x64_F4F4,
     waveamdmachine::MatrixFamily::None},
}};
...
static FailureOr<Value> materializeWideAddUniformFirst(
  ...
  sym::ExprHandle constant = view.getAddConstant();
  std::optional<int64_t> constantInt = staticIntLiteral(constant);
  bool pendingConstant = !constantInt || *constantInt != 0;
...
static FailureOr<Value> materializeWideRounded(
    WaveAMDMachineSelector &S, WideMaterializationContext &context,
    sym::ExprHandle expr, Operation *user, ArrayRef<WideSymbolBinding> bindings,
    sym::ExprKind kind, bool symbolsAreUniform) {
  ...
  if (kind == sym::ExprKind::Trunc && !nonNegative) {
    Value sign = ashrWidePow2(S, user->getLoc(), numerator, 63);
    Value bias = andWideMask(S, user->getLoc(), sign, den - 1);
    numerator = addWide(S, user->getLoc(), numerator, bias);
  }
...
static FailureOr<Value> materializeWideCompoundIndexExprNode(
  ...
  case sym::ExprKind::Floor:
    return materializeWideRounded(S, context, expr, user, bindings,
                                  sym::ExprKind::Floor, symbolsAreUniform);
  case sym::ExprKind::Ceil:
    return materializeWideRounded(S, context, expr, user, bindings,
                                  sym::ExprKind::Ceil, symbolsAreUniform);
  case sym::ExprKind::Trunc:
    return materializeWideRounded(S, context, expr, user, bindings,
                                  sym::ExprKind::Trunc, symbolsAreUniform);
  case sym::ExprKind::Mod:
...
static FailureOr<Value>
materializePointerOffsetLowDword(WaveAMDMachineSelector &S, Operation *user,
                                 const PointerOffset &offset) {
  if (!offset.expr)
    return createImm(S.builder, user->getLoc(), 0);

  llvm::StringMap<Value> narrowBindings;
  SmallVector<WideSymbolBinding, 4> wideBindings;
  for (const PointerOffsetBinding &binding : offset.bindings) {
    Value value = S.expect(binding.value, user);
    narrowBindings[binding.name] = value;
    wideBindings.push_back({binding.name, binding.value, value});
  }

  if (requiresWideRationalIntermediates(S, offset.expr, offset.assumptions,
                                        narrowBindings)) {
    FailureOr<Value> wide = materializeWideIndexExprNode(
        S, offset.expr, user, wideBindings, offset.assumptions);
    if (failed(wide))
      return failure();
  ...
  FailureOr<Value> value = materializeIndexExprNode(
      S, offset.expr, user, narrowBindings, offset.assumptions);
  if (failed(value))
    return failure();
  return extractLowDword(S, user->getLoc(), *value);
}
...
static FailureOr<Value> materializePlanLowDword(
  ...
  FailureOr<Value> value =
      materializePlanExpr(S, user, expr, bindings, assumptions, addOrder);
  if (failed(value))
    return failure();
...
static FailureOr<unsigned> getPackedBF16ToF32VectorLength(CastOp op) {
  std::optional<unsigned> sourceLength =
      getSimdPackedBF16Length(op.getSource().getType());
  std::optional<unsigned> resultLength =
      getSimdPackedF32Length(op.getResult().getType());
  if (!sourceLength || !resultLength || *sourceLength != *resultLength)
    return op.emitError("packed bf16 to f32 lowering requires matching "
                        "!wave.simd<vector<2^nxbf16>, W> to "
                        "!wave.simd<vector<2^nxf32>, W>");
  return *sourceLength;
}
...
static LogicalResult selectPackedBF16ToF32Cast(WaveAMDMachineSelector &S,
                                               CastOp op,
                                               CastRounding rounding) {
  if (rounding != CastRounding::RNE)
    return op.emitError(
        "packed bf16 to f32 lowering supports only rne rounding");

  FailureOr<unsigned> vectorLength = getPackedBF16ToF32VectorLength(op);
  if (failed(vectorLength))
    return failure();
  ...
  for (unsigned index : llvm::seq<unsigned>(0, *vectorLength)) {
    Value word = (*sourceWords)[index / 2];
    if (index % 2)
      word = waveamdmachine::VAndB32Op::create(
          S.builder, op.getLoc(), vgprType, word,
          createImm(S.builder, op.getLoc(), -65536));
    else
      word = waveamdmachine::VLshlrevB32Op::create(
          S.builder, op.getLoc(), vgprType, word,
...
static LogicalResult selectScalarF32ToBF16Cast(WaveAMDMachineSelector &S,
                                               CastOp op) {
  FailureOr<llvm::AMDGPU::IsaVersion> isa =
...
static LogicalResult selectScalarBF16ToF32Cast(WaveAMDMachineSelector &S,
                                               CastOp op) {
  Type vgprType =
      getRegType(S.builder.getContext(), waveamdmachine::RegClass::VGPR);
  Value source =
      S.ensureVGPRForVSrc1(op.getLoc(), S.expect(op.getSource(), op));
  S.values[op.getResult()] = waveamdmachine::VLshlrevB32Op::create(
      S.builder, op.getLoc(), vgprType, source,
      createImm(S.builder, op.getLoc(), 16));
  S.eraseIfTopLevel(op);
  return success();
...
static LogicalResult selectScalarF16ToF32Cast(WaveAMDMachineSelector &S,
                                              CastOp op) {
  FailureOr<llvm::AMDGPU::IsaVersion> isa =
...
static LogicalResult selectScalarFpConvert(WaveAMDMachineSelector &S, CastOp op,
  ...
  if (sourceElement.isF32() && resultElement.isBF16())
    return selectScalarF32ToBF16Cast(S, op);
  if (sourceElement.isBF16() && resultElement.isF32())
    return selectScalarBF16ToF32Cast(S, op);
  if (sourceElement.isF16() && resultElement.isF32())
    return selectScalarF16ToF32Cast(S, op);
  return op.emitError(
      "WaveAMDMachine fpconvert lowering supports only f32 to f16/bf16 SIMD, "
      "f16/bf16 to f32 SIMD, "
      "vector<2^nxf32> to vector<2^nxf16> SIMD, or vector<2^nxf32> to "
      "vector<2^nxbf16> SIMD, or vector<2^nxbf16> to vector<2^nxf32> "
      "SIMD");
}
...
selectPackedFpConvert(WaveAMDMachineSelector &S, CastOp op,
  ...
  if (isSimdVectorElement(op.getSource().getType(), bf16Type) &&
      isSimdVectorElement(op.getResult().getType(), f32Type))
    return selectPackedBF16ToF32Cast(S, op, rounding);
...
Value WaveAMDMachineSelector::andMask(Location loc, Value v, int64_t mask) {
  if (static_cast<uint64_t>(mask) == std::numeric_limits<uint32_t>::max())
    return v;
...
static bool valueRangeFitsI32(WaveAMDMachineSelector &S, Value value) {
  std::optional<ConstantIntRanges> range = S.finiteSignedRange(value);
  return range && range->smin().isSignedIntN(32) &&
         range->smax().isSignedIntN(32);
}

static bool usesSignedI32IndexExprValue(WaveAMDMachineSelector &S,
                                        IndexExprOp op,
                                        const PointerOffset &offset) {
  return offset.expr && !S.slotFitsU32(offset.expr, offset.assumptions) &&
...
materializeSelectedBufferDmaSourceAddress(
  ...
  FailureOr<AddressPlan> activePlan =
      planMemoryAddress(S, op, (*pointers)->active.offset, spec);
  FailureOr<AddressPlan> inactivePlan =
      planMemoryAddress(S, op, (*pointers)->inactive.offset, spec);
