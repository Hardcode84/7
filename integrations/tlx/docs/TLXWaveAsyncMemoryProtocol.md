...
The implementation references for this compatibility baseline are in the TLX
Triton repository:

- `include/triton/Dialect/TritonGPU/IR/TritonGPUOps.td`;
- `lib/Analysis/Membar.cpp`;
- `third_party/amd/lib/TritonAMDGPUToLLVM/LoadStoreOpToLLVM.cpp`;
- `third_party/amd/lib/TritonAMDGPUToLLVM/AsyncUtility.cpp`; and
- `third_party/amd/lib/TritonAMDGPUToLLVM/MembarUtility.cpp`.

## Scope

This document applies to the structural converter in
`integrations/tlx/src/wave_tlx/converter` and the Wave/WaveAMD IR it emits.
