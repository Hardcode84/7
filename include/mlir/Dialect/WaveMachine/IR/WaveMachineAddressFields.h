//===- WaveMachineAddressFields.h - Memory-op slot spec ---------*- C++ -*-===//
//
...
#ifndef MLIR_DIALECT_WAVEMACHINE_IR_WAVEMACHINEADDRESSFIELDS_H
#define MLIR_DIALECT_WAVEMACHINE_IR_WAVEMACHINEADDRESSFIELDS_H

#include <cstdint>

namespace mlir::wavemachine {
...
#endif // MLIR_DIALECT_WAVEMACHINE_IR_WAVEMACHINEADDRESSFIELDS_H
